...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Tour Date View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/tour_tourdate/add?tid='.$id); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Tour Date </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/tour_tourdate/bulk_action', $attributes); 
					?>                                
            ...
            <a href="<?php echo base_url('admin/tour_tourdate/edit')."?id=".$val['DateId']."&tid=".$val['TourId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/tour_tourdate/delete')."?id=".$val['DateId']."&tid=".$val['TourId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
            ...
            -->
                      ...
                      <td> 
                                  <?php
										   ...
										   $data = array('id'  => $TourName[0]['id'] );
											echo form_hidden($data);
								  
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['DateId'],  'checked'=> false, 'class'=>" margin_bottom" );
