                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                            ...
                            <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'adm_name', 'id' => 'adm_name',  'placeholder' => 'Admin Name', 'class'=>"form-control margin_bottom");
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'adm_login_id', 'id' => 'adm_login_id',  'placeholder' => 'Login Id', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
		                		...
		                		<div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ Password form open ---------------------------------
                                        $password_data = array('name'  => 'adm_password', 'id' => 'adm_password',  'placeholder' => 'Password ', 'class'=>"form-control margin_bottom");
                               ...
                               <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ Confirm Password form open ---------------------------------
                                      $cpassword_data = array('name'  => 'adm_conpwd', 'id' => 'adm_conpwd',  'placeholder' => 'Confirm Password ', 'class'=>"form-control margin_bottom");
                                ...
                                <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ Confirm Password form open ---------------------------------
                                      $email_data = array('name'  => 'adm_email', 'id' => 'adm_email',  'placeholder' => 'Email  ', 'class'=>"form-control margin_bottom");
                              ...
                              <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ Contact no Password form open ---------------------------------
                                      $data = array('name'  => 'adm_phone', 'id' => 'adm_phone',  'placeholder' => 'Contact No  ', 'class'=>"form-control margin_bottom");
                                        echo form_input($data);
                                    ?>
		                		  </div>
                               </div>  
                               ...
                               <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                      $data = array('name'  => 'adm_address', 'id' => 'adm_address',  'placeholder' => 'Address ', 'class'=>"form-control margin_bottom");
                              ...
                              <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ adm_city no Password form open ---------------------------------
                                      $data = array('name'  => 'adm_city', 'id' => 'adm_city',  'placeholder' => 'City  ', 'class'=>"form-control margin_bottom");
                                        echo form_input($data);
                                    ?>
		                		  </div>
                               </div>   
                                 ...
                                 <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ adm_city no Password form open ---------------------------------
                                      $data = array('name'  => 'adm_state', 'id' => 'adm_city',  'placeholder' => 'State  ', 'class'=>"form-control margin_bottom");
                                        echo form_input($data);
                                    ?>
		                		  </div>
                               </div>   
                               ...
                               <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ adm_zipcode no Password form open ---------------------------------
                                      $data = array('name'  => 'adm_zipcode', 'id' => 'adm_zipcode',  'placeholder' => 'Zipcode  ', 'class'=>"form-control margin_bottom");
                                        echo form_input($data);
                                    ?>
		                		  </div>
                               </div>   
