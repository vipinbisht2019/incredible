                      ...
                      <div class="col-sm-4 col-md-2">
                        <div class="select1_wrapper">
                          <input type="text" name="guestsinfo" id="guestsinfo" value="1 Room 1 Adult 0 Child" id="bt"  onclick="toggle3(this)" class="trvl-cnt" readonly>
                            <div class="traveller-count" id="cont3" style="max-height: 410px; overflow-y: auto; overflow-x: hidden;">
                              ...
                              <!-- <div class="center" style="display: block;width: 300px;" id="roommerge1"> -->
                                ...
                                <div class="row" style="display: flex;padding: 5px;">
                                  <div class="col-md-6" style="width: 100%;">
                                    <p style="font-weight: 500;font-size: 12px;">Adults
                                      <span style="color: #969696;font-size: 10px;">(12+ yr)</span>
                                    </p>
                                  </div><br>
                                  <div class="col-md-6" style="margin-top: 0px;">
                                    <div class="input-group" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;padding: 2px;border-radius: 25px;">
          ...
          $("#updateTraveller2").on("click",function(){ 
           ...
           //   console.log(noofrooms);
            ...
            //  alert(guestsinfo);
              ...
              // var roommerge2 = document.getElementById('roommerge2');
              // roommerge2.style.display = 'none';

              // var childernage31 = document.getElementById('childernage31');
              // childernage31.style.display = 'none';

              // var childernage32 = document.getElementById('childernage32');
              // childernage32.style.display = 'none';

              // var childernage33 = document.getElementById('childernage33');
              // childernage33.style.display = 'none';  
...
<script>
  ...
  function addRoom(){ 
      ...
      function childPlus1(i){

         // alert(i);

          //alert("jokpx");

        var children1 = document.getElementById('noofchild'+i).value;

          //var children1 = $("#noofchild"+i).val();
          alert(children1);
          if(children1 > 0){
  ...
  //   // var roommerge2 = document.getElementById('roommerge2');
  //   // roommerge2.style.display = 'block';
