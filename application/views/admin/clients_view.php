...
<body>
	<div id="wrapper">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Clients View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/clients/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">  Add Clients </a>
     ...
     <?php 
			...
			echo form_open_multipart(base_url('admin/clients/search'), $attributes);
	          ?>
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/clients/bulk_action', $attributes); 
					?>                                
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							   <tr class="<?php echo $css; ?>">
                                    <td><?php echo $val['CustomersId'] ?></td> 
                                   
                                    <td><?php echo $val['FirstName'] ?> <?php echo $val['LastName'] ?></td>
                                    <td><?php echo $val['EMailAddress'] ?></td>
                                    <td><?php echo $val['ContactNumber'] ?></td>
                                    <td> <?php if($val['Gender']=='M') echo"Male"; elseif($val['Gender']=='F') echo"InActive"; else echo"Other"; ?></td>
                                    <td><?php if($val['Status']=='Y') echo"Active"; else echo"InActive"; ?></td>
							     <td> 
                                    
            <a href="<?php echo base_url('admin/clients/edit')."?id=".$val['CustomersId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/clients/delete')."?id=".$val['CustomersId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['CustomersId'],  'checked'=> false, 'class'=>" margin_bottom" );
