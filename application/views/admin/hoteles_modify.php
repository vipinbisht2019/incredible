		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Hotel Modify</b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/hoteles/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/hoteles/edit', $attributes);
							     ?>
                                ...
                                <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
											...
											foreach($hoteltype as $val)
											  ...
											  $selected=$edit_hoteles[0]['hoteltypeId'];	
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span>Hotel Name * </span></label>
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('HotelName'); ?></span>
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'HotelName', 'id' => 'HotelName', 'value'=>$edit_hoteles[0]['HotelName'], 'placeholder' => 'Hotel Name', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                   ...
                                   <?php
								     // ------------------------------ adm_status form  ---------------------------------
											...
											(
											 ...
											 $selected=$edit_hoteles[0]['StarRating'];
																		
											echo form_dropdown('StarRating', $options, $selected ,'class="form-control margin_bottom"');
                                    ?>
		                		  </div>
                               </div> 
                               ...
                               <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'Locality', 'id' => 'Locality', 'value'=>$edit_hoteles[0]['Locality'], 'placeholder' => 'Location', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		</div>  
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'City', 'id' => 'City', 'value'=>$edit_hoteles[0]['City'], 'placeholder' => 'City', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		</div>  
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'State', 'id' => 'State', 'value'=>$edit_hoteles[0]['State'], 'placeholder' => 'State', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		</div>  
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'Country', 'id' => 'Country', 'value'=>$edit_hoteles[0]['Country'], 'placeholder' => 'Country', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		</div>  
                                   ...
                                   <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'Overview', 'id' => 'Overview','value'=>$edit_hoteles[0]['Overview'] ,  'placeholder' => 'Overview', 'class'=>"form-control margin_bottom");
                                ...
                                <div class="col-md-12 padding_opx">
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                         <?php
											  if($edit_hoteles[0]['SmallImage']!='') { ?>
                                               <img src="<?php echo base_url('uploads/hotel/'.$edit_hoteles[0]['SmallImage']) ?>" width="200px"> <br>
											  <?php } else { ?>
                              ...
                              <p>&nbsp;</p>
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Big Image (Header) </span></label>
		                			    <div class="col-md-5 form-group padding_opx">
                                          <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'SmallImage[]',  'class'=>"form-control margin_bottom");
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                         <?php
											  if($edit_hoteles[0]['BigImage']!='') { ?>
                                               <img src="<?php echo base_url('uploads/hotel/'.$edit_hoteles[0]['BigImage']) ?>" width="200px"> <br>
											  <?php } else { ?>
                                               Image does not exist
                                              <?php } ?>
                              <p>&nbsp;</p>
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span>Select Facilities </span></label>
		                			    <div class="col-md-5 form-group padding_opx">
								    ...
								    foreach($hotel_facilities as $fh_val)
											 {  
											    ...
											    ?>
                                                   ...
                                                   <?php 
								    if(in_array($fh_val['FId'], $edit_hotel_facilities))
										  { 
													$data = array
														(
                               ...
                               <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'SortOrder', 'id' => 'SortOrder','value'=>$edit_hoteles[0]['SortOrder'] ,  'placeholder' => 'Sort Order', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                                    ?>
                                  ...
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
                                        ...
                                        echo form_hidden($data);
										 ...
										 $data = array('id'  => $edit_hoteles[0]['HotelId']);
											echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
