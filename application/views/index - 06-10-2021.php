                ...
                <div id="tabs-1">
                  <div class="tabs" style="box-shadow: none;background: #fafafa">
						   ...
						   <div class="row after-add-more" style="margin-top: 20px;margin-bottom: 15px;">
                              ...
                              <div class="col-sm-2 col-md-2 pad-col">
                                <div class="select1_wrapper">
                                  <!--<label>To </label>-->
                                  <div class="select1_inner">
                                  <input type="text" name="destination1" id="search_destination3" class="qq1" placeholder ="Destination"  style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #ececec;width:100%;">
                                  </div>
                                </div>
                              </div>
                              <div class="col-sm-3 col-md-3 pad-col">
                            ...
                            <!--      <button type="button" class="add-citiesq add-more"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Upto 4 Cities</button> -->
                                <!-- <a href="javascript:(0);" style="text-decoration:none;"><i class="fa fa-plus-circle" aria-hidden="true"> </i> Reset</a> -->							 
								 
							<button class="btn btn-lg add-more add-cities" id="add_more11" type="button"><i class="glyphicon glyphicon-plus"></i> Add More</button> 
					...
					<div class="copy hide">  
						...
						<div class="row control-group input-groups">
							<div class="col-sm-2 col-md-2 pad-col" style="display: flex;">
							...
							<button class="btn btn-lg add-more1 add-cities" type="button"><i class="glyphicon glyphicon-plus"></i> Add More</button> 					
	   ...
	   $("body").on("click",".add-more1",function(){ 
		...
		//  $(this).hide();
		 //  $(".add-more").show();
          ...
          var html = $(".copy").html();  
          $(".after-add-more").after(html); 
		   $(this).removeClass("add-more1");
		    $(this).addClass("add-more2");
      });
