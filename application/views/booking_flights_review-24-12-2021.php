                                        ...
                                        <div class="dscrpton-cntnt detail-box">
                                            ...
                                            <ul class="brdrBot">
                                                ...
                                                <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResultReturn['sI'][0]['dt'])); ?></p>
                                                    ...
                                                    <p style="font-size: 13px;font-weight: 500;color: #8b8b8b;line-height: 15px;margin-bottom: 0;"><?php echo $tripInfoResultReturn['sI'][0]['da']['name']; ?> <?php //echo $tripInfoResult['sI'][0]['da']['city']; ?> <?php //echo $tripInfoResult['sI'][0]['da']['country']; ?><br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResultReturn['sI'][0]['da']['terminal']; ?>)</span></p>
                                                </li>
                                                <li>
                                                    <div class="common-elementsstyles__Wid25-sc-ilw4bs-16 sGaBo flexCol TxtCenter padR20 padL10"><div class="flight-detailstyles__BackgroundLn-sc-1i6unua-6 iGruED dF justifyBetween alignItemsCenter backgroundLn"><div class="flight-detailstyles__Oval2-sc-1i6unua-7 dHNyva"></div><span class="padL10 padR10 whiteBg font20"><?php  
                                                ...
                                                <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResultReturn['sI'][0]['at'])); ?></p>
                                                    ...
                                                    <p style="font-size: 13px;font-weight: 500;color: #8b8b8b;line-height: 15px;margin-bottom: 0;"><?php echo $tripInfoResultReturn['sI'][0]['aa']['name']; ?><br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResultReturn['sI'][0]['aa']['terminal']; ?>)</span></p>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="grey padT10 font12 padL20 padR20 dF">
                                                <div class="flex1_5">
                                                    <span class="flexRow">
                                                        ...
                                                        <p class="padL5" style="font-size: 12px;padding-top: 12px;font-weight: 500;color: #adadad;margin-bottom:0px;"><?php echo $tripInfoResultReturn['totalPriceList'][0]['fd']['ADULT']['bI']['iB']; ?>  Check-In, <?php echo $tripInfoResultReturn['totalPriceList'][0]['fd']['ADULT']['bI']['cB']; ?> Cabin
                                                        </p>
                                                    </span>
                                                </div>
                                                <div class="flex2"></div>
                                            ...
                                            <?php if(!empty($tripInfoResultReturn['sI'][0]['cT'])){ ?>
                                                ...
                                                <ul class="brdrBot">
                                                    <li>
                                                        ...
                                                        <p class="flight-detl"><?php echo $tripInfoResultReturn['sI'][1]['fD']['aI']['name']; ?></p>
                                                        <p class="flight-detl"><?php echo ucfirst($tripInfoResultReturn['totalPriceList'][0]['fd']['ADULT']['cc']); ?></p>
                                                        <p class="flight-detl"><?php echo $tripInfoResultReturn['sI'][1]['fD']['aI']['code']; ?> - <?php echo $tripInfoResultReturn['sI'][1]['fD']['fN']; ?></p>
                                                        <p class="flight-detl" style="font-weight: 500;">(Aircraft: <?php echo $tripInfoResultReturn['sI'][1]['fD']['eT']; ?>)</p>
                                                        </span>
                                                    </li>
                                            ...
                                            <div class="grey padT10 font12 padL20 padR20 dF">
                                                <div class="flex1_5">
                                                    <span class="flexRow">
                                                        ...
                                                        <p class="padL5" style="font-size: 12px;padding-top: 12px;font-weight: 500;color: #adadad;margin-bottom:0px;"><?php echo $tripInfoResultThird['totalPriceList'][0]['fd']['ADULT']['bI']['iB']; ?>  Check-In, <?php echo $tripInfoResultThird['totalPriceList'][0]['fd']['ADULT']['bI']['cB']; ?> Cabin
                                                        </p>
                                                    </span>
                                                </div>
                                                <div class="flex2"></div>
                                            ...
                                            <div class="grey padT10 font12 padL20 padR20 dF">
                                                <div class="flex1_5">
                                                    <span class="flexRow">
                                                        ...
                                                        <p class="padL5" style="font-size: 12px;padding-top: 12px;font-weight: 500;color: #adadad;margin-bottom:0px;"><?php echo $tripInfoResultForth['totalPriceList'][0]['fd']['ADULT']['bI']['iB']; ?>  Check-In, <?php echo $tripInfoResultForth['totalPriceList'][0]['fd']['ADULT']['bI']['cB']; ?> Cabin
                                                        </p>
                                                    </span>
                                                </div>
                                                <div class="flex2"></div>
                                        ...
                                        <div class="grey padT10 font12 padL20 padR20 dF">
                                            <div class="flex1_5">
                                                <span class="flexRow">
                                                    ...
                                                    <p class="padL5" style="font-size: 12px;padding-top: 12px;font-weight: 500;color: #adadad;margin-bottom:0px;"><?php echo $tripInfoResultFifth['totalPriceList'][0]['fd']['ADULT']['bI']['iB']; ?>  Check-In, <?php echo $tripInfoResultFifth['totalPriceList'][0]['fd']['ADULT']['bI']['cB']; ?> Cabin
                                                    </p>
                                                </span>
                                            </div>
                                            <div class="flex2"></div>
                                        ...
                                        <div class="grey padT10 font12 padL20 padR20 dF">
                                            <div class="flex1_5">
                                                <span class="flexRow">
                                                    ...
                                                    <p class="padL5" style="font-size: 12px;padding-top: 12px;font-weight: 500;color: #adadad;margin-bottom:0px;"><?php echo $tripInfoResultSixth['totalPriceList'][0]['fd']['ADULT']['bI']['iB']; ?>  Check-In, <?php echo $tripInfoResultSixth['totalPriceList'][0]['fd']['ADULT']['bI']['cB']; ?> Cabin
                                                    </p>
                                                </span>
                                            </div>
                                            <div class="flex2"></div>
                                                    ...
                                                    foreach($passengersdetailsReview as $row_passengers) 
                                                    {
                                                        ...
                                                        <ul class="art-tabody">
                                                            <li>
                                                                ...
                                                                <?php if((!empty(@$bagdesc)) || (!empty(@$mealdesc))){ ?> 
                        ...
                        <div class="col-md-12 sidebar-item">
                            ...
                            <div class="input2_wrapper">
                                ...
                                <div class="col-md-4 pad-l-r">
                                    <span class="red"> <i class="fa fa-inr"></i> &nbsp;<?php echo $this->session->userdata('baseFareReTotal'); ?>                                            
                            ...
                            <div class="input2_wrapper">
                                <label class="col-md-6 mp"><h5 class="mp">Total Amount;<?php echo $totalGrossAmount; ?></h5></label>
