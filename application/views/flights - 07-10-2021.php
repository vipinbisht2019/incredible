    ...
    <div id="main">
      ...
      <div style="background: #244082;padding: 20px;position: sticky;top: 0px;z-index: 3;padding-left: 0;">
        ...
        <ul style="display: flex;padding-left: 0px;">
          <li style="color: #fff;"><input type="radio" name="oneway" id="oneway" <?php if($bookingType == 'O'){ echo "checked" ; } ?> style="height: 20px;width: 25px;"> <span style="position: relative;bottom: 5px;">One Way</span></li>&nbsp;&nbsp;
          <li style="color: #fff;"><input type="radio" name="oneway" id="returnway" <?php if($bookingType == 'R'){ echo "checked" ; } ?> style="height: 20px;width: 25px;"> <span style="position: relative;bottom: 5px;">Round Trip</span></li>&nbsp;&nbsp;
          <li style="color: #fff;"><input type="radio" name="oneway" id="returnway" <?php if($bookingType == 'M'){ echo "checked" ; } ?> style="height: 20px;width: 25px;"> <span style="position: relative;bottom: 5px;">Multi City</span></li>
        </ul>
                        ...
                        <table>
                          <tbody>
						   ...
						   <?php if($count_multiways > 4) { ?>
                            ...
                            <tr>
                              <td style="border: none;padding: 0px 5px;"><h3 style="margin-top: 35px;margin-bottom: 0;padding-bottom: 0;text-align: right;font-weight:600"><i class="fa fa-inr"></i><?php echo $totaFare = $completeResultReturn[0]['totalFare'] + $completeResult[0]['totalFare'] + $completeResultthird[0]['totalFare'] + $completeResultforth[0]['totalFare']+ $completeResultfifth[0]['totalFare']; ?>aa</h3></td>
                            </tr>
						  
						   <?php } elseif($count_multiways > 3) { ?>
						  
                            <tr>
                              <td style="border: none;padding: 0px 5px;"><h3 style="margin-top: 35px;margin-bottom: 0;padding-bottom: 0;text-align: right;font-weight:600"><i class="fa fa-inr"></i><?php echo $totaFare = $completeResultReturn[0]['totalFare'] + $completeResult[0]['totalFare'] + $completeResultthird[0]['totalFare'] + $completeResultforth[0]['totalFare']; ?>bb</h3></td>
                            </tr>
						  
						  <?php } elseif($count_multiways > 2) { ?>
						  
                            <tr>
                              <td style="border: none;padding: 0px 5px;"><h3 style="margin-top: 35px;margin-bottom: 0;padding-bottom: 0;text-align: right;font-weight:600"><i class="fa fa-inr"></i><?php echo $totaFare = $completeResultReturn[0]['totalFare'] + $completeResult[0]['totalFare'] + $completeResultthird[0]['totalFare']; ?>cc</h3></td>
                            </tr>
						  <?php } else { ?>
						  <tr>
                              <td style="border: none;padding: 0px 5px;"><h3 style="margin-top: 35px;margin-bottom: 0;padding-bottom: 0;text-align: right;font-weight:600"><i class="fa fa-inr"></i><?php echo $totaFare = $completeResultReturn[0]['totalFare'] + $completeResult[0]['totalFare']; ?>dd</h3></td>
                            </tr>
						<?php } ?>
                      ...
                      <div class="col-md-5" style="padding-left: 0;">
                        <table>
                          <tbody>
                            <tr>
							<?php if($count_multiways > 4) { ?>
                              <td style="border: none;padding: 0px 5px;"><button style="background: #f37638;border: 1px solid #f37638;padding: 10px 32px;color: #fff;font-weight: 500;border-radius: 5px;margin-top: 43px;margin-bottom: 0;height: 35px;line-height: 10px;"><a href ="<?php echo base_url("flights/detailsmultiway/")?><?php echo  $completeResult[0]['flightId']; ?>/<?php echo  $completeResultReturn[0]['flightId']; ?>/<?php echo  $completeResultthird[0]['flightId']; ?>/<?php echo  $completeResultforth[0]['flightId']; ?>/<?php echo  $completeResultfifth[0]['flightId']; ?>" style="color: #fff">BOOK</a></button></td>
							
							<?php } elseif($count_multiways > 3) { ?>
                              <td style="border: none;padding: 0px 5px;"><button style="background: #f37638;border: 1px solid #f37638;padding: 10px 32px;color: #fff;font-weight: 500;border-radius: 5px;margin-top: 43px;margin-bottom: 0;height: 35px;line-height: 10px;"><a href ="<?php echo base_url("flights/detailsmultiway/")?><?php echo  $completeResult[0]['flightId']; ?>/<?php echo  $completeResultReturn[0]['flightId']; ?>/<?php echo  $completeResultthird[0]['flightId']; ?>/<?php echo  $completeResultforth[0]['flightId']; ?>" style="color: #fff">BOOK</a></button></td>							
							
							<?php } elseif($count_multiways > 2) { ?>
                              <td style="border: none;padding: 0px 5px;"><button style="background: #f37638;border: 1px solid #f37638;padding: 10px 32px;color: #fff;font-weight: 500;border-radius: 5px;margin-top: 43px;margin-bottom: 0;height: 35px;line-height: 10px;"><a href ="<?php echo base_url("flights/detailsmultiway/")?><?php echo  $completeResult[0]['flightId']; ?>/<?php echo  $completeResultReturn[0]['flightId']; ?>/<?php echo  $completeResultthird[0]['flightId']; ?>" style="color: #fff">BOOK</a></button></td>
