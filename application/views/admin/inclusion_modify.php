...
<html lang="en">
<head>
<title>Tours Inclusion/Exclusion Modify</title>
<meta charset="utf-8">
             	...
             	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b><i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Tours Inclusion/Exclusion Modify</b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/inclusion/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/inclusion/edit', $attributes);
							     ?>
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Tour Inclusion / Exclusion  * </span></label>
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('TourInclusionsName'); ?></span>
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'TourInclusionsName', 'id' => 'TourInclusionsName', 'value' =>$edit_inclusion[0]['TourInclusionsName'], 'placeholder' => 'Theam Name', 'class'=>"form-control margin_bottom");
                           ...
                           <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
                                            ...
                                            $data = array('name'  => 'SortOrder', 'id' => 'SortOrder', 'value'=>$edit_inclusion[0]['SortOrder']  , 'placeholder' => '', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
										...
										//-------------------------------------------------------------------------------------------------------------------
										$data = array('id'  => $edit_inclusion[0]['TourInclusionsId'] );
										echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
