...
<body>
	<div id="wrapper">
     ...
     <div class="main">
			...
			<div class="panel">
				...
				<div class="panel-body">
                      ...
                      <div class="col-md-12 col-xs-12 margin_top">  <?php
                                    if($error = $this->session->flashdata('admin_added')){  ?>
            ...
            <a  href="<?php echo base_url('admin/admin/edit')."?id=".$val['adm_id'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php echo base_url('admin/admin/delete')."?id=".$val['adm_id'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
