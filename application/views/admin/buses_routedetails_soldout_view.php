...
<body>
	<div id="wrapper">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
						 ...
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/busesroutes_soldout/add?bid='.$bid.'&rid='.$rid) ; ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Seat Block </a>
     ...
     <a href="<?php echo base_url('admin/busesroutes_soldout/edit')."?id=".$val['BlockId']."&bid=".$val['BusesRoutsId'].'&rid='.$val['RoutesId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> |   <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/busesroutes_soldout/delete')."?id=".$val['BlockId']."&bid=".$val['BusesRoutsId'].'&rid='.$val['RoutesId'];  ?>&did=<?php echo $val['BlockId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  title="Delete"></a>  
