...
<html lang="en">
  <head>
	<title>Testimonial Modify</title>
	<meta charset="utf-8">
	          ...
	          <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Testimonial Modify</b></h3>
						</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                         ...
                         $data = array('name'  => 'TestimonialTitle', 'id' => 'TestimonialTitle', 'value' =>set_value('TestimonialTitle'),  'placeholder' => 'Testimonial Title', 'class'=>"form-control margin_bottom");
                         echo form_input($data);
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
				 $data = array('name'  => 'ClientName', 'id' => 'ClientName','value' =>set_value('ClientName'),   'placeholder' => 'Client Name', 'class'=>"form-control margin_bottom");
                  echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
                                            ...
                                            $data = array('name'  => 'Designation', 'id' => 'Designation','value' =>set_value('Designation'),   'placeholder' => 'Designation', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
                                 ...
                                 <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
                                         ...
                                         $data = array('name'  => 'TestimonialDescription', 'id' => 'TestimonialDescription', 'value' =>set_value('TestimonialDescription'),  'placeholder' => 'Description ', 'class'=>"form-control margin_bottom");
