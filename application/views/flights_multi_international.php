    ...
    <div id="main">
      ...
      <section class="flight-destinations">
        <div class="container">
          <div class="row">
            <div class="col-lg-12"> 
              <?php  include('includes/flight_leftmenu_internreturn.php'); ?>
            <div>
            <div class="col-lg-9">  
              <div id="flightdata">
                <div class="row">
                ...
                <ul class="flight-table" style="display: flex;justify-content: space-between;align-items: center;">
                  <li>
                    <ul style="display:flex;align-items: center;">
                            
                      <li><img src="http://59.144.168.44/2020/projects/incredible/uploads/flights/EK.png" alt=""></li>
                      <li style="font-size:13px;font-weight:600;text-align: left;left: 10px;position: relative;">Emirates Airlines
                        <p style="font-size:11px;font-weight:400;">EK - 505 </p>
                        <!-- <span style="font-size:11px;font-weight:400;">EK - 505 </span>
                        <span style="font-size:11px;font-weight:400;">EK - 505 </span>
                        <span style="font-size:11px;font-weight:400;">EK - 505 </span>
                        <span style="font-size:11px;font-weight:400;">EK - 505 </span> -->
                      </li>
                  ...
                  <li>
                    <p style="text-align: left;">Feb 07 </p>
                    <h6 style="font-size: 18px;color: #363636;font-weight: 600;">10:25</h6>                              
                    <p> Mumbai </p>                             
                  </li>
                  <li>
                    <h6 style="display: flex;flex-direction: column;text-align: left;font-size: 13px;">39h 5m                                
                    <div class="relative fliStopsSep">
                      <p class="fliStopsSepLine" style="border-top: 3px solid rgb(102, 137, 221);"></p>
                    </div>
                    <span style="font-size: 9px;">2 stop(s)</span></h6>
                  </li>
                  <li> 
                    <p style="text-align: left;">Feb 07 </p>
                    <h6 style="font-size: 18px;color: #363636;font-weight: 600;justify-content: center;">12:10</h6> 
                    <p style="text-align: left;">Dubai</p>
                  </li>
                </ul>

                <ul class="flight-table" style="display:flex;justify-content: space-between;">
                      <li>
                        <ul style="display: flex;">
                          <li class="text-center">
                            <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;">
                          
                              <li><img src="<?php echo base_url('uploads/flights/EK.png'); ?>" alt=""></li>
                              <li style="font-size:13px;font-weight:600;text-align: left;left: 10px;position: relative;">Emirates Airlines                                  <br>
                                <span style="font-size:11px;font-weight:400;">EK - 505 </span>
                                <span style="font-size:11px;font-weight:400;">EK - 505 </span>
                                <span style="font-size:11px;font-weight:400;">EK - 505 </span>
                                <span style="font-size:11px;font-weight:400;">EK - 505 </span>
                            ...
                            <ul class="price-list">
                              <li>
                                <div style="display: flex;align-items: center;margin-bottom: 2px;">
                                  <input type="radio" class="flightIdsnew" name="fav_language" id="pricecheck0" value="15-2-10-4252209580_0BOMDXBEK505DXBBKKEK384KULSINEK7712SINDXBEK355DXBBOMEK504_24334801875210183" style="width: 18px;height: 18px;margin-top: 0px;" onclick="getlightDetails('15-2-10-4252209580_0BOMDXBEK505DXBBKKEK384KULSINEK7712SINDXBEK355DXBBOMEK504_24334801875210183');">&nbsp;&nbsp;
                                  <label for="vehicle1" style="margin-bottom: 0px;line-height: 15px;font-size: 16px;font-weight: 600;color: #444;"> <i class="fa fa-inr"></i> 175,630.50</label>
                                </div>                                
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div class="atls-holder">
                                      <span class="ars-refunsleft ars-lastre">
                                        ECONOMY                                        <span class="cursor-pointer"></span>
                                      </span>
                                    </div>
                                  </div>
                                </div>
                ...
                <div class="flight-table">
                  <table id="flightSortTable">
                        ...
                        <ul style="display: flex;">
                          <li class="text-center">
                            <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;">
                              ...
                              <li><img src="http://localhost/incredible/uploads/flights/EK.png" alt=""></li>
                              <li style="font-size:13px;font-weight:600;text-align: left;left: 10px;position: relative;">Emirates Airlines                                  <br>
                                <span style="font-size:11px;font-weight:400;">EK - 505 </span>
                                <span style="font-size:11px;font-weight:400;">EK - 505 </span>
                                <span style="font-size:11px;font-weight:400;">EK - 505 </span>
                    ...
                    //  echo "<pre>"; print_r($flightArray); die;
                       //foreach ($flightArray as $key => $flightArrayValue) { 
                         //  echo "<pre>"; print_r($flightArrayValue['segmentListValOnward']);
                          //foreach ($flightArrayValue['segmentListValOnward'] as $key => $segmentOnwardVal) {
                        ...
                        <tr>
                          <td class="text-center">
                            <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;">
                              ...
                              <li><img src="<?php //echo base_url();  ?>uploads/flights/<?php //echo $segmentOnwardVal['flightCode']; ?>.png" alt=""></li>
                              <li style="font-size:13px;font-weight:600;text-align: left;left: 10px;position: relative;"><?php //echo $segmentOnwardVal['flightName']; ?>
                                <br>
                                <?php //if(!empty($segmentOnwardVal['flightConnectingTime'])){ foreach ($flightArrayValue['segmentListValOnward'] as $key => $onwardValue) { ?>
                                <span style="font-size:11px;font-weight:400;"><?php //echo $segmentOnwardVal['flightCode']?> - <?php //echo $segmentOnwardVal['flightNumber']; ?> </span>
                                <?php //} }else{ ?> 
                                  <span style="font-size:11px;font-weight:400;"><?php //echo $segmentOnwardVal['flightCode']?> - <?php //echo $segmentOnwardVal['flightNumber']; ?> </span>
                          ...
                          <td>
                            <p style="text-align: left;"><?php //$deptDate = date('M d',strtotime($segmentOnwardVal['departureDateNTime'])); echo $deptDate; ?> </p>
                            <h6 style="font-size: 18px;color: #363636;font-weight: 600;"><?php //$deptTime = date('H:i',strtotime($segmentOnwardVal['departureDateNTime'])); echo $deptTime; ?></h6>                              
                            <p> <?php //echo $segmentOnwardVal['deptCityName']?> </p>                             
                          </td>
                          <td>
                            <h6 style="display: flex;flex-direction: column;text-align: left;font-size: 13px;"><?php 

                                // $totalDuration = '';
                                // $totalConnectFlight = array();
                                // $flightStop=array();

                                // foreach ($flightArrayValue['segmentListValOnward'] as $key => $onwardValue) {

                                //   $totalDuration = $totalDuration + $onwardValue['flightDuration'] +  @$onwardValue['flightConnectingTime'] ;

                                //   if(!empty($onwardValue['flightConnectingTime'])){

                                //     $totalConnectFlight[] = count($onwardValue['flightConnectingTime']);
                                  
                                //   }
                                //   if($onwardValue['flightStop']!=0){
                                    
                                //     $flightStop[] = count($onwardValue['flightStop']);
                                ...
                                // $minutes = $totalDuration; $hours = floor($minutes / 60); $min = $minutes - ($hours * 60); echo $hours."h ".$min."m" ; ?>                                
                            <div class="relative fliStopsSep">
                              <p class="fliStopsSepLine" style="border-top: 3px solid rgb(102, 137, 221);"></p>
                            </div>
                            <span style="font-size: 9px;"><?php //$totalDeptCount =  count($totalConnectFlight) + count($flightStop);  if($totalDeptCount > 0 ){ echo $totalDeptCount." ";  echo "stop(s)";  }else{ echo "Non-stop"; }   ?></span></h6>
                          </td>
                          <td> 
                            <p style="text-align: left;"><?php //$retarriveDate = date('M d',strtotime($segmentOnwardVal['arrivalDateNTime'])); echo $retarriveDate; ?> </p>
                            <h6 style="font-size: 18px;color: #363636;font-weight: 600;justify-content: center;"><?php //$retDate = date('H:i',strtotime($segmentOnwardVal['arrivalDateNTime'])); echo $retDate; 
                            
                            
                            ?></h6> 
                            <p style="text-align: left;"><?php //echo $segmentOnwardVal['arivCityName']; ?></p>
                          </td>
                          <td>
                            <ul class="price-list">
                            <?php //foreach ($flightArrayValue['pricelist']  as $key => $fareList) { ?>
                              <li>
                                <div style="display: flex;align-items: center;margin-bottom: 2px;">
                                  <input type="radio" class="flightIdsnew" name="fav_language" id="pricecheck0" value="<?php //echo $fareList['flightId']; ?>" style="width: 18px;height: 18px;margin-top: 0px;" onclick="getlightDetails('<?php //echo $fareList['flightId']; ?>');">&nbsp;&nbsp;
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #002880;background: #cbd2e1;"><?php  //echo "SNS Saver"; ?></span>  
                                    <?php //} ?>                                      
                                    <div class="atls-holder">
                                      <span class="ars-refunsleft ars-lastre">
                                    ...
                                    <div class="tabs">
                                      ...
                                      <div class="tab-content">
                                        <div id="tab1" class="tab active">
                                          <div style="background: #f9f9f9;margin-bottom: 10px">
                                          <p class="flight-details-top-list"><b><span><?php //echo $flightArrayValue['segmentListValOnward'][0]['deptCityName']; ?></span><span class="ars-arright">→</span><span><?php //echo $flightArrayValue['segmentListValOnward'][count($flightArrayValue['segmentListValOnward']) - 1]['arivCityName']; ?></span></b>&nbsp;&nbsp;<span class="graycolor "><?php //echo date('D, M d Y',strtotime($flightArrayValue['segmentListValOnward'][0]['departureDateNTime'])); ?> </span></p>
                                          <?php //foreach ($flightArrayValue['segmentListValOnward'] as $key => $flightOnwardVal) { ?>
                                          <table>
                                            <tbody>
                                          
                                            <tr>
                                              <td class="text-center" style="background: #dfe9ff;justify-content: flex-start;align-items: center;">
                                                <img src="<?php //echo base_url('uploads/flights/');?><?php //echo $flightOnwardVal['flightCode']; ?>.png" alt=""> <?php //echo $flightOnwardVal['flightCode']; ?> - <?php //echo $flightOnwardVal['flightNumber']; ?>                                                 
                                              </td>
                                              <td style="background: #dfe9ff;">
                                                <span style="font-size: 14px;"><?php //$deptDateNTime = date('M d , H:i',strtotime($flightOnwardVal['departureDateNTime'])); echo $deptDateNTime; ?></span>
                                                <p class="content-p" style="line-height: 0.4;margin-top: 10px;" ><?php //echo $flightOnwardVal['deptCityName']; ?> , <?php //echo $flightOnwardVal['deptCountryName']; ?></p>
                                                <p class="content-p" style="line-height: 0.4;" ><?php //echo $flightOnwardVal['deptAirName']; ?></p>
                                                <p class="content-p" style="line-height: 0.4;" ><?php //echo $flightOnwardVal['deptTerminalName']; ?></p>

                                              </td>
                                              <td style="background: #dfe9ff;">
                                                <div class="flight-detailstyles__BackgroundLn-sc-1i6unua-6 iGruED dF justifyBetween alignItemsCenter backgroundLn"><div class="flight-detailstyles__Oval2-sc-1i6unua-7 dHNyva"></div><span class="padL10 padR10 whiteBg font20"><?php  //$minutes = $flightOnwardVal['flightDuration']; $hours = floor($minutes / 60); $min = $minutes - ($hours * 60); echo $hours."h ".$min."m" ; ?></span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="2rem" height="2rem" class="Flight__FlightIcon-sc-1w228os-0 fWhqRy"><path d="M31.95 16.262c-.012 0-.012 0 0 0-.337.762-2.238 1.3-2.238 1.3l-8.137-.012-8.863 12.925-2.088-.15 4.063-10.875-.225-1.95-9.588-.025L.499 22.05l-.5.063 1.438-5.663-.475-.375-.113-.088.125-.1.475-.363L.024 9.849l.5.063 4.338 4.6h9.6l.225-1.95-4.025-10.887 2.088-.15 8.825 12.963 8.137.012s2.713.762 2.238 1.763z"></path></svg></div>
                                                <p style="text-align:center;"><span><?php  //$deptstop = count($flightOnwardVal['flightStopArr']); if($deptstop > 0 ){ echo $deptstop." "; echo "stop(s)"; }else{ echo "Non-Stop"; } ?> </span><br><span><?php //if(count($flightOnwardVal['flightStopArr'])>0){ foreach ($flightOnwardVal['flightStopArr'] as $key => $onwardStopvalue) {
                                                 //echo "Via:";   echo $onwardStopvalue['flightStopAirCode'];
                                                //} } ?></span></p>
                                              </td>
                                              <td style="background: #dfe9ff;display: flex;flex-direction: column;">
                                                <span style="font-size: 14px;"><?php //$arriveDateNTime = date('M d , H:i',strtotime($flightOnwardVal['arrivalDateNTime'])); echo $arriveDateNTime; ?></span>
                                                <p class="content-p" style="line-height: 0.4; margin-top: 10px;" ><?php //echo $flightOnwardVal['arivCityName']; ?> , <?php //echo $flightOnwardVal['arivCountryName']; ?></p>
                                                <p class="content-p" style="line-height: 0.4;" ><?php //echo $flightOnwardVal['arivAirName']; ?></p>
                                                <p class="content-p" style="line-height: 0.4;" > <?php //echo $flightOnwardVal['arivTerminalName']; ?></p>
                                              </td>
                                            </tr>
                                           
                                          </tbody>
                                        </table>
                                        <?php //if(!empty($flightOnwardVal['flightConnectingTime'])){ ?>
                                        <div style="text-align:center;margin-bottom:10px;margin-top:10px;">
                                          <span style="background: #e3e2e2;padding: 5px 20px;border-radius: 20px;"> Require to change Plane    Layover Time - <?php  //$minutescon = $flightOnwardVal['flightConnectingTime']; $hourscon = floor($minutescon / 60); $mincon = $minutescon - ($hourscon * 60); echo $hourscon."h ".$mincon."m" ; ?>  
                                          </span> 
                                        </div>
                                        <?php //} } ?>
                                        </div>
                                        <div style="background: #f9f9f9;margin-bottom: 10px">
                                        <p class="flight-details-top-list"><b><span><?php //echo $flightArrayValue['segmentListValReturn'][0]['deptCityName']; ?></span><span class="ars-arright">→</span><span><?php //echo $flightArrayValue['segmentListValReturn'][count($flightArrayValue['segmentListValReturn']) - 1]['arivCityName'] ?></span></b>&nbsp;&nbsp;<span class="graycolor "> <?php //echo date('D, M d Y',strtotime($flightArrayValue['segmentListValReturn'][0]['departureDateNTime'])); ?> </span></p>
                                        <?php //foreach ($flightArrayValue['segmentListValReturn'] as $key => $flightReturnVal) { ?>
                                          <table>
                                          <tbody>
                                              <tr>
                                              <td class="text-center" style="background: #dfe9ff;justify-content: flex-start;align-items: center;">
                                                <img src="<?php //echo base_url('uploads/flights/'); ?><?php //echo $flightReturnVal['flightCode']; ?>.png" alt=""><?php //echo $flightReturnVal['flightCode']; ?> - <?php //echo $flightReturnVal['flightNumber']; ?>                                                  
                                              </td>
                                              <td style="background: #dfe9ff;">
                                                <span style="font-size: 14px;"><?php //$retdeptDateNTime = date('M d , H:i',strtotime($flightReturnVal['departureDateNTime'])); echo $retdeptDateNTime; ?></span>
                                                <p class="content-p" style="line-height: 0.4;margin-top: 10px;"><?php //echo $flightReturnVal['deptCityName']; ?> , <?php //echo $flightReturnVal['deptCountryName']; ?></p>
                                                <p class="content-p" style="line-height: 0.4;"><?php //echo $flightReturnVal['deptAirName']; ?></p>
                                                <p class="content-p" style="line-height: 0.4;" ><?php //echo $flightReturnVal['deptTerminalName']; ?></p>
                                              </td>
                                              <td style="background: #dfe9ff;">
                                                <div class="flight-detailstyles__BackgroundLn-sc-1i6unua-6 iGruED dF justifyBetween alignItemsCenter backgroundLn"><div class="flight-detailstyles__Oval2-sc-1i6unua-7 dHNyva"></div><span class="padL10 padR10 whiteBg font20"><?php  //$minutes1 = $flightReturnVal['flightDuration']; $hours1 = floor($minutes1 / 60); $min1 = $minutes1 - ($hours1 * 60); echo $hours1."h ".$min1."m" ; ?></span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="2rem" height="2rem" class="Flight__FlightIcon-sc-1w228os-0 fWhqRy"><path d="M31.95 16.262c-.012 0-.012 0 0 0-.337.762-2.238 1.3-2.238 1.3l-8.137-.012-8.863 12.925-2.088-.15 4.063-10.875-.225-1.95-9.588-.025L.499 22.05l-.5.063 1.438-5.663-.475-.375-.113-.088.125-.1.475-.363L.024 9.849l.5.063 4.338 4.6h9.6l.225-1.95-4.025-10.887 2.088-.15 8.825 12.963 8.137.012s2.713.762 2.238 1.763z"></path></svg></div>
                                                <p style="text-align:center;"><span><?php // $retstop = count($flightReturnVal['flightStopArr']); if($retstop > 0 ){ echo $retstop." "; echo "stop(s)"; }else{ echo "Non-Stop"; } ?> </span><br><span><?php //if(count($flightReturnVal['flightStopArr']) > 0){ foreach ($flightReturnVal['flightStopArr'] as $key => $returnStopvalue) {
                                                 //echo "Via:";   echo $returnStopvalue['flightStopAirCode'];
                                                //} } ?></span></p>
                                              </td>
                                              <td style="background: #dfe9ff;display: flex;flex-direction: column;">
                                                <span style="font-size: 14px;"><?php //$retarriveDateNTime = date('M d , H:i',strtotime($flightReturnVal['arrivalDateNTime'])); echo $retarriveDateNTime; ?></span>
                                                <p class="content-p" style="line-height: 0.4;margin-top: 10px;"><?php //echo $flightReturnVal['arivCityName']; ?> , <?php //echo $flightReturnVal['arivCountryName']; ?></p>
                                                <p class="content-p" style="line-height: 0.4;"><?php //echo $flightReturnVal['arivAirName']; ?></p>
                                                <p class="content-p" style="line-height: 0.4;"> <?php //echo $flightReturnVal['arivTerminalName']; ?></p>
                                              </td>
                                              </tr>
                                           
                                          </tbody>
                                        </table>
                                        <?php //if(!empty($flightReturnVal['flightConnectingTime'])){ ?>
                                        <div style="text-align:center;margin-bottom:10px;margin-top:10px;">
                                          <span style="background: #e3e2e2;padding: 5px 20px;border-radius: 20px;"> Require to change Plane    Layover Time - <?php  //$minutescon1 = $flightReturnVal['flightConnectingTime']; $hourscon1 = floor($minutescon1 / 60); $mincon1 = $minutescon1 - ($hourscon1 * 60); echo $hourscon1."h ".$mincon1."m" ; ?> 
                                          </span> 
                                        </div>
                                        <?php //} }  ?>
                                        </div>
   ...
   console.log(id);
    ...
    function bookFlight(){
        ...
        $(document).ready(function(){
          ...
          var id = $("#priceids").val();
          window.location.href= "<?php echo base_url("flights/detailsreturninternational/")?>"+id;
