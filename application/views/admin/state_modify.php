		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>State Modify</b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/state/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    if($error = $this->session->flashdata('state')){  ?>
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/state/edit', $attributes);
							     ?>
                                   ...
                                   <?php
								     // ------------------------------ adm_status form  ---------------------------------
											   ...
											   foreach($country_list as $country)
											    {
												  $options[$country['countryid']] = $country['country'];
												}
											
											$selected = $edit_state[0]['countryid'];
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('StatesName'); ?></span>
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'StatesName', 'id' => 'StatesName', 'value'=>$edit_state[0]['StatesName'], 'placeholder' => 'State Name', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                               ...
                               <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">State Code</label>
		                			<div class="col-md-2 form-group padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'StateCode', 'id' => 'StateCode','value'=>$edit_state[0]['StateCode'] ,  'placeholder' => 'State Code', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                                    ?>
                                  ...
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
                                        ...
                                        echo form_hidden($data);
										 ...
										 $data = array('id'  => $edit_state[0]['StatesID']);
											echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
