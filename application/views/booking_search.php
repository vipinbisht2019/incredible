...
<!----------------------------End new css------------------------------------>
  ...
  <body class="not-front page-about">
    ...
    <div class="row">
		...
		<a href="<?php echo base_url('booking/flight'); ?>" class="btn-blue">Flight Booking</a>
		<a href="<?php echo base_url('booking/hotel'); ?>"  class="btn-red btn-blue">Hotel Booking</a>
         <!-- <div class="panel">
					...
					?>
                           	<tr>
								...
								<td><?php //$date_created1 = $user_booking['date_created'];  										
										  //$travel_date1 = $user_booking['travel_date'];  										
								...
								<td><?php 
										//$arrival_date_return1 = $user_booking['departure_date'];  										
