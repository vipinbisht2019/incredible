...
<html lang="en">
 <head>
	<title>Buses Unpaid Booking View</title>
	<meta charset="utf-8">
...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Buses Unpaid Booking View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="#" class="btn btn-primary btn-primary1 pull-right margin_bottom">Buses Unpaid Booking View</a>
			...
			echo form_open_multipart('admin/busbookingenc/search', $attributes);
	 ?>
                  ...
                  <?php                         
					  ...
					  // echo"<pre>";
					    // print_r($busbookingenc);
					  // echo"</pre>";
						  
					   

			     if(count($busbookingenc) > 0) { ?>
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                                ...
                                <td style="width: 5%;"> <a href="<?php echo base_url('admin/busbookingenc/details/'.$val['BookingId']); ?>" class="db-done"> <i class="fa fa-info-circle" aria-hidden="true"></i></a> </td>
                          <!--       <td style="width: 6%;"> <a href="<?php echo base_url('admin/busbookingenc/ticketprint/'.$val['BookingId']); ?>" class="db-done"> <i class="fa fa-print" aria-hidden="true"></i></a> </td>
                                <td style="width: 5%;"><a onClick="return confirm('Are you sure you want to cancel?')" href="<?php echo base_url('admin/busbookingenc/busbookingenccancle/').$val['BookingId']; ?>" class="db-done"> <i class="fa fa-window-close" aria-hidden="true"></i></a></td> -->
