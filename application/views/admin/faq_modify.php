              	...
              	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> FAQ Modify</b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/faq/view'); ?>" class="btn btn-primary pull-right  btn-primary1 margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/faq/edit', $attributes);
							     ?>
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">Question *</label>
		                			<div class="col-md-5 form-group padding_opx">
                                     <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('question'); ?></span>
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'question', 'id' => 'question',  'value' =>$edit_faq[0]['question'],  'placeholder' => 'Question ', 'class'=>"form-control margin_bottom");
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">Answer * </label>
		                			<div class="col-md-5 form-group padding_opx">
                                     <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('answer'); ?></span>
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'answer', 'id' => 'answer',  'value' =>$edit_faq[0]['answer'],  'placeholder' => 'Answer ', 'class'=>"form-control margin_bottom");
                                         echo form_textarea($data);
                                    ?>
                                    <p>&nbsp;</p>
		                		  </div>
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                          <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'sortorder', 'id' => 'sortorder',  'value' =>$edit_faq[0]['sortorder'], 'placeholder' => 'Sort Order', 'class'=>"form-control margin_bottom");
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
										...
										$data = array('id'  => $edit_faq[0]['faq_id']);
											echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
