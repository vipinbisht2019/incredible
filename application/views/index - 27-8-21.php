                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4 col-md-2" style="padding: 0px;">
                        <div class="input1_wrapper">
                          ...
                          <div class="input1_inner">
                            <input type="text" name="checkindate" id="checkindate" placeholder="Check In" style="border-radius: 6px;border: #3658a9;width: 100%;"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-4 col-md-2" style="padding: 0px;">
                        <div class="input1_wrapper">
                          ...
                          <div class="input1_inner">
                            <input type="text" name="checkoutdate" id="checkoutdate" placeholder="Check Out" style="border-radius: 6px;border: #3658a9;width: 100%;"/>
                          </div>
                        </div>
                      </div>
                      <!-- <div class="col-md-2 col-sm-1" style="padding: 0px;">
                        <input type="text" name="nights" id="total_night" placeholder="Total Night(s)"  minlength="3" style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #ececec;width: 100%" class="ui-autocomplete-input" autocomplete="off">
                        <!--<input type="text" name="total nights" id="end-date" placeholder="" style="border-radius: 6px;border: #3658a9;width: 100%;"/>-->
                      <!--</div> -->
                      <div class="col-sm-4 col-md-2">
                        <div class="select1_wrapper">
                          <!--<label><span class="label-span">Adult:</span></label>-->
                          <input type="text" name="guestsinfo" id="guestsinfo" value="2 Guests in 1 Room" id="bt"  onclick="toggle3(this)" class="trvl-cnt" readonly>
                            <div class="traveller-count" id="cont3">
                              <div>
                                  ...
                                  <div class="row" style="display: grid;padding: 5px;">
                                    ...
                                    <div class="col-md-6" style="margin-top: -30px;">
                                      <div class="input-group" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;padding: 2px;border-radius: 25px;">
                                        ...
                                        <input type="text" name="noofadults" id="noofadults" class="form-control input-number" value="2" min="2" max="16" style="padding: 6px;width: 40px;background: #fff;box-shadow: none;border: none;">
                                        <span class="input-group-btn">
                                ...
                                <div class="dropdown buysell-cc-dropdown newselectbox" id="childernage">
                                  ...
                                  <select name="childAge" id="childAge" class="form-control">
                                    <option selected="selected" value="1" class="emptyOption" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;border-radius: 4rem;">1</option>
          ...
          $("#updateTraveller2").on("click",function(){ 
            ...
            $("#updateRoomInfo").on("click",function(){ 
              ...
              if(noofrooms > 1){
                ...
                var guestsinfo = totalPax2 + ' ' + 'Guests , ' +   noofrooms + ' Rooms ';  

              }else{      

               var guestsinfo = totalPax2 + ' ' + 'Guests , ' +   noofrooms + ' Room ';  
...
<script>
    ...
    function toggle3(ele3) {
      ...
      if (cont3.style.display == 'block') {
          ...
          document.getElementById(ele3.id).value = '2 Guests in 1 Room';
      }
      else {
