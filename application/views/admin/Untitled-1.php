...
<div class="col-lg-12 col-xs-12">
  ...
  <table class="table">
    ...
    $yrdata = $toursbooking_details[0]['DepartureDate'];     echo date('d-M-Y', strtotime($yrdata. ' + '.$toursbooking_details[0]['NoofNight'].' days'));  ?>   </td>
          ...
          <td class="font_16px"> <?php echo $toursbooking_details[0]['BoardingPoint']; ?>  </td>
...
<div class="col-lg-12">
   ...
   <div class="panel-heading">
   <h5 style="margin: 0px; font-size: 18px;"> <i class="fa fa-inr"></i>  Fare & Seats No. </h5>
   </div>
  ...
  <table class="table">
    ...
    <tbody>
       ...
       <tr>
          ...
          <td class="font_16px"> <i class="fa fa-inr"></i> <?php echo $totalfare=$toursbooking_details[0]['BusFare']*$toursbooking_details[0]['TotalTravellar']; ?>    </td>
          <td class="font_16px"> <i class="fa fa-inr"></i> <?php echo $totalgst=$totalfare*5/100; ?>  </td>
           <td class="font_16px"> <i class="fa fa-inr"></i>  <?php echo $totalpickupcharge=$toursbooking_details[0]['TotalPrice']; ?>  </td>
          <td class="font_16px"> <i class="fa fa-inr"></i> <?php echo $garndtotal = $totalfare+$totalgst+$totalpickupcharge;  ?>   </td>
       </tr> 
...
<!--               <table class="table">
         ...
         <tbody>
            ...
            <tr>
               <td class="font_16px" style="border-top: 0px;"> Seat no.  </td>
               <td class="font_16px" style="border-top: 0px;"> 2,3 </td>
            </tr>

            <tr>
               <td class="font_16px">  Fare : </td>
               <td class="font_16px"> <i class="fa fa-inr"></i> 1600 </td>
            </tr>

            <tr>
               <td class="font_16px"> GST  </td>
               <td class="font_16px"> <i class="fa fa-inr"></i> 40 </td>
            </tr>

            <tr>
               <td class="font_16px"> Pickup Charges  </td>
               <td class="font_16px"> <i class="fa fa-inr"></i> 150 </td>
            </tr>

            <tr>
               <td class="font_16px"> Totals Fare  </td>
               <td class="font_16px"> <i class="fa fa-inr"></i> 1950 </td>
            </tr>
