...
<html lang="en">
<head>
<title>Room Rate Type Add</title>
<meta charset="utf-8">
		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Room Rate Type Add</b></h3>
						</div>
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
										...
										echo form_open_multipart('admin/roomratetype/add', $attributes);
							     ?>
                                   ...
                                   <?php
										...
										/*	unset($options);									
											...
											foreach($hotels as $val)
											 ...
											 $selected=set_value('HotelId');	
										     echo form_dropdown('HotelId', $options,'','class="form-control margin_bottom"');*/
                                    ?>
		                		  </div>
                               </div>                   
-->
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('room_rate_type'); ?></span>
                                       <?php
						
               $data = array('name'  => 'room_rate_type', 'id' => 'room_rate_type', 'value'=>set_value('room_rate_type'), 'placeholder' => 'Room Rate Type', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                              ...
                              <!--  <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
		/* $data = array('name'  => 'Description', 'id' => 'Overview','value'=>set_value('Description') ,  'placeholder' => 'Description', 'class'=>"form-control margin_bottom");
