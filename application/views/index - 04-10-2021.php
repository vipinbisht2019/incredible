                  ...
                  <form name="searchhotel" id="searchhotel"  method="post" action="<?php echo base_url('hotels'); ?>" class="form1">
                    ...
                    <div class="row">
                      <div class="col-sm-3 col-md-2">
                        <div class="select1_wrapper">
                          <div class="select1_inner input-container">
                            ...
                            <input type="text" name="city" id="search_city" placeholder ="Search by City" minlength="3" style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #ececec;width: 100%;border-left:none;">
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-4 col-md-2" style="padding: 0px;">
                        <div class="input1_wrapper">
                          <div class="input1_inner">
                            <input type="text" name="checkindate" id="checkindate" placeholder="Check In" style="border-radius: 6px;border: #3658a9;width: 100%;" autocomplete="off"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-4 col-md-2" style="padding: 0px;">
                        <div class="input1_wrapper">
                          <div class="input1_inner">
                            <input type="text" name="checkoutdate" id="checkoutdate" placeholder="Check Out" style="border-radius: 6px;border: #3658a9;width: 100%;" autocomplete="off"/>
                          </div>
                        </div>
                      </div>
                              ...
                              <div>
                                <div class="center">
                                  <div class="row" style="display: grid;padding: 5px;">
                                    <div class="col-md-6" style="width: 100%;">
                                      <p style="font-weight: 500;font-size: 12px;">Rooms<span style="color: #969696;font-size: 10px;">(Max 5)</span>
                                      </p>
                                    </div><br>
                                    <div class="col-md-6" style="margin-top: -30px;">
                                  ...
                                  <div class="row" style="display: grid;padding: 5px;">
                                    ...
                                    <div class="col-md-6" style="margin-top: -30px;">
                                      <div class="input-group" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;padding: 2px;border-radius: 25px;">
                                        ...
                                        <input type="text" name="noofchild" id="noofchild" class="form-control input-number" value="0" min="0" max="9" style="padding: 6px;width: 40px;background: #fff;box-shadow: none;border: none;">
                                        <span class="input-group-btn">
                                ...
                                <div class="dropdown buysell-cc-dropdown newselectbox" id="childernage">
                                  ...
                                  <select name="childAge1" id="childAge" class="form-control">
                                  <option value="0">Select Child 1 Age</option>
                                ...
                                <div class="dropdown buysell-cc-dropdown newselectbox" id="childernage1">
                                  ...
                                  <select name="childAge2" id="childAge" class="form-control">
                                  <option value="0">Select Child 2 Age</option>
                                    <option  value="1" class="emptyOption" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;border-radius: 4rem;">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                                ...
                                <div class="dropdown buysell-cc-dropdown newselectbox" id="childernage2">
                                  ...
                                  <select name="childAge3" id="childAge" class="form-control">
                                    <option value="0">Select Child 3 Age</option>
                                    <option  value="1" class="emptyOption" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;border-radius: 4rem;">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                                ...
                                <div class="dropdown buysell-cc-dropdown newselectbox" id="childernage3">
                                  <p style="font-weight: 500;font-size: 12px;margin-bottom: 0;font-family: 'Poppins',sans-serif;">Child 4
                                  <span style="color: #969696;font-size: 10px;">Age</span>
                                  </p>
                                  <select name="childAge4" id="childAge" class="form-control">
                                    <option value="0">Select Child 4 Age</option>
                                    <option  value="1" class="emptyOption" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;border-radius: 4rem;">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                                ...
                                <div class="dropdown buysell-cc-dropdown newselectbox" id="childernage4">
                                  <p style="font-weight: 500;font-size: 12px;margin-bottom: 0;font-family: 'Poppins',sans-serif;">Child 5
                                  <span style="color: #969696;font-size: 10px;">Age</span>
                                  </p>
                                  <select name="childAge5" id="childAge" class="form-control">
                                    <option value="0">Select Child 5 Age</option>
                                    <option  value="1" class="emptyOption" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;border-radius: 4rem;">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                                ...
                                <div class="dropdown buysell-cc-dropdown newselectbox" id="childernage5">
                                  <p style="font-weight: 500;font-size: 12px;margin-bottom: 0;font-family: 'Poppins',sans-serif;">Child 6
                                  <span style="color: #969696;font-size: 10px;">Age</span>
                                  </p>
                                  <select name="childAge5" id="childAge" class="form-control">
                                    <option value="0">Select Child 6 Age</option>
                                    <option  value="1" class="emptyOption" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;border-radius: 4rem;">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                                ...
                                <div class="dropdown buysell-cc-dropdown newselectbox" id="childernage6">
                                  <p style="font-weight: 500;font-size: 12px;margin-bottom: 0;font-family: 'Poppins',sans-serif;">Child 7
                                  <span style="color: #969696;font-size: 10px;">Age</span>
                                  </p>
                                  <select name="childAge7" id="childAge" class="form-control">
                                    <option value="0">Select Child 7 Age</option>
                                    <option  value="1" class="emptyOption" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;border-radius: 4rem;">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                                ...
                                <div class="dropdown buysell-cc-dropdown newselectbox" id="childernage7">
                                  <p style="font-weight: 500;font-size: 12px;margin-bottom: 0;font-family: 'Poppins',sans-serif;">Child 8
                                  <span style="color: #969696;font-size: 10px;">Age</span>
                                  </p>
                                  <select name="childAge8" id="childAge" class="form-control">
                                    <option value="0">Select Child 8 Age</option>
                                    <option  value="1" class="emptyOption" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;border-radius: 4rem;">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                                ...
                                <div class="dropdown buysell-cc-dropdown newselectbox" id="childernage8">
                                  <p style="font-weight: 500;font-size: 12px;margin-bottom: 0;font-family: 'Poppins',sans-serif;">Child 9
                                  <span style="color: #969696;font-size: 10px;">Age</span>
                                  </p>
                                  <select name="childAge9" id="childAge" class="form-control">
                                    <option value="0">Select Child 9 Age</option>
                                    <option  value="1" class="emptyOption" style="box-shadow: rgb(0 0 0 / 13%) 0px 1px 4px 0px;border-radius: 4rem;">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                                ...
                                <!--<div class="eHRHNU lhNBSu kfVCVI">
                                  <h4 class="hAEfdZ dkRohM">1</h4>
                                  <span class="dxKRvV">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="hxaLyN">
                                      <path d="M16 26a3.067 3.067 0 01-2.305-1.04L.614 10.091A2.462 2.462 0 014.312 6.84l11.439 13.003a.334.334 0 00.501 0L27.691 6.84a2.462 2.462 0 113.697 3.251L18.311 24.955A3.079 3.079 0 0116.002 26z"></path>
                                    </svg>
                                  </span>
                                </div>-->
          ...
          $("#updateTraveller2").on("click",function(){ 
            ...
            $("#childPlus").on("click", function(){
              ...
              if(children == 4){
                ...
                var childernage3 = document.getElementById('childernage3');
                childernage3.style.display = 'block';
              ...
              var childernage4 = document.getElementById('childernage4');
              childernage4.style.display = 'block';
              ...
              if(children == 6){
                ...
                var childernage5 = document.getElementById('childernage5');
                childernage5.style.display = 'block';
              ...
              if(children == 7){
                ...
                var childernage6 = document.getElementById('childernage6');
                childernage6.style.display = 'block';
              ...
              if(children == 8){
                ...
                var childernage7 = document.getElementById('childernage7');
                childernage7.style.display = 'block';
              ...
              if(children == 9){
                ...
                var childernage8 = document.getElementById('childernage8');
                childernage8.style.display = 'block';
