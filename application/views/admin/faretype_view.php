...
<html lang="en">
 <head>
	<title>Tour Fare Type View</title>
	<meta charset="utf-8">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Tour Fare Type View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/faretype/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Tour Fare Type </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/faretype/bulk_action', $attributes); 
					?>                                
             ...
             <a href="<?php echo base_url('admin/faretype/edit')."?id=".$val['FareTypeId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
             <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/faretype/delete')."?id=".$val['FareTypeId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
