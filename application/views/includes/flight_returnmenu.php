        ...
        <div class="sidebar-item">
            ...
            <div class="sidebar-content">
                <div class="row">
                   ...
                   <!-- <div class="col-md-3">
                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="dethreest">
                            <input type="checkbox" class="dep2" name="stops" id="dethreest" onclick="getPage();" value="2">
                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                <span class="black" id="dethreestt">3+</span>
                            </span>
                        </label>
                        <!--<p class="filter-p">2+ Stops</p>-->
                    <!--</div>-->
                  <div class="col-md-3">
                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="ddethreest">
                        <input type="checkbox" class="dep2" name="stops" id="ddethreestop" onclick="getPage();" value="3">
                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                            <span class="black" id="ddethreestt">3+</span>
                        </span>
                    </label>
                    <!--<p class="filter-p">2+ Stops</p>-->
                </div>
            ...
            <div class="sidebar-content">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="rethreestt">
                            <input type="checkbox" class="dep2" name="stops" id="rethreesttt" onclick="getPage();" value="2">
                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                <span class="black" id="rethreestttt">3+</span>
                            </span>
                        </label>
                        <!--<p class="filter-p">2+ Stops</p>-->
                    </div>
                ...
                <div class="row">
					...
					<div class="col-md-3" style="padding: 5px;">
                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="before111" >
                            <input type="checkbox"  class="dep2" name="depatureId" id="before11" onclick="getPage(this);" value="0,1,2,3,4,5:59" >
                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                ...
                <div class="row">
					...
					<div class="col-md-3" style="padding: 5px;">
                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="rbefore111" >
                            <input type="checkbox"  class="dep2" name="rdepatureId" id="rbefore11" onclick="getPage1(this);" value="0,1,2,3,4,5:59" >
                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
