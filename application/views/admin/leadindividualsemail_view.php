...
$(function() {
	...
	$("#Email").autocomplete(
	 {
	 	source:'<?php echo base_url('admin/leadindividualsemail/emailsource?term=ar') ?>',
		minLength:3
	});
...
<body>
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Send  Email</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
   ...
   <?php
	     // ------------------------------ Login Id form open ---------------------------------
					 ...
					 echo form_open_multipart(base_url('admin/leadindividualsemail/send'), $attributes); 
					    ?>    
                          <div class="row">
		                	   	...
		                	   	<label class="col-md-2 text-left padding_opx">
		                			<span><strong> To Email </strong></span></label>
		                			   ...
		                			   <div class="col-md-6 form-group padding_opx">
                                        ...
                                        <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'Email', 'id' => 'Email',  'value' =>set_value('Email'),  'placeholder' => 'To Email', 'class'=>"form-control margin_bottom");
