...
<html lang="en">
 <head>
	<title>Tour Frequency View</title>
	<meta charset="utf-8">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Tour Frequency View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/frequency/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Frequency </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                      ...
                      <div class="col-md-12 col-xs-12 margin_top">  <?php
                                    if($error = $this->session->flashdata('frequency')){  ?>
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/frequency/bulk_action', $attributes); 
					?>                                
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                            	...
                            	<td><?php echo $val['TourFrequencyId'] ?></td>
								<td><?php echo $val['TourFrequency'] ?></td>
             ...
             <a href="<?php echo base_url('admin/frequency/edit')."?id=".$val['TourFrequencyId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
             <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/frequency/delete')."?id=".$val['TourFrequencyId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['TourFrequencyId'],  'checked'=> false, 'class'=>" margin_bottom" );
