                ...
                <table id="flightSortTable">
                  ...
                  <?php 
                      ...
                      foreach($completeResult as $key => $flightValue) {
                       ...
                       // foreach ($segflightValue['segmentsList'] as $key => $flightValue) {
                         
                          //  echo "<pre>"; print_r($flightValue);
                                          ...
                                          <div id="tab1" class="tab active">
                                            <table>
                                              <tbody>
                                                ...
                                                <tr>
                                                <?php if(!empty($flightValue['connectingFlights'])){ ?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td style="background: #dfe9ff;display: flex;flex-direction: column;">
                                                      ...
                                                      <!--<h6><?php echo $flightValue['connectdepartureAirportCode']  ?> , <?php echo $flightValue['connectdepartureCountry']  ?><b> <?php echo $arrivalTime; ?> </b></h6>-->
                                                      <p class="content-p"> <?php echo $flightValue['connectdepartureAirportName']  ?> , <?php echo $flightValue['connectdepartureCity']  ?></p>
                                                    </td>
                                                  </tr>
                                                  
                                                <?php //if(!empty($flightValue['connectingFlights'])){
                                                  
                                                  $conminutes = $flightValue['conduration'];
                                                  $conhours = floor($conminutes / 60);
                                                  $conmin = $conminutes - ($conhours * 60);


                                                 // $conminutes = $flightValue['connectingFlights'];
                                                ...
                                                ?>
                                                  ...
                                                  <tr style="background: #dfe9ff;">
                                                    <td colspan="4">
                                                      <div class="col-sm-12 text-center">
                                                        <div class="apt-mainlaydesktop mt-20 mb-20">
                                                          <p class="apt-laypverdesktop">
                                                            <span class="at-fontweight mr-20">Require to change Plane</span>
                                                            <span>Layover Time -  <?php echo $conhours."h ".$conmin."m" ; ?></span>
                                                          </p>
                                                        </div>
                                                      </div>
                                                    </td>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td class="text-center" style="background: #dfe9ff;justify-content: flex-start;align-items: center;">
                                                      <img src="<?php echo base_url('uploads/flights/');?><?php echo $flightValue['arriflghtCode'] ; ?>.png" alt=""> <?php echo $flightValue['arriflightName'] ?> <?php echo $flightValue['arriflghtCode'] ?> - <?php echo $flightValue['arriflghtNumber']; ?>
                                                    </td>
                                                    <td style="background: #dfe9ff;">
                                                      <!--<h6 style="display: block;"><?php echo $flightValue['arriflghtName'] ?> <?php echo $flightValue['arriflghtCode'] ?> - <?php echo $flightValue['arriflghtNumber']; ?> (<?php echo $st; ?>)</h6>-->
                                                      <span style="font-size: 14px;"><?php echo  $departureDate = date("M d",strtotime($flightValue['condepartureTime'])); ?> ,<?php echo $departureTime; ?></span>
                                                      <p class="content-p"><?php echo $flightValue['connectdepartureAirportName']  ?> , <?php echo $flightValue['connectdepartureCountry']  ?></p>
                                                      <!--<h6 style="display: block;"><p> <?php //echo $departureTime; ?></p></h6>-->
                                                    </td>
                                                    <td style="background: #dfe9ff;">
                                                      <div class="flight-detailstyles__BackgroundLn-sc-1i6unua-6 iGruED dF justifyBetween alignItemsCenter backgroundLn"><div class="flight-detailstyles__Oval2-sc-1i6unua-7 dHNyva"></div><span class="padL10 padR10 whiteBg font20"><?php echo $conhours."h ".$conmin."m" ; ?></span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="2rem" height="2rem" class="Flight__FlightIcon-sc-1w228os-0 fWhqRy"><path d="M31.95 16.262c-.012 0-.012 0 0 0-.337.762-2.238 1.3-2.238 1.3l-8.137-.012-8.863 12.925-2.088-.15 4.063-10.875-.225-1.95-9.588-.025L.499 22.05l-.5.063 1.438-5.663-.475-.375-.113-.088.125-.1.475-.363L.024 9.849l.5.063 4.338 4.6h9.6l.225-1.95-4.025-10.887 2.088-.15 8.825 12.963 8.137.012s2.713.762 2.238 1.763z"></path></svg></div>
                                                      <p style="text-align:center;">Flight Duration</p>
                                                    </td>
                                                    <td style="background: #dfe9ff;display: flex;flex-direction: column;">
                                                      <span style="font-size: 14px;"><?php echo  $departureDate = date("M d",strtotime($flightValue['conarrivalTime'])); ?> , <?php echo $arrivalTime; ?></span>
                          ...
                          <tbody>
                           ...
                           // echo "<pre>"; print_r($completeResult[0]['pricelist'][0]['flightId']); 
                            ...
                            $i=0; foreach($completeResult as $key => $flightValue) { 
                              ...
                              //echo "<pre>"; print_r($flightValue['pricelist'][0]['flightId']); 

                              // if($completeResult[0]['pricelist'][0]['flightId'] == $flightValue['pricelist'][0]['flightId']){
                            ...
                            <tr>
                              <td class="text-center">
                                <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;flex-direction: column;">
                                  <li><img src="<?php echo base_url('uploads/flights/');?><?php echo $flightValue['flghtCode'] ; ?>.png" alt=""></li>
                                  <li style="font-size:13px;font-weight:600;text-align: left;left: 0px;position: relative;"><?php echo $flightValue['flghtName']; ?>
                                ...
                                <ul>
                                    <?php  $fp = 0; 
                                      ...
                                      <li>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                          <?php  if($fareList['fareIdentifier'] == 'LITE' || $fareList['fareIdentifier'] == 'SALE'){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: green;background: #c0f1c0;"><?php  echo "SNS PRO"; ?></span><?php }else if($fareList['fareIdentifier'] == 'PUBLISHED'){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #002880;background: #cbd2e1;"><?php  echo "SNS Saver"; ?></span><?php } else if($fareList['fareIdentifier'] == 'FLEXI_PLUS' || $fareList['fareIdentifier'] ==  'PREMIUM_FLEX' ){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #a55319;background: #e5d9cf;"><?php  echo "SNS Flexi"; ?></span><?php }else if($fareList['fareIdentifier'] == 'SPECIAL_RETURN'){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #b1941e;background: #fff5cf;"><?php  echo "SNS Return"; ?></span><?php } else{  echo $fareList['fareIdentifier']; }  ?>
                                            <div class="atls-holder">
                                              <span class="ars-refunsleft ars-lastre">
                                                <?php 
                                                  if($fareList['adultcabinClassFare'] !=''){
...
<?php if(!empty($returnMaximumPrice)){ ?>
    ...
    $('#rethreest').on('change', function(){
      //alert("3");
    	if($(this).is(':checked')){
           $("#rethreest").css('background-color',"#244082");
           $("#rethreest").css('color',"#ffffff");
        } else {
            $("#rethreest").css('background-color',"#244082");
            $("#rethreest").css('color',"#ffffff");
        }
