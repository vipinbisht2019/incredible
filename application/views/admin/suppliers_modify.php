             	...
             	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b><i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Suppliers Modify</b></h3>
						</div>
...
<!-- Html ##################################################### -->
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/suppliers/edit', $attributes);
							     ?>
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        ...
                                        <?php
											...
											foreach($suppliersdropdown as $val)
											 ...
											 $selected=$edit_suppliers[0]['TypeId'];	
 ...
 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Name form open ---------------------------------
               $data = array('name'  => 'ContactPersonName',  'value'=>$edit_suppliers[0]['ContactPersonName'], 'placeholder' => 'ContactPersonName', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Name form open ---------------------------------
               $data = array('name'  => 'CompanyName', 'id' => 'CompanyName', 'value'=>$edit_suppliers[0]['CompanyName'], 'placeholder' => 'Company Name', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
               ...
               $data = array('name'  => 'EmailID', 'id' => 'EmailID', 'value'=>$edit_suppliers[0]['EmailID'], 'placeholder' => 'Email', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'ContactNumber', 'id' => 'ContactNumber', 'value'=>$edit_suppliers[0]['ContactNumber'], 'placeholder' => 'Contact Number', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'Country', 'id' => 'Country', 'value'=>$edit_suppliers[0]['Country'], 'placeholder' => 'Country', 'class'=>"form-control margin_bottom");
                echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'City', 'id' => 'City', 'value'=>$edit_suppliers[0]['City'], 'placeholder' => 'City', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'Website', 'id' => 'Website', 'value'=>$edit_suppliers[0]['Website'], 'placeholder' => 'Website', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'Skype', 'id' => 'Skype', 'value'=>$edit_suppliers[0]['Skype'], 'placeholder' => 'Skype', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'WhatsApp', 'id' => 'WhatsApp', 'value'=>$edit_suppliers[0]['WhatsApp'], 'placeholder' => 'WhatsApp', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'Reference', 'id' => 'Reference', 'value'=>$edit_suppliers[0]['Reference'], 'placeholder' => 'Reference', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <?php
								     // ------------------------------ adm_status form  ---------------------------------
										 ...
										 $selected=	$edit_suppliers[0]['Status'];						
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
										...
										//-------------------------------------------------------------------------------------------------------------------
										$data = array('id'  => $edit_suppliers[0]['SuppliersId'] );
										echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
