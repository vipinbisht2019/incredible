		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>City Modify</b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/city/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    if($error = $this->session->flashdata('city')){  ?>
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/city/edit', $attributes);
							     ?>
                                    ...
                                    <select name="countryid" id="countryid" onChange="getState()";>
                                        ...
                                        <?php foreach($country_list as $country){ ?>
                                            ...
                                            <option value="<?php echo $country['countryid']?>"<?php if($country['countryid'] == $edit_city[0]['countryid']){echo "selected";}?>><?php echo $country['country']?></option>
		                			...
		                			<div class="col-md-2 form-group padding_opx">
                                      ...
                                      <select name="stateid" id="stateid">
                                        ...
                                        <?php foreach($state_list as $state){ ?>
                                            ...
                                            <option value="<?php echo $state['StatesID']?>"<?php if($state['StatesID'] == $edit_city[0]['stateid']){echo "selected";}?>><?php echo $state['StatesName']?></option>
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('city_name'); ?></span>
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'city_name', 'id' => 'city_name', 'value'=>$edit_city[0]['city_name'], 'placeholder' => 'City Name', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                               ...
                               <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">City Code</label>
		                			<div class="col-md-2 form-group padding_opx">
                                     <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('StateCode'); ?></span>
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'city_code', 'id' => 'city_code','value'=>$edit_city[0]['city_code'] ,  'placeholder' => 'City Code', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                                    ?>
                                  ...
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
                                        ...
                                        echo form_hidden($data);
										 ...
										 $data = array('id'  => $edit_city[0]['cityid']);
											echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
...
function getState(){
			...
			var countryId= document.getElementById("countryid").value;
			 jQuery.ajax
				({
				  type: "POST",
				  url: "<?php echo base_url();?>admin/City/getStateList",
