     ...
     <div class="main">
             	...
             	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong><i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Testimonials View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/testimonials/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom"> Add testimonials </a>
                            <br>
						 </div>
					</div>
				</div>
			...
			<div class="panel">
               ...
               <?php                         
						...
						echo form_open_multipart('admin/testimonials/bulk_action', $attributes); 
					?>                              
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                            	...
                            	<td><?php echo $val['TestimonialId'] ?></td>
								<td><?php echo $val['TestimonialTitle'] ?></td>
                                ...
                                <td>
								        <?php
											  if($val['Photo']!='') { ?>
                                               <img src="<?php echo base_url('uploads/testimonials/'.$val['Photo']) ?>" width="200px"> <br>
											  <?php } else { ?>
            ...
            <a href="<?php echo base_url('admin/testimonials/edit')."?id=".$val['TestimonialId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/testimonials/delete')."?id=".$val['TestimonialId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
                                  ...
                                  <?php
                                            ...
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['TestimonialId'],  'checked'=> false, 'class'=>" margin_bottom" );
