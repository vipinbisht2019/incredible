                          ...
                          ?>
                            <tr>
                              ...
                              <td style="border: none;padding: 0px 5px;">
                                ...
                                <p style="margin-bottom: 3px;"><?php echo $completeResult[0]['flghtName']; ?></p>
                        ...
                        <table>
                          <tbody style="border-right:  1px dashed rgb(194, 194, 194);">
                            <tr>
                              ...
                              <td style="border: none;padding: 0px 5px;">
                                <p style="font-size: 11px;font-weight: 500;margin-bottom: 0;"><?php echo  $arrivalDate = date("D,d M",strtotime($completeResultReturn[0]['arrivalTime']));?></p>
                    ...
                    <div class="row" style="display: flex">
                      <div class="col-md-6" style="padding-right: 0;">
                        <table>
                          <tbody>
                            <tr>
                              <td style="border: none;padding: 0px 5px;"><h3 style="margin-top: 35px;margin-bottom: 0;padding-bottom: 0;text-align: right;font-weight:600"><i class="fa fa-inr"></i><?php echo $totaFare = $completeResultReturn[0]['totalFare'] + $completeResult[0]['totalFare']; ?></h3></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    ?>
                            ...
                            <tr>
                              <td class="text-center">
                                ...
                                <!--<img src="<?php echo base_url('uploads/flights/');?><?php echo $flightValue['flghtCode'] ; ?>.png" alt="">--></td>
                                <td>
                                ...
                                <td>
                                  ...
                                  <p style="text-align: center;"><!--<?php echo $flightValue['arrivalAirportCode']  ?> --> <?php echo $flightValue['arrivalCity'] ?><!--, <?php echo $flightValue['arrivalCountry'] ?>--></p>
                                ...
                                <td>
                                  <ul class="ars-radiolist">
                                      <li>
                                        ...
                                        <div class="check"></div>
                                        <span class="label label-warning ars-flightlabel ars-refunsleft">Lite</span>
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                    <tr>
                                                      ...
                                                      <p class="flight-details-top-list"><b><span><?php echo $flightValue['departureCity']  ?></span><span class="ars-arright">→</span> <span><?php echo $flightValue['arrivalCity'] ?></span></b><span class="graycolor "> Thu, Oct 14th 2021</span></p>
                                                    ...
                                                    <td style="background: #dfe9ff;">
                                                      ...
                                                      <span style="font-size: 14px;">Oct 14, Thu,  <?php echo $departureTime; ?></span>
                                                    ...
                                                    <td style="background: #dfe9ff;display: flex;flex-direction: column;">
                                                      <span style="font-size: 14px;">Oct 14, Thu,  <?php echo $arrivalTime; ?></span>
                                                        ...
                                                        <div class="col-sm-12 text-center">
                                                          <div class="apt-mainlaydesktop mt-20 mb-20">
                                                            <p class="apt-laypverdesktop">
                                                              ...
                                                              <span>Layover Time - 04h 20m</span>
                                                            </p>
                                                          </div>
                                                        </div>
                                                      </div>
                      ...
                      <?php // echo "<pre>"; print_r($flightValue); ?>
                                              <table>
                                                ...
                                                <tbody><tr style="background: #dfe9ff;">
                        
                                                  <td style="border: 0px solid #e0e0e0;">Base Fare(<?php echo $flightValue['countadultPax']; ?> Adult )</td>
                                                  <td style="border: 0px solid #e0e0e0;"><i class="fa fa-inr"></i> <?php echo $basefares_Adult = $flightValue['adultBaseFare'] * $flightValue['countadultPax']; ?> </td>
                                                </tr>
                        <tr style="background: #dfe9ff;">
                                                  <td style="border: 0px solid #e0e0e0;">Taxes and Fees( <?php echo $flightValue['countadultPax']; ?> Adult )</td>
                                                  <td style="border: 0px solid #e0e0e0;"><i class="fa fa-inr"></i> <?php echo $taxes_Adult = $flightValue['adultTaxFare'] * $flightValue['countadultPax']; ?></td>
                                                </tr>
                        ...
                        <tr style="background: #dfe9ff;">
                                                  <td style="border: 0px solid #e0e0e0;">Child Fare(<?php echo $flightValue['countchildPax']; ?> Child )</td>
                                                  <td style="border: 0px solid #e0e0e0;"><i class="fa fa-inr"></i> <?php echo $basefares_Child = $flightValue['childBaseFare'] * $flightValue['countchildPax']; ?> </td>
                                                </tr>
                        <tr>
                                                  <td style="border: 0px solid #e0e0e0;">Taxes and Fees( <?php echo $flightValue['countchildPax']; ?> Child )</td>
                                                  <td style="border: 0px solid #e0e0e0;"><i class="fa fa-inr"></i> <?php echo $taxes_Child =  $flightValue['childTaxFare'] * $flightValue['countchildPax']; ?></td>
                                                </tr>
                        <?php } ?>
                        ...
                        <tr>
                                                  <td style="border: 0px solid #e0e0e0;">Infant Fare(<?php echo $flightValue['countinfantPax']; ?> Infant )</td>
                                                  <td style="border: 0px solid #e0e0e0;"><i class="fa fa-inr"></i> <?php echo $basefares_Inafant = $flightValue['infantBaseFare'] * $flightValue['countinfantPax']; ?> </td>
                                                </tr>
                        <tr>
                                                  <td style="border: 0px solid #e0e0e0;">Taxes and Fees( <?php echo $flightValue['countinfantPax']; ?> Infant )</td>
                                                  <td style="border: 0px solid #e0e0e0;"><i class="fa fa-inr"></i> <?php echo $taxes_Infant = $flightValue['infantTaxFare'] * $flightValue['countinfantPax']; ?></td>
                                                </tr>
                        <?php } ?>
                        
                                                
                                                <tr style="border-top: 1px solid #cbcbcb;background: #dfe9ff;">
                                                  <td style="border: 0px solid #e0e0e0;"><b>Total Fare</b></td>
                                              <td style="border: 0px solid #e0e0e0;"><b><i class="fa fa-inr"></i> <?php echo $basefares_Adult  + $taxes_Adult + @$basefares_Child + @$taxes_Child  + @$basefares_Inafant + @$taxes_Infant; ?></b></td>
                                                </tr>
                                              </tbody></table>
                                            </div>
                                            ...
                                            <div id="tab3" class="tab">
                                              ...
                                              <table style="border: 1px solid #ddd;">
                                                <tbody><tr style="background: #f7f9ff;height: 40px;">
                                                ...
                                                <tr style="background:#dfe9ff;height:40px;">
                                                  ...
                                                  <td style="border: 0px solid #e0e0e0;">Adult: <?php echo $flightValue['adultCheckInBaggage']; ?> <!--(1 piece only)--></td>
                                                  <td style="border: 0px solid #e0e0e0;"> <?php echo $flightValue['adultCabinBaggage']; ?> <!--(1 piece only)--></td>
                                                </tr>
                                              </tbody>
                                            </table>
                                            ...
                                            <div id="tab4" class="tab">
                                              ...
                                              <div id="divMsg" style="background-color: rgb(234 240 253); color: rgb(255, 255, 255); height: auto; width: 100%; text-align: center; display: block; border-radius: 4px;">
                                                <button class="ars-activelist fare-rules-tabs">DEL-HYD</button>
