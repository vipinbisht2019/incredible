		...
		<div class="main-content">
		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Tour Buses Add</b></h3>
						</div>
         ...
         <div class="stepwizard-step col-md-1">
            <a href="<?php echo base_url('admin/tour_train/edit?TourId='.$TourId); ?>"><button type="button" class="btn btn-primary btn-circle" >9</button></a>
               ...
               <div class="stepwizard-step col-md-1">
              <a href="<?php echo base_url('admin/tour_bus/edit?TourId='.$TourId); ?>"><button type="button" class="btn btn-primary btn-circle" disabled="disabled">10</button></a>
                <p>Bus</p>
            </div>
...
<?php
 ...
 // ------------------------------ admin form open ---------------------------------
			...
			echo form_open_multipart('admin/tour_bus/edit', $attributes);
                          ...
                          <!-- ************************************************* Train Name *****************************************************  -->    
                                          <div class="form-group col-md-12 col-xs-12" style="margin-bottom: 10px;">
                                                          <label class="col-md-2 text-left padding_opx">
                                                            <span> Bus Name </span></label>
                                                              <div class="col-md-5 form-group padding_opx">
														 <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
              $data = array('name'  => 'BusName[]', 'id' => 'BusName', 'value'=>$bus_detail[$i]['BusName'],    'placeholder' => 'Bus Name', 'class'=>"form-control margin_bottom");
                              ...
                              <div class="form-group col-md-12 col-xs-12" style="margin-bottom: 10px;">
                                                          <label class="col-md-2 text-left padding_opx">
                                                            <span> From City  </span></label>
                                                              ...
                                                              <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                $data = array('name'  => 'PlaceFrom[]', 'id' => 'PlaceFrom', 'value'=>$bus_detail[$i]['PlaceFrom'],    'placeholder' => 'Place From', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                              ...
                              <div class="form-group col-md-12 col-xs-12" style="margin-bottom: 10px;">
                                                          <label class="col-md-2 text-left padding_opx">
                                                            <span> To City  </span></label>
                                                              ...
                                                              <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                $data = array('name'  => 'PlaceTo[]', 'id' => 'ToCity', 'value'=>$bus_detail[$i]['PlaceTo'],    'placeholder' => 'Place To', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                                           ...
                                           <div class="form-group col-md-12 col-xs-12" style="margin-bottom: 10px;">
                                                          <label class="col-md-2 text-left padding_opx">
                                                            <span> Note (<small>If any</small>) </span></label>
                                                              ...
                                                              <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'OtherDeatils[]', 'id' => 'OtherDeatils', 'value'=>$bus_detail[$i]['OtherDeatils'],    'placeholder' => 'Description ', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
