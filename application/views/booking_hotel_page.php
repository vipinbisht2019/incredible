                            ...
                            <div class="bg-3" style="padding-bottom: 20px;">
                                ...
                                <div class="row padd">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div >
                                             <span style="font-size: 12px;font-weight: 600;color: #000000;">Last Cancellation Date: <?php echo date("d M, Y h:i A",strtotime($hotelSummary['ops'][0]['ddt'])); ?> 
                                            </span>
                                        </div> 
                                    </div>
                                </div>
                                <div class="container">
                                    ...
                                    <div class="row bookinbg-padd">
                                        <div class="col-md-3">
                                            <div style="border-right: 1px dashed #7490d3;height: 65px;">
                            ...
                            <div class="bg-3">
                                ...
                                <div class="container">
                                    <form name="guestdetails" method="post" action="<?php echo base_url('hotels/guestDetails'); ?>"> 
                                        ...
                                        <?php $totalHotel = count($hotelSummary['ops'][0]['ris']); ?>
                                        <input type="hidden" name="rooms" id="rooms" value="<?php  echo $totalHotel; ?>">
                                            <?php
                                                $rm=1;
                                            foreach ($hotelSummary['ops'][0]['ris'] as $key => $roomValue) {
                                          
                                           ?>
                                            <div class="row customer_records">
                                                <div class="col-lg-12">
                                                    <span class="room">For Room <?php echo $rm; ?> - <?php echo $roomValue['rt']; ?></span>
                                                    <input type="hidden" name="roomname" id="roomname" value="<?php  echo $roomValue['rt']; ?>">
                                                </div>
