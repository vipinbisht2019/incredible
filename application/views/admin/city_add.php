		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>City Add</b></h3>
						</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
										...
										echo form_open_multipart('admin/city/add', $attributes);
							     ?>
               ...
               $data = array('name'  => 'city_name', 'id' => 'city_name', 'value'=>set_value('city_name'), 'placeholder' => 'City', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                               ...
                               <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">Code</label>
		                			<div class="col-md-2 form-group padding_opx">
                                 
                                    <?php
					
                       $data = array('name'  => 'city_code', 'id' => 'city_code','value'=>set_value('city_code') ,  'placeholder' => 'City Code', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                                    ?>
