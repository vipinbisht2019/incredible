...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
							...
							//echo"<pre>";
							// print_r($dropdown_routes);		  
						   // echo"</pre>";			  
                          
							
							          // ------------------------------ admin form open ---------------------------------
										$attributes = array('class' => 'form-auth-small form-inline', 'name'=>'form1', 'id' => 'form1');
										echo form_open_multipart('admin/busesroutesdetails/add', $attributes);
							     ?>
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
											...
											foreach($dropdown_routes as $val)
										       {
												   $options[$val['RoutesId']] = $val['RoutesName'];
											   }		
											 $selected=$edit_cardetails[0]['RoutesId'];	
                         ...
                         <div class="col-md-12 padding_opx">
                                ...
                                <div class="col-md-12 padding_opx margin_top">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'FromOperating', 'id' => 'datepicker3', 'value'=>set_value('CityName'), 'placeholder' => 'From', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                      ...
                                      <div class="col-md-3 form-group padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'ToOperating', 'id' => 'datepicker2', 'value'=>set_value('CityName'), 'placeholder' => 'To', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                ...
                                <div class="col-md-12 padding_opx margin_top">
                                   ...
                                   <?php
								     // ------------------------------ adm_status form  ---------------------------------
								$data = array('name'  => 'SortOrder', 'id' => 'SortOrder', 'value'=>set_value('SortOrder'), 'placeholder' => 'To', 'class'=>"form-control margin_bottom");
								echo form_input($data);
                                    ?>
		                		  </div>
                               </div>   
