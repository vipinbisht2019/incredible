...
<html lang="en">
<head>
<title>Dropping Point Modify</title>
<meta charset="utf-8">
             	...
             	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b><i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Dropping Point Modify</b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/busesdropping/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/busesdropping/edit', $attributes);
		                			...
		                			<div class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        ...
                                        <?php
											...
											unset($options);									
									        $options['']='.::Choose City::.';
											foreach($dropdwon_city as $val)
										       {
												   $options[$val['CityId']] = $val['CityName'];
											   }		
											 $selected=$edit_busesdropping[0]['CityId'];	
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('DroppingPointName'); ?></span>
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'DroppingPointName', 'id' => 'DroppingPointName', 'value' =>$edit_busesdropping[0]['DroppingPointName'], 'placeholder' => 'Dropping Point', 'class'=>"form-control margin_bottom");
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
										...
										//SeatNo
										//-------------------------------------------------------------------------------------------------------------------
										$data = array('id'  => $edit_busesdropping[0]['DroppingId']);
										echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
