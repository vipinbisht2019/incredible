...
<?php //echo '<pre>'; print_r($tripInfoResult);?>
	...
	<input type="hidden" name="flightIdmultiway_third" value="<?php  if(!empty($flightIdmultiway_third)) { echo $flightIdmultiway_third; } ?>" />
                 ...
                 $grossTotal = $adultCount + $adultReCount + $adultMultithirdCount + $childCount + $childReCount + $childMultithirdCount + $infantCount + $infantReCount + $infantMultithirdCount;
                               ...
                               @$infantBf = $tripInfoResult['totalPriceList'][0]['fd']['INFANT']['fC']['BF'] * $infantPax21; 
                                ...
                                $adultTotalBaseFare = $adultBf + $adulRetBf + $adulMultithirdBf;
                                $childTotalBaseFare = $childBf + $childReBf + $childMultithirdBf;
                                $infantTotalBaseFare = $infantBf + $infantReBf + $infantMultithirdBf;



                                $baseFareTotal = $adultBf + $childBf + $infantBf;
                             $baseFareReTotal = $adultBf + $adulRetBf + $adulMultithirdBf +  $childBf + $childReBf + $childMultithirdBf + $infantBf + $infantReBf + $infantMultithirdBf;
                                ...
                                $totalTaxFare = $adultTAF + $adultReTAF + $adultMultithirdTAF + $childTAF + $childReTAF + $childMultithirdTAF + $infantTAF + $infantReTAF + $infantMultithirdTAF;
                                ...
                                $totalAGST = $adultAGST + $childAGST + $infantAGST + $adultReAGST + $childReAGST + $infantReAGST + $adultMultithirdAGST  + $childMultithirdAGST  +  $infantMultithirdAGST;
                                ...
                                $totalMFT = $adultMFT + $childMFT + $infantMFT + $adultReMFT + $childReMFT + $infantReMFT + $adultMultithirdMFT  +  $childMultithirdMFT  +  $infantMultithirdMFT;
                                ...
                                $totalMF = $adultMF + $childMF + $infantMF + $adultReMF + $childReMF + $infantReMF + $adultMultithirdMF  + $childMultithirdMF  + $infantMultithirdMF;
                                ...
                                $totalOT = $adultOT + $childOT + $infantOT + $adultReOT + $childReOT + $infantReOT + $adultMultithirdOT + $childMultithirdOT + $infantMultithirdOT;
