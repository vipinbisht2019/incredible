...
<html lang="en">
 <head>
	<title>Adventure Images View</title>
	<meta charset="utf-8">
              	...
              	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Gallary View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/gallary/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom"> Add Gallary </a>
                            <br>
						 </div>
					</div>
				</div>
