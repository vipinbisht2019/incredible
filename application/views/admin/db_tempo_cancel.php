...
<html lang="en">
  <head>
	<title> Tempo And Coach Cancel Details</title>
	<meta charset="utf-8">
            	...
            	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>  Tempo & Coach Cancel Detail </b></h3>
						</div>
...
<?php          
      ...
      echo form_open_multipart('admin/temppobooking/temppobookingcancle', $attributes);
                    ...
                    $data = array('CancellationDateTime'  => $cancellation_amount['CancellationDateTime']);
                                        echo form_hidden($data);
                    $data = array('BookingId'  => $tempo_details[0]['BookingId']);
                                        echo form_hidden($data);
