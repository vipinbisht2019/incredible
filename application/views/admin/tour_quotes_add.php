...
<html lang="en">
<head>
<title>Tours Quotes Detials Add</title>
<meta charset="utf-8">
		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Tours Quotes Detials Add</b></h3>
						</div>
			...
			<div class="panel">
                ...
                <div class="stepwizard">
                  <div class="stepwizard-row">
                   ...
                   <div class="stepwizard-step col-md-1">
                   <a href="<?php echo base_url('admin/tour_inclusionexclusion/edit?TourId='.$TourId); ?>"><button type="button" class="btn btn-primary btn-circle" >2</button></a>
                        <p>Inclusion<br>Exclusion</p>
                    </div>
            
                    <div class="stepwizard-step col-md-1">
                   <a href="<?php echo base_url('admin/tour_itinerary/edit?TourId='.$TourId); ?>"><button type="button" class="btn btn-primary btn-circle" >3</button></a>
                        <p>Itinerary</p>
                    </div>
                    ...
                    <div class="stepwizard-step col-md-1">
                        <a href="<?php echo base_url('admin/tour_infodetail/edit?TourId='.$TourId); ?>"><button type="button"  class="btn btn-primary btn-circle">9</button></a>
                            <p>Tour Info Details</p>
                     </div>
                        <div class="stepwizard-step col-md-1">
                        <a href="<?php echo base_url('admin/Tour_quotedetial/edit?TourId='.$TourId); ?>"><button type="button"  class="btn btn-primary btn-circle" disabled="disabled">10</button></a>
                            <p>Tour Quotes Details</p>
                     </div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    if($error = $this->session->flashdata('Tour Info')){  ?>
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/Tour_quotedetial/edit', $attributes);
							     ?>

		                
								         
                          		 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">Select Tour Quotes Category * </label>
		                			<div class="col-md-5 form-group padding_opx">
                                          <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('quotes_type'); ?></span>
                                          
                                          <select name="quotes_type" id="quotes_type">
                                          <option value="">Select Tour Quotes Category</option>
                                          	<option value="quotes">Quotes</option>
                                            <option value="supplements">Supplements</option>
                                             <option value="flight_subcharges">Flight Sub Charges</option>
                                          </select>
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">Quotes Head *</label>
		                			<div class="col-md-5 form-group padding_opx">
                                     <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('quotes_head'); ?></span>
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'quotes_head', 'id' => 'quotes_head',  'value' =>$edit_infodetail[0]['quotes_head'],  'placeholder' => 'Quotes Head ', 'class'=>"form-control margin_bottom");
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">Quotes Price * </label>
		                			<div class="col-md-5 form-group padding_opx">
                                     <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('quotes_price'); ?></span>
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'quotes_price', 'id' => 'quotes_price',  'value' =>$edit_infodetail[0]['quotes_price'],  'placeholder' => 'Quotes Price ', 'class'=>"form-control margin_bottom");
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                          <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'sortorder', 'id' => 'sortorder',  'value' =>$edit_infodetail[0]['sortorder'], 'placeholder' => 'Sort Order', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                          ?>
