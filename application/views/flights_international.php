                      ...
                      <?php  $i=0;
                       foreach ($flightArray as $key => $flightArrayValue) {  ?>
                        <tr>
                          ...
                          <td>
                            <p style="text-align: left;"><?php $deptDate = date('M d',strtotime($flightArrayValue['segmentListValOnward'][0]['departureDateNTime'])); echo $deptDate; ?> </p>
                          ...
                          <td> 
                            <p style="text-align: left;"><?php $retarriveDate = date('M d',strtotime($flightArrayValue['segmentListValOnward'][count($flightArrayValue['segmentListValOnward']) - 1]['arrivalDateNTime'])); echo $retarriveDate; ?> </p>
                            <h6 style="font-size: 18px;color: #363636;font-weight: 600;justify-content: center;"><?php $retDate = date('H:i',strtotime($flightArrayValue['segmentListValOnward'][count($flightArrayValue['segmentListValOnward']) - 1]['arrivalDateNTime'])); echo $retDate; 
                            
                            
                            ?></h6> 
                            <p style="text-align: left;"><?php echo $flightArrayValue['segmentListValOnward'][count($flightArrayValue['segmentListValOnward']) - 1]['arivCityName']; ?></p>
                          </td>
                          <td>
                            <ul class="price-list">
                        ...
                        <tr>
                          <td class="text-center">
                            <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;">
                              <li><img src="<?php echo base_url(); ?>uploads/flights/<?php echo $flightArrayValue['segmentListValReturn'][0]['flightCode']; ?>.png" alt=""></li>
                              <li style="font-size:13px;font-weight:600;text-align: left;left: 10px;position: relative;"><?php echo $flightArrayValue['segmentListValReturn'][0]['flightName']; ?>
                                <br>
                                <?php 
                                  foreach ($flightArrayValue['segmentListValReturn'] as $key => $returnVal) { ?>
                                <span style="font-size:11px;font-weight:400;"><?php echo $returnVal['flightCode']; ?> - <?php echo $returnVal['flightNumber'].","; ?></span>
                                <?php } ?>
                              </li>
                            </ul>                           
                          </td>
                          <td>
                            <p style="text-align: left;"><?php $retarriveDate = date('M d',strtotime($flightArrayValue['segmentListValReturn'][0]['departureDateNTime'])); echo $retarriveDate; ?> </p>
                            <h6 style="font-size: 18px;color: #363636;font-weight: 600;"><?php $retdeptTime = date('H:i',strtotime($flightArrayValue['segmentListValReturn'][0]['departureDateNTime'])); echo $retdeptTime; ?></h6>                              
                            <p> <?php echo $flightArrayValue['segmentListValReturn'][0]['deptCityName']; ?> </p>                                                        
                          </td>
                          <td>
                            ...
                            <h6 style="display: flex;flex-direction: column;text-align: left;font-size: 13px;"><?php
                              ...
                              $rettotalDuration = '';
                              $rettotalConnectFlight = array();
                              $retflightStop = array();

                              foreach ($flightArrayValue['segmentListValReturn'] as $key => $returnValue) {

                                $rettotalDuration = $rettotalDuration + $returnValue['flightDuration'] +  @$returnValue['flightConnectingTime'] ;

                                if(!empty($returnValue['flightConnectingTime'])){

                                  $rettotalConnectFlight[] = count($returnValue['flightConnectingTime']);

                                }
                                if($returnValue['flightStop']!=0){

                                  $retflightStop[] = count($returnValue['flightStop']);
                                
                                }
                              }
                              

                              $minutes = $rettotalDuration; $hours = floor($minutes / 60); $min = $minutes - ($hours * 60); echo $hours."h ".$min."m" ; ?>                               
                            <div class="relative fliStopsSep">
                              <p class="fliStopsSepLine" style="border-top: 3px solid rgb(102, 137, 221);"></p>
                            </div>
                            <span style="font-size: 9px;"><?php $rettotalDeptCount =  count($rettotalConnectFlight) + count($retflightStop); if($rettotalDeptCount > 0 ){ echo $rettotalDeptCount." ";   echo "stop(s)"; }else{ echo "Non-stop"; } ?></span></h6>
                            
                          </td>
                          <td>
                            <p style="text-align: left;"><?php $retarriveDate = date('M d',strtotime($flightArrayValue['segmentListValReturn'][count($flightArrayValue['segmentListValReturn']) - 1]['arrivalDateNTime'])); echo $retarriveDate; ?> </p>
                            <h6 style="font-size: 18px;color: #363636;font-weight: 600;justify-content: center;"> <?php $retarriveTime = date('H:i',strtotime($flightArrayValue['segmentListValReturn'][count($flightArrayValue['segmentListValReturn']) - 1]['arrivalDateNTime'])); echo $retarriveTime; ?></h6> 
                            <p style="text-align: left;"><?php echo $flightArrayValue['segmentListValReturn'][count($flightArrayValue['segmentListValReturn']) - 1]['arivCityName'] ?> </p>
