		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Car Details Add</b></h3>
						</div>
...
<!-- Html ##################################################### -->
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/cardetails/add', $attributes);
							     ?>
                            ...
                            <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
											...
											foreach($dropdown_category as $val)
											 ...
											 $selected=set_value('CarCategoriesId');	
		                		 ...
		                		 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'CarName', 'id' => 'CarName', 'value'=>set_value('CarName'), 'placeholder' => 'Car Title', 'class'=>"form-control margin_bottom");
                            ...
                            <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
											...
											foreach($dropdown_manufacturer as $val)
											 ...
											 $selected=set_value('CarManufacturerId');	
               ...
               $data = array('name'  => 'Luggage', 'id' => 'Luggage', 'value'=>set_value('Luggage'), 'placeholder' => 'Luggage', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>  
               ...
               $data = array('name'  => 'DistanceLimit', 'id' => 'DistanceLimit', 'value'=>set_value('DistanceLimit'), 'placeholder' => 'Distance Limit in KM', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
               ...
               $data = array('name'  => 'ExtraHours', 'id' => 'ExtraHours', 'value'=>set_value('ExtraHours'), 'placeholder' => 'Extra Hours', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span>Out Station <small>(Per KM)</small></span></label>
		                			   <div class="col-md-2 form-group padding_opx">
                                       
                                       <?php
									 
               $data = array('name'  => 'OutStation', 'id' => 'OutStation', 'value'=>set_value('OutStation'), 'placeholder' => 'Out Station', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
             ...
             $data = array('name'  => 'DistanceLimitOutation', 'id' => 'DistanceLimitOutation', 'value'=>set_value('DistanceLimitOutation'), 'placeholder' => 'Minimum Distance Limit', 'class'=>"form-control margin_bottom");
                       echo form_input($data); 
                                        ?>
                                      </div>
                                  </div>  
               ...
               $data = array('name'  => 'DrivingChargesOutation', 'id' => 'DrivingChargesOutation', 'value'=>set_value('DrivingChargesOutation'), 'placeholder' => 'Driving Charges', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
                                  </div>  
               ...
               $data = array('name'  => 'AirportTransfers', 'id' => 'AirportTransfers', 'value'=>set_value('AirportTransfers'), 'placeholder' => 'Airport Transfers Charges', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
               ...
               $data = array('name'  => 'ParkingCharges', 'id' => 'ParkingCharges', 'value'=>set_value('ParkingCharges'), 'placeholder' => 'Parking Charges', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>        
