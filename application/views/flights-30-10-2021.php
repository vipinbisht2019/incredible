...
jQuery(document).ready(function($){
    ...
    $('#aafter11').on('change', function(){
    	if($(this).is(':checked')){
           $("#aafter11").css('background-color',"#244082");
    ...
    $('#aafter5').on('change', function(){
    	if($(this).is(':checked')){
           $("#aafter55").css('background-color',"#244082");
           $("#after555").css('color',"#ffffff");
        } else {
            $("#aafter55").css('background-color',"#f3f6f8");
            $("#aafter555").css('color',"#000000");
        }
    })
    ...
    $('#threest').on('change', function(){
    	if($(this).is(':checked')){
           $("#threest").css('background-color',"#244082");
           $("#threest").css('color',"#ffffff");
        } else {
            $("#threest").css('background-color',"#244082");
            $("#threest").css('color',"#ffffff");
        }
