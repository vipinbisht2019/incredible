...
<html lang="en">
  <head>
	<title>Tour Holiday Details</title>
	<meta charset="utf-8">
...
<div class="col-lg-12 col-xs-12">
  ...
  <div class="col-lg-6">
    ...
    <div class="panel panel-default">
       ...
       <div class="panel-heading"> <h5 style="font-size: 18px; margin: 0px;"> <i class="fa fa-bus"></i> Holiday Tour </h5> </div>
...
<?php          
      ...
      echo form_open_multipart('admin/holidaybooking/toursbookingcancle', $attributes);
