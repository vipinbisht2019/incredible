                          ...
                          <div class="row" style="/*margin-bottom: 15px;*/">
                            ...
                            <div class="col-sm-2 col-md-2 pad-col">
                              <div class="select1_wrapper">
                                ...
                                <div class="select1_inner input-container" style="border: 1px solid #a7a7a7;">
                                  <i class="fa fa-plane icon" style="background: #fff;border-right: none;"></i>
                                <input type="text" name="destination" id="search_destination" placeholder ="Arrival" class="inpt-tab" style="border-left: none;">
                              </div>
                            </div>
                          </div>
                          <div class="col-sm-2 col-md-2 pad-col">
                            <div class="input1_wrapper" style="border: 1px solid #a7a7a7;border-radius:5px;">
                              ...
                              <div class="input1_inner">
                                <input type="text" class="input inpt-tab" name="departure_date" id="departure_date"  placeholder="Departure Date" autocomplete="off">
                              </div>
                            </div>
                          </div>
                         <!-- <div class="col-sm-2 col-md-2 pad-col">
                            ...
                            <div class="row" style="margin-bottom: 15px;">
                              <div class="col-sm-2 col-md-2 pad-col" style="display: flex;">
                                <div class="select1_wrapper">  
                                  <div class="select1_inner input-container" style="border: 1px solid #a7a7a7;">
                                    <i class="fa fa-plane icon" style="background: #fff;border-right: none;"></i>
                                    <input type="text" name="departure" class="inpt-tab" id="search_departure2" placeholder ="From" minlength="3" style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #a7a7a700;width: 100%;border-left: none;">
                              ...
                              <div class="col-sm-2 col-md-2 pad-col">
                                <div class="select1_wrapper">
                                  <div class="select1_inner input-container" style="border: 1px solid #a7a7a7;">
                                  <i class="fa fa-plane icon" style="background: #fff;border-right: none;"></i>
                                  <input type="text" name="destination" class="inpt-tab" id="search_destination2" placeholder ="Destination"  style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #a7a7a700;width:100%;border-left:none">
                                  </div>
                                </div>
                              </div>
                              <div class="col-sm-3 col-md-3 pad-col">
                                <div class="input1_wrapper" style="border: 1px solid #a7a7a7;border-radius:5px;">
                                  <div class="input1_inner">
                                    <input type="text" class="input" class="inpt-tab" name="departure_date" id="departure_date2" placeholder="Departure" autocomplete="off">
                                  </div>
                                </div>
                              </div>
                              <div class="col-sm-3 col-md-3 pad-col" style="padding-left: 0px;">
                              ...
                              <div class="col-sm-2 col-md-2 pad-col" style="display: flex;">
                                <div class="select1_wrapper" style="border: 1px solid #a7a7a7;border-radius: 5px;">  
                                  <div class="select1_inner">
                                    <input type="text" name="departure1" class="inpt-tab" id="search_departure3" placeholder ="From" minlength="3" style="font-size: 13px;line-height: 20px;padding: 12px 20px 11px 15px;color: #c2c2c2;width: 100%">
                                  </div>
                                </div>
                              </div>
                              <div class="col-sm-2 col-md-2 pad-col">
                                <div class="select1_wrapper" style="border: 1px solid #a7a7a7;border-radius: 5px;">
                                  <div class="select1_inner">
                                    <input type="text" name="destination1" class="inpt-tab" id="search_destination3" placeholder ="Destination"  style="font-size: 13px;line-height: 20px;padding: 12px 20px 11px 15px;color: #c2c2c2;width:100%;">
                                  </div>
                                </div>
                              </div>
                              <div class="col-sm-3 col-md-3 pad-col">
               ...
               <div class="row after-add-more" style="margin-top: 20px;margin-bottom: 15px;">                              
                ...
                <div class="col-sm-2 col-md-2 pad-col" style="display: flex;">
                                <div class="select1_wrapper">  
                                  ...
                                  <div class="select1_inner">
                                    <input type="text" name="departure1" id="search_departure3" placeholder ="From" minlength="3" style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #a7a7a7;width: 100%">
                                  </div>
                                </div>
                              ...
                              <div class="col-sm-2 col-md-2 pad-col">
                                <div class="select1_wrapper">
                                  ...
                                  <div class="select1_inner">
                                  <input type="text" name="destination1" id="search_destination3" onclick="myFunctions()" class="qq1 " placeholder ="Destination"  style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #a7a7a7;width:100%;">
                                  </div>
                                </div>
                              </div>
                              <div class="col-sm-3 col-md-3 pad-col">
            ...
            <div class="addmoreCities1" style="display:none;">
              ...
              <div class="col-sm-2 col-md-2 pad-col" style="display: flex;">
                                <div class="select1_wrapper  multicity_wrapper">  
                                  ...
                                  <div class="select1_inner">
                                    <input type="text" name="departure1" id="qq2" class="qq2" placeholder ="From" minlength="3" style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #a7a7a7;width: 100%">                  
                              ...
                              <div class="col-sm-2 col-md-2 pad-col">
                                <div class="select1_wrapper multicity_wrapper">
                                  ...
                                  <div class="select1_inner">
                                  <input type="text" name="destination1" id="search_destination3" class="ui-autocomplete-input ui-autocomplete-loading" placeholder ="Destination"  style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #a7a7a7;width:100%;">
                                  </div>
                                </div>
                              </div>
                              <div class="col-sm-3 col-md-3 pad-col ">
            ...
            <div class="addmoreCities2" style="display:none;">
              ...
              <div class="col-sm-2 col-md-2 pad-col" style="display: flex;">
                                <div class="select1_wrapper  multicity_wrapper">  
                                  ...
                                  <div class="select1_inner">
                                    <input type="text" name="departure1" id="search_departure3" class="qq2" placeholder ="From" minlength="3" style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #a7a7a7;width: 100%">                  
                              ...
                              <div class="col-sm-2 col-md-2 pad-col">
                                <div class="select1_wrapper multicity_wrapper">
                                  ...
                                  <div class="select1_inner">
                                  <input type="text" name="destination1" id="search_destination3" class="" placeholder ="Destination"  style="font-size: 13px;line-height: 20px;padding: 7px 20px 7px 15px;color: #c2c2c2;border: 1px solid #a7a7a7;width:100%;">
                                  </div>
                                </div>
                              </div>
                              <div class="col-sm-3 col-md-3 pad-col ">
