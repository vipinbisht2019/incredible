...
<html lang="en">
 <head>
	<title>Tour Cancellation Policy View</title>
	<meta charset="utf-8">
...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Tour Cancellation Policy View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/cancellationpolicy/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Tour Cancellation Policy </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                      ...
                      <div class="col-md-12 col-xs-12 margin_top">  <?php
									...
									// echo"<pre>"; 
									   //print_r($cancellationpolicy);
									 //echo"</pre>"; 
                                    ?>
                                    </div>
                  <?php                         
						  $attributes = array('class' => 'form-auth-small form-inline', 'name'=>'form1', 'id' => 'form1');
						  echo form_open_multipart('admin/cancellationpolicy/bulk_action', $attributes); 
					?>                                
            ...
            <a href="<?php echo base_url('admin/cancellationpolicy/edit')."?id=".$val['CancellationID'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/cancellationpolicy/delete')."?id=".$val['CancellationID'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
