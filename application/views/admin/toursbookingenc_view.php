...
<html lang="en">
 <head>
	<title>Tours Pending Booking View</title>
	<meta charset="utf-8">
...
<body>
	<div id="wrapper">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Tours Unpaid Booking View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="#" class="btn btn-primary btn-primary1 pull-right margin_bottom">Tours Unpaid Booking View</a>
     ...
     <?php 
			...
			echo form_open_multipart('admin/toursbookingenc/search', $attributes);
	 ?>
                 ...
                 <?php 
					foreach($toursbookingenc as $val) 
					   {
					   // var $css;
...
<td style="width: 5%;"> <a href="<?php echo base_url('admin/toursbookingenc/toursbookingencdetails/').$val['BookingId']; ?>" class="db-done"> <i class="fa fa-info-circle"></i></a></td>
