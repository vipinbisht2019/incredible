...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Promo Code  View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/promocode/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Promo Code  </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/promocode/bulk_action', $attributes); 
					?>                                
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                                ...
                                <td><?php echo $val['CouponID'] ?></td>
								<td><?php echo $val['CouponName'] ?></td>
                                <td><?php echo $val['CouponPrice'] ?></td>
            ...
            <a href="<?php echo base_url('admin/promocode/edit')."?id=".$val['CouponID'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/promocode/delete')."?id=".$val['CouponID'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['CouponID'],  'checked'=> false, 'class'=>" margin_bottom" );
