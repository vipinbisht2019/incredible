               ...
               <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Sponsor Modify </b></h3>
						</div>
						      <div class="col-md-6 padding_opx">
						...
						//-------------------------------------------------------------------------------------------------
                          ...
                          <?php  
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/sponsors/edit', $attributes);
							     ?>
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'name', 'id' => 'name', 'value' =>$edit_sponsor[0]['name'],  'placeholder' => 'Name', 'class'=>"form-control margin_bottom");
                                  ...
                                  <div class="col-md-12 padding_opx margin_bottom">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Current Image  </span></label>
		                			    <div class="col-md-5 form-group padding_opx">
                                    
								             <?php
											  if($edit_sponsor[0]['photo']!='') { ?>
                                               <img src="<?php echo base_url('uploads/sponsor/'.$edit_sponsor[0]['photo']) ?>" width="200px"> <br>
											  <?php } else { ?>
                                   ...
                                   <?php
								     // ------------------------------ adm_status form  ---------------------------------
											...
											(
											 ...
											 $selected=	$edit_sponsor[0]['status']	;					
                                  ...
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
                                        ...
                                        echo form_hidden($data);
											    ...
											    $data = array('id'  => $edit_sponsor[0]['id'] );
										   	echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
