...
<html lang="en">
<head>
<title>Room Rate Type Modify</title>
<meta charset="utf-8">
		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Room Rate Type Modify</b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/roomratetype/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    if($error = $this->session->flashdata('roomratetype')){  ?>
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/roomratetype/edit', $attributes);
							     ?>
                        ...
                        <!--   <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
											...
											foreach($hotels as $val)
											 ...
											 $selected=$edit_roomtype[0]['HotelId'];
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Room Rate Type * </span></label>
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('RoomTitle'); ?></span>
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'RoomRateType', 'id' => 'RoomRateType', 'value'=>$edit_roomtype[0]['room_rate_type'], 'placeholder' => 'Room Rate Type', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                  ...
                                  <!-- <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                       /* $data = array('name'  => 'Description', 'id' => 'Description','value'=>$edit_roomtype[0]['Description'] ,  'placeholder' => 'Description', 'class'=>"form-control margin_bottom");
                        ...
                        <!--         <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                         <?php
											/*  if($edit_roomtype[0]['Photo']!='') { */?>
                                               <img src="<?php //echo base_url('uploads/hotel/'.$edit_roomtype[0]['Photo']) ?>" width="200px"> <br>
											  <?php //} else { ?>
                              ...
                              <p>&nbsp;</p>
                               ...
                               <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'SortOrder', 'id' => 'SortOrder','value'=>$edit_roomtype[0]['SortOrder'] ,  'placeholder' => 'Sort Order', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                                    ?>
                                  ...
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
                                        ...
                                        echo form_hidden($data);
										 ...
										 $data = array('id'  => $edit_roomtype[0]['RoomId']);
											echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
