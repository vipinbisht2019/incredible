<?php  // echo "<pre>"; print_r($bookingOrder); die;?>
...
<div id="main">
   <?php include('includes/header.php'); ?>
            ...
            <div class="abt-section pt-20 pb-20">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <ul class="abt-booklist">
                            <?php if($bookingOrder['status'] == 'SUCCESS'){ ?>
                                <li class=""><img src="<?php echo base_url('assets/img/icon/booking.png')?>" klass="print_image-success"></li>
                            <?php }elseif($bookingOrder['status'] == 'PENDING'){ ?>
                                <li class=""><img src="<?php echo base_url('assets/img/icon/pending.png')?>" klass="print_image-success"></li>
                            <?php } ?>
                                <li class="abt-booksuceed">
                                    <?php if($bookingOrder['status'] == 'SUCCESS'){ ?>
                                        <span class="booking__status-successTrip" style="color: rgb(112, 209, 39);">
                                            <span>Booking</span> 
                                            <span class=""><?php echo $bookingOrder['status']; ?></span>
                                        </span>
                                    <?php }elseif($bookingOrder['status'] == 'PENDING'){ ?>
                                        <span class="booking__status-successTrip" style="color: rgb(219, 95, 0);">
                                            <span>Booking</span> 
                                            <span class=""><?php echo $bookingOrder['status']; ?></span>
                                        </span>
                                    <?php } ?>
                                    <!-- <span class="createdOn_timeClass">Dec 11, 2021 6:10 PM</span> -->
                                    <p class="abt-succedspan">
                                        <!-- <a href="//apitest-dashboard.tripjack.com/manage-carts/cart-detail/TJS108200156751" class=""> -->
                                            <span class="graycolor"><span>Booking ID</span></span>  <?php echo $bookingOrder['bookingId']; ?> 
                                        <!-- </a> -->
                                    </p>
                                </li>
                            </ul>
                        ...
                        <div class="col-sm-6 no-padding">
                            <!-- <div class="btn-wrapper text-right">
                                <div class="tgs-button tgs-button-variant-normal">
                                    <span class=""><i class="fa fa-download"></i> Download as PDF</span>
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="detail-content content-wrapper">   
                                <div class="description detail-box flight-book">
                                    <!-- <div class="detail-title">
                                        ...
                                        <?php //}elseif($bookingDetails['booking_status'] == 'PENDING'){ ?>
                        ...
                        <div class="dscrpton-cntnt detail-box">
                                ...
                                <li>
                                    <span class="dsply">
                                        ...
                                        <div>
                                            ...
                                            <p class="flight-detl" style="font-weight:600;"><?php echo $tripInfoResult['sI'][0]['fD']['aI']['code']; ?> - <?php echo $tripInfoResult['sI'][0]['fD']['fN']; ?></p>
                            ...
                            <div class="grey padT10 font12 padL20 padR20 dF" style="padding-top: 5px;">
                                <div class="flex1_5">
                                    <span class="flexRow">
                                        ...
                                        <p class="padL5" style="font-size: 12px;padding-top: 0px;font-weight: 500;color: #adadad;margin-bottom: 0px;">15 Kg  Check-In, 7 Kg Cabin
                                        </p>
                                    </span>
                                </div>
                                <div class="flex2"></div>
                                ...
                                <li>
                                    <span class="dsply">
                                        ...
                                        <div>
                                            ...
                                            <!-- <p class="flight-detl"><?php //echo ucfirst($tripInfoResult['totalPriceList'][1]['fd']['ADULT']['cc']); ?></p> -->
                                            <p class="flight-detl" style="font-weight:600;"><?php echo $tripInfoResult['sI'][1]['fD']['aI']['code']; ?> - <?php echo $tripInfoResult['sI'][1]['fD']['fN']; ?></p>
                                            <p class="flight-detl"><i class="fa fa-plane"></i>: <?php echo $tripInfoResult['sI'][1]['fD']['eT']; ?></p>
                                        <div>
                                    </span>
                                </li>
                            ...
                            <?php if(!empty($tripInfoResult['sI'][1]['cT'])){ ?>
                            ...
                            <li class="dsply">
                                <span>
                                        ...
                                        <!-- <p class="flight-detl"><?php //echo ucfirst($tripInfoResult['totalPriceList'][1]['fd']['ADULT']['cc']); ?></p> -->
                                        <p class="flight-detl"  style="font-weight: 600;"><?php echo $tripInfoResult['sI'][2]['fD']['aI']['code']; ?> - <?php echo $tripInfoResult['sI'][2]['fD']['fN']; ?><i class="fa fa-plane"></i>:<?php echo $tripInfoResult['sI'][2]['fD']['eT']; ?></p>
                                    </div>
                                </span>
                            </li>
                    ...
                    <?php if(!empty($tripInfoResultSecond)){ ?>  
                        <div class="dF pad10 justifyBetween alignItemsCenter">
                            <div class="dF alignItemsCenter font18">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="2rem" height="2rem" class="Flight__FlightIcon-sc-1w228os-0 fWhqRy"><path d="M31.95 16.262c-.012 0-.012 0 0 0-.337.762-2.238 1.3-2.238 1.3l-8.137-.012-8.863 12.925-2.088-.15 4.063-10.875-.225-1.95-9.588-.025L.499 22.05l-.5.063 1.438-5.663-.475-.375-.113-.088.125-.1.475-.363L.024 9.849l.5.063 4.338 4.6h9.6l.225-1.95-4.025-10.887 2.088-.15 8.825 12.963 8.137.012s2.713.762 2.238 1.763z"></path></svg>
                                <?php if(empty($tripInfoResultSecond['sI'][0]['cT'])){  ?> 
                                    <span class="padL5">

                                        <?php echo $tripInfoResultSecond['sI'][0]['da']['city'] ?> - <?php echo $tripInfoResultSecond['sI'][0]['aa']['city'] ?>&nbsp;&nbsp;
                                            <span style="font-size:14px;color:#727272"><?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultSecond['sI'][0]['dt'])); ?>
                                            </span>
                                    </span>
                                <?php }else if(!empty($tripInfoResultSecond['sI'][0]['cT']) && empty($tripInfoResultSecond['sI'][1]['cT'])){   ?>

                                    <span class="padL5">

                                        <?php echo $tripInfoResultSecond['sI'][0]['da']['city'] ?> - <?php echo $tripInfoResultSecond['sI'][1]['aa']['city'] ?>&nbsp;&nbsp;
                                        <span style="font-size:14px;color:#727272"><?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultSecond['sI'][0]['dt'])); ?>
                                        </span>

                                    </span>
                                <?php }else if(!empty($tripInfoResultSecond['sI'][1]['cT'])){  ?>
                                    <span class="padL5">

                                        <?php echo $tripInfoResultSecond['sI'][0]['da']['city'] ?> - <?php echo $tripInfoResultSecond['sI'][2]['aa']['city'] ?>&nbsp;&nbsp;
                                        <span style="font-size:14px;color:#727272"><?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultSecond['sI'][0]['dt'])); ?>
                                        </span>
                        ...
                        <div class="dscrpton-cntnt detail-box">
                            <ul class="brdrBot">
                                <li>
                                    <span class="dsply">
                                        <img src="<?php echo base_url("uploads/flights/");?><?php echo $tripInfoResultSecond['sI'][0]['fD']['aI']['code']; ?>.png">
                                        <div>
                                            <p class="flight-detl" style="font-weight: 600;"><?php echo $tripInfoResultSecond['sI'][0]['fD']['aI']['name']; ?></p>                                           
                                            <p class="flight-detl"><?php echo $tripInfoResultSecond['sI'][0]['fD']['aI']['code']; ?> - <?php echo $tripInfoResultSecond['sI'][0]['fD']['fN']; ?> <i class="fa fa-plane"></i>: <?php echo $tripInfoResultSecond['sI'][0]['fD']['eT']; ?></p>
                                        </div>
                                    </span>
                                </li>
                                <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResultSecond['sI'][0]['dt'])); ?></p>
                                    <p style="margin-bottom: 3px;font-size: 18px;font-weight: 500;"><?php echo $tripInfoResultSecond['sI'][0]['da']['city']; ?>, <?php echo $tripInfoResultSecond['sI'][0]['da']['country']; ?></p>
                                    
                                    <p style="font-size: 13px;font-weight: 500;color: #8b8b8b;line-height: 15px;margin-bottom: 0;"><?php echo $tripInfoResultSecond['sI'][0]['da']['name']; ?> <?php //echo $tripInfoResult['sI'][0]['da']['city']; ?> <?php //echo $tripInfoResult['sI'][0]['da']['country']; ?><br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResultSecond['sI'][0]['da']['terminal']; ?>)</span></p>
                                </li>
                                <li>
                                    <div class="common-elementsstyles__Wid25-sc-ilw4bs-16 sGaBo flexCol TxtCenter padR20 padL10"><div class="flight-detailstyles__BackgroundLn-sc-1i6unua-6 iGruED dF justifyBetween alignItemsCenter backgroundLn"><div class="flight-detailstyles__Oval2-sc-1i6unua-7 dHNyva"></div><span class="padL10 padR10 whiteBg font20"><?php  
                                        $minutes = $tripInfoResultSecond['sI'][0]['duration'];
                                        $hours = floor($minutes / 60);
                                        $min = $minutes - ($hours * 60); 
                                        
                                        echo  $hours."h ".$min."m" ;

                                        $stop = $tripInfoResultSecond['sI'][0]['stops'];
                                        if($stop == 0){
                                ...
                                <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResultSecond['sI'][0]['at'])); ?></p>
                                    <p style="margin-bottom: 3px;font-size: 18px;font-weight: 500;"><?php echo $tripInfoResultSecond['sI'][0]['aa']['city']; ?>, <?php echo $tripInfoResultSecond['sI'][0]['aa']['country']; ?></p>
                                    <p style="font-size: 13px;font-weight: 500;color: #8b8b8b;line-height: 15px;margin-bottom: 0;"><?php echo $tripInfoResultSecond['sI'][0]['aa']['name']; ?><br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResultSecond['sI'][0]['aa']['terminal']; ?>)</span></p>
                                </li>
                            </ul>
                            ...
                            <?php if(!empty($tripInfoResultSecond['sI'][0]['cT'])){ ?>
                                ...
                                <div style="text-align:center;margin-bottom:30px;">
                                    <span style="background: #e3e2e2;padding: 5px 20px;border-radius: 20px;">
                                        Require to change Plane    Layover Time - <?php  
                                            ...
                                            $connectminutes = $tripInfoResultSecond['sI'][0]['cT'] ;
                                            $connecthours = floor($connectminutes / 60);
                                            $connectmin = $connectminutes - ($connecthours * 60); 
                                ...
                                <li>
                                    <span>
                                        <img src="<?php echo base_url("uploads/flights/");?><?php echo $tripInfoResultSecond['sI'][1]['fD']['aI']['code']; ?>.png">
                                        <p class="flight-detl"><?php echo $tripInfoResultSecond['sI'][1]['fD']['aI']['name']; ?></p>
                                        <!-- <p class="flight-detl"><?php //echo ucfirst($tripInfoResult['totalPriceList'][1]['fd']['ADULT']['cc']); ?></p> -->
                                        <p class="flight-detl"><?php echo $tripInfoResultSecond['sI'][1]['fD']['aI']['code']; ?> - <?php echo $tripInfoResultSecond['sI'][1]['fD']['fN']; ?></p>
                                        <p class="flight-detl" style="font-weight: 500;">(Aircraft: <?php echo $tripInfoResultSecond['sI'][1]['fD']['eT']; ?>)</p>
                                    </span>
                                </li>
                                <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResultSecond['sI'][1]['dt'])); ?></p>
                                    <p style="margin-bottom: 3px;font-size: 18px;font-weight: 500;"><?php echo $tripInfoResultSecond['sI'][1]['da']['city']; ?>, <?php echo $tripInfoResultSecond['sI'][1]['da']['country']; ?></p>
                                    
                                    <p style="font-size: 13px;font-weight: 500;color: #8b8b8b;line-height: 15px;margin-bottom: 0;"><?php echo $tripInfoResultSecond['sI'][1]['da']['name']; ?> <?php //echo $tripInfoResult['sI'][0]['da']['city']; ?> <?php //echo $tripInfoResult['sI'][0]['da']['country']; ?><br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResultSecond['sI'][1]['da']['terminal']; ?>)</span></p>
                                </li>
                                <li>
                                    <div class="common-elementsstyles__Wid25-sc-ilw4bs-16 sGaBo flexCol TxtCenter padR20 padL10"><div class="flight-detailstyles__BackgroundLn-sc-1i6unua-6 iGruED dF justifyBetween alignItemsCenter backgroundLn"><div class="flight-detailstyles__Oval2-sc-1i6unua-7 dHNyva"></div><span class="padL10 padR10 whiteBg font20"><?php  
                                        $minutes = $tripInfoResultSecond['sI'][1]['duration'];
                                        $hours = floor($minutes / 60);
                                        $min = $minutes - ($hours * 60); 
                                        
                                        echo  $hours."h ".$min."m" ;

                                        $stop = $tripInfoResultSecond['sI'][1]['stops'];
                                        if($stop == 0){
                                ...
                                <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResultSecond['sI'][1]['at'])); ?></p>
                                    <p style="margin-bottom: 3px;font-size: 18px;font-weight: 500;"><?php echo $tripInfoResultSecond['sI'][1]['aa']['city']; ?>, <?php echo $tripInfoResultSecond['sI'][1]['aa']['country']; ?></p>
                                    <p style="font-size: 13px;font-weight: 500;color: #8b8b8b;line-height: 15px;margin-bottom: 0;"><?php echo $tripInfoResultSecond['sI'][1]['aa']['name']; ?><br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResultSecond['sI'][1]['aa']['terminal']; ?>)</span></p>
                                </li>
                            </ul>
                            ...
                            <?php if(!empty($tripInfoResultSecond['sI'][1]['cT'])){ ?>

                            <div style="text-align:center;margin-bottom:30px;">
                                <span style="background: #e3e2e2;padding: 5px 20px;border-radius: 20px;">
                                    Require to change Plane    Layover Time - <?php  

                                        $connectminutes = $tripInfoResultSecond['sI'][1]['cT'] ;
                                        $connecthours = floor($connectminutes / 60);
                                        $connectmin = $connectminutes - ($connecthours * 60); 
                            ...
                            <li>
                                <span>
                                    <img src="<?php echo base_url("uploads/flights/");?><?php echo $tripInfoResultSecond['sI'][2]['fD']['aI']['code']; ?>.png">
                                    <p class="flight-detl"><?php echo $tripInfoResultSecond['sI'][2]['fD']['aI']['name']; ?></p>
                                    <!-- <p class="flight-detl"><?php //echo ucfirst($tripInfoResult['totalPriceList'][1]['fd']['ADULT']['cc']); ?></p> -->
                                    <p class="flight-detl"><?php echo $tripInfoResultSecond['sI'][2]['fD']['aI']['code']; ?> - <?php echo $tripInfoResultSecond['sI'][2]['fD']['fN']; ?></p>
                                    <p class="flight-detl" style="font-weight: 500;">(Aircraft: <?php echo $tripInfoResultSecond['sI'][2]['fD']['eT']; ?>)</p>
                                </span>
                            </li>
                            <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResultSecond['sI'][2]['dt'])); ?></p>
                                <p style="margin-bottom: 3px;font-size: 18px;font-weight: 500;"><?php echo $tripInfoResultSecond['sI'][2]['da']['city']; ?>, <?php echo $tripInfoResultSecond['sI'][2]['da']['country']; ?></p>
                                
                                <p style="font-size: 13px;font-weight: 500;color: #8b8b8b;line-height: 15px;margin-bottom: 0;"><?php echo $tripInfoResultSecond['sI'][2]['da']['name']; ?> <?php //echo $tripInfoResult['sI'][0]['da']['city']; ?> <?php //echo $tripInfoResult['sI'][0]['da']['country']; ?><br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResultSecond['sI'][2]['da']['terminal']; ?>)</span></p>
                            </li>
                            <li>
                                <div class="common-elementsstyles__Wid25-sc-ilw4bs-16 sGaBo flexCol TxtCenter padR20 padL10"><div class="flight-detailstyles__BackgroundLn-sc-1i6unua-6 iGruED dF justifyBetween alignItemsCenter backgroundLn"><div class="flight-detailstyles__Oval2-sc-1i6unua-7 dHNyva"></div><span class="padL10 padR10 whiteBg font20"><?php  
                                    $minutes = $tripInfoResultSecond['sI'][2]['duration'];
                                    $hours = floor($minutes / 60);
                                    $min = $minutes - ($hours * 60); 
                                    
                                    echo  $hours."h ".$min."m" ;

                                    $stop = $tripInfoResultSecond['sI'][2]['stops'];
                                    if($stop == 0){
                            ...
                            <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResultSecond['sI'][2]['at'])); ?></p>
                                <p style="margin-bottom: 3px;font-size: 18px;font-weight: 500;"><?php echo $tripInfoResultSecond['sI'][2]['aa']['city']; ?>, <?php echo $tripInfoResultSecond['sI'][2]['aa']['country']; ?></p>
                                <p style="font-size: 13px;font-weight: 500;color: #8b8b8b;line-height: 15px;margin-bottom: 0;"><?php echo $tripInfoResultSecond['sI'][2]['aa']['name']; ?><br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResultSecond['sI'][2]['aa']['terminal']; ?>)</span></p>
                            </li>
                            </ul>
					...
					<?php //if(@$this->session->userdata('flightdepartureCity2') !='') { ?>			
								...
								<!-- <div class="dF pad10 justifyBetween alignItemsCenter"><div class="dF alignItemsCenter font18">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="2rem" height="2rem" class="Flight__FlightIcon-sc-1w228os-0 fWhqRy"><path d="M31.95 16.262c-.012 0-.012 0 0 0-.337.762-2.238 1.3-2.238 1.3l-8.137-.012-8.863 12.925-2.088-.15 4.063-10.875-.225-1.95-9.588-.025L.499 22.05l-.5.063 1.438-5.663-.475-.375-.113-.088.125-.1.475-.363L.024 9.849l.5.063 4.338 4.6h9.6l.225-1.95-4.025-10.887 2.088-.15 8.825 12.963 8.137.012s2.713.762 2.238 1.763z"></path></svg>
                                    <span class="padL5"><?php echo $this->session->userdata('flightdepartureCity2');	?> - <?php echo $this->session->userdata('flightarrivalCity2'); ?>&nbsp;&nbsp;<?php echo $this->session->userdata('flightDateTime2'); ?></span></div><div class="dF alignItemsCenter"><span class="padR5"></span>
                                </div>
								</div>
                                <div class="dscrpton-cntnt detail-box">
                                    <ul class="brdrBot">
...
<?php echo $this->session->userdata('flightdepartureCity2');	?>,<br><?php echo $this->session->userdata('flightdepartureCountry2'); ?>  <br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo $this->session->userdata('flightdepartureTerminal2'); ?>)</span></p>
                ...
                <?php if(!empty($tripInfoResultThird)){
                    // echo "bhanu";
                    // echo "<pre>"; print_r($tripInfoResultThird);
                ...
                ?>  
                        ...
                        <div class="dscrpton-cntnt detail-box">
                            ...
                            <?php if(!empty($tripInfoResultThird['sI'][1]['cT'])){ ?>
            ...
            <?php } ?>   
						...
						<?php //if(@$this->session->userdata('flightdepartureCity3') !='') { ?>			
								...
								<!-- <div class="dF pad10 justifyBetween alignItemsCenter"><div class="dF alignItemsCenter font18">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="2rem" height="2rem" class="Flight__FlightIcon-sc-1w228os-0 fWhqRy"><path d="M31.95 16.262c-.012 0-.012 0 0 0-.337.762-2.238 1.3-2.238 1.3l-8.137-.012-8.863 12.925-2.088-.15 4.063-10.875-.225-1.95-9.588-.025L.499 22.05l-.5.063 1.438-5.663-.475-.375-.113-.088.125-.1.475-.363L.024 9.849l.5.063 4.338 4.6h9.6l.225-1.95-4.025-10.887 2.088-.15 8.825 12.963 8.137.012s2.713.762 2.238 1.763z"></path></svg>
				<span class="padL5"><?php echo $this->session->userdata('flightdepartureCity3');	?> - <?php echo $this->session->userdata('flightarrivalCity3'); ?>&nbsp;&nbsp;<?php echo $this->session->userdata('flightDateTime3'); ?></span></div><div class="dF alignItemsCenter"><span class="padR5"></span></div>
									</div>
...
<?php echo $this->session->userdata('flightdepartureCity3');	?>,<br><?php echo $this->session->userdata('flightdepartureCountry3'); ?>  <br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo $this->session->userdata('flightdepartureTerminal3'); ?>)</span></p>
                    ...
                    <?php if(!empty($tripInfoResultForth)){ ?>  
                        ...
                        <div class="dscrpton-cntnt detail-box">
                            ...
                            <?php if(!empty($tripInfoResultForth['sI'][1]['cT'])){ ?>
                    ...
                    <?php } ?> 
						...
						<?php //if(@$this->session->userdata('flightdepartureCity4') !='') { ?>			
								...
								<!-- <div class="dF pad10 justifyBetween alignItemsCenter"><div class="dF alignItemsCenter font18">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="2rem" height="2rem" class="Flight__FlightIcon-sc-1w228os-0 fWhqRy"><path d="M31.95 16.262c-.012 0-.012 0 0 0-.337.762-2.238 1.3-2.238 1.3l-8.137-.012-8.863 12.925-2.088-.15 4.063-10.875-.225-1.95-9.588-.025L.499 22.05l-.5.063 1.438-5.663-.475-.375-.113-.088.125-.1.475-.363L.024 9.849l.5.063 4.338 4.6h9.6l.225-1.95-4.025-10.887 2.088-.15 8.825 12.963 8.137.012s2.713.762 2.238 1.763z"></path></svg>
				<span class="padL5"><?php echo $this->session->userdata('flightdepartureCity4');	?> - <?php echo $this->session->userdata('flightarrivalCity4'); ?>&nbsp;&nbsp;<?php echo $this->session->userdata('flightDateTime4'); ?></span></div><div class="dF alignItemsCenter"><span class="padR5"></span></div>
									</div>
...
<?php echo $this->session->userdata('flightdepartureCity4');	?>,<br><?php echo $this->session->userdata('flightdepartureCountry4'); ?>  <br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo $this->session->userdata('flightdepartureTerminal4'); ?>)</span></p>
                        ...
                        <div class="dscrpton-cntnt detail-box">
                            <ul class="brdrBot">
                                ...
                                <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResultFifth['sI'][0]['dt'])); ?></p>
                                    <p style="margin-bottom: 3px;font-size: 18px;font-weight: 500;"><?php echo $tripInfoResultFifth['sI'][0]['da']['city']; ?>, <?php echo $tripInfoResultFifth['sI'][0]['da']['country']; ?></p>
                            ...
                            <?php if(!empty($tripInfoResultFifth['sI'][1]['cT'])){ ?>
                    ...
                    <?php } ?> 
						...
						<?php //if(@$this->session->userdata('flightdepartureCity5') !='') { ?>			
								...
								<!-- <div class="dF pad10 justifyBetween alignItemsCenter"><div class="dF alignItemsCenter font18">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="2rem" height="2rem" class="Flight__FlightIcon-sc-1w228os-0 fWhqRy"><path d="M31.95 16.262c-.012 0-.012 0 0 0-.337.762-2.238 1.3-2.238 1.3l-8.137-.012-8.863 12.925-2.088-.15 4.063-10.875-.225-1.95-9.588-.025L.499 22.05l-.5.063 1.438-5.663-.475-.375-.113-.088.125-.1.475-.363L.024 9.849l.5.063 4.338 4.6h9.6l.225-1.95-4.025-10.887 2.088-.15 8.825 12.963 8.137.012s2.713.762 2.238 1.763z"></path></svg>
				<span class="padL5"><?php echo $this->session->userdata('flightdepartureCity5');	?> - <?php echo $this->session->userdata('flightarrivalCity5'); ?>&nbsp;&nbsp;<?php echo $this->session->userdata('flightDateTime5'); ?></span></div><div class="dF alignItemsCenter"><span class="padR5"></span></div>
									</div>
                                        ...
                                        <div class="dscrpton-cntnt detail-box">
                                            <ul class="brdrBot">
                                                ...
                                                <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResultSixth['sI'][0]['dt'])); ?></p>
                                                    <p style="margin-bottom: 3px;font-size: 18px;font-weight: 500;"><?php echo $tripInfoResultSixth['sI'][0]['da']['city']; ?>, <?php echo $tripInfoResultSixth['sI'][0]['da']['country']; ?></p>
                                            ...
                                            <?php if(!empty($tripInfoResultSixth['sI'][1]['cT'])){ ?>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingOne">
                              <h4 class="panel-title">
                                ...
                                <p class="confirm-rate"><i class="fa fa-inr"></i> <?php echo number_format($this->session->userdata('baseFareTotal'),2); ?></p>
                              </h4>
                            </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingTwo">
                              <h4 class="panel-title">
                                ...
                                <p class="confirm-rate"><i class="fa fa-inr"></i> <?php echo number_format($this->session->userdata('totalTaxFare'),2); ?></p>
                              </h4>
                            </div>
                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                              <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9"><i class="fa fa-inr"></i> <?php echo $this->session->userdata('totalYQ'); ?></div>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9"><i class="fa fa-inr"></i> <?php echo $this->session->userdata('totalYR'); ?></div>
                                    </div>
                                    <?php } ?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingTwo">
                              <h4 class="panel-title">
                                ...
                                <p class="confirm-rate"><i class="fa fa-inr"></i> <?php echo number_format($this->session->userdata('totalBaggageMeal'),2); ?></p>
                              </h4>
                            </div>
                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                              <div class="panel-body">
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingThree">
                              <h4 class="panel-title">
                                ...
                                <p class="confirm-rate"><i class="fa fa-inr"></i><?php echo number_format($this->session->userdata('grossTotal'),2); ?></p>
                                <?php } else{ ?>
                                <p class="confirm-rate"><i class="fa fa-inr"></i><?php echo number_format($this->session->userdata('totalGrossAmount'),2); ?></p>
                                <?php } ?>
                              </h4>
                            </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingOne">
                              <h4 class="panel-title">
                                ...
                                <p class="confirm-rate"><i class="fa fa-inr"></i> <?php echo number_format($this->session->userdata('baseFareReTotal'),2); ?></p>
                              </h4>
                            </div>
                            <!--<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                              <div class="panel-body">
