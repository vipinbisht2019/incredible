...
<html lang="en">
<head>
<title>Tour Operational Itinerary Add</title>
<meta charset="utf-8">
...
<body>
	<div id="wrapper">
       ...
       // echo '<pre>'; print_r($getDates); die;
					foreach($getDates['dates'] as $key => $dateValue){	
              ?>
                ...
                <div class="col-md-12 form-group padding_opx">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group col-md-12 col-xs-12" style="margin-bottom: 10px;">
                      	<div class="row">
                        	<div class="form-group col-md-12 col-xs-12" style="margin-bottom: 10px;">
                                ...
                                <div class="col-md-5 form-group padding_opx"><?php  echo $getDates['cityList'][$i]['city_name']; ?></div> 
                           	</div>
                      ...
                      <?php foreach($itinerary_details[$i]['sightMoreValue'] as $key => $sightValue){
					  
					  		//print_r($sightValue);
					   ?>
                      <div>
                            <input type="time" name="Times[]" value="<?php echo $sightValue['times']?>" >
                            <select name="sightSeeings[]" id="sightSeeing">
                                <option value="">Select SightSeeing</option>
                                  <?php foreach($sightseeinglist as $key => $sightseeingValue){ ?>
                                              <option value="<?php  echo $sightseeingValue['title']; ?>" <?php if($sightValue['sightSeeings'] == $sightseeingValue['title']){echo "selected";}?>><?php  echo $sightseeingValue['title']; ?>
                                  </option>
                                    <?php } ?>
                                    </select>
                                      <select name="meals[]" id="meal">
                                        <option value="">Select Meal</option>
                                        <option value="B" <?php if($sightValue['meals'] == 'B'){echo "selected";}?>>Breakfast</option>
                                        <option value="L" <?php if($sightValue['meals'] == 'L'){echo "selected";}?>>Lunch</option><option value="D" <?php if($sightValue['meals'] == 'D'){echo "selected";}?>>Dinner</option>
                                      </select><input type="text" name="Descriptions[]" value="<?php echo $sightValue['descriptions']?>" placeholder="Description"/>
                                   <!-- <input type="hidden" name="itineraryDay[<?php //$i;?>]" value ="'+j+'">-->
                       ...
                       <script>
							...
							function addSightSeeing(id){
								 ...
								 var wrapper = $(".sight"+id);
									...
									$(wrapper).append('<div><input type="time" name="Times[]" placeholder="Time"/><select name="sightSeeings[]" id="sightSeeing"><option value="">Select SightSeeing</option><?php foreach($sightseeinglist as $key => $sightseeingValue){?><option value="<?php  echo $sightseeingValue['title']; ?>" <?php if($itinerary_details[$i]['sightSeeing'] == $sightseeingValue['title']){echo "selected";}?>><?php  echo $sightseeingValue['title']; ?></option><?php } ?></select><select name="meals[]" id="meal"><option value="">Select Meal</option><option value="B">Breakfast</option><option value="L">Lunch</option><option value="D">Dinner</option></select><input type="text" name="Descriptions[]" placeholder="Description"/><input type="hidden" name="itineraryDays[<?php $i;?>]" value ="'+j+'"><a href="#" class="delete">Delete</a></div>');
                             ...
                             <?php
										...
										$data = array("CityName[$i]"  => $getDates['cityList'][$i]['city_name']);
										 echo form_hidden($data);
							 $i++; } ?>   
