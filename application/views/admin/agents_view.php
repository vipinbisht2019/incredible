     ...
     <div class="main">
				...
				<div class="col-md-12">
					...
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"> <strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Agents View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/agents/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom"> Add Agents </a>
                            </div>
					</div>
				</div>
			...
			<div class="panel">
				...
				<div class="panel-body" style="width: 100%;; ">  <!-- overflow-x: scroll;-->
                      ...
                      <div class="col-md-12 col-xs-12 members margin_top">  
					       <?php
                ...
                <?php                         
						...
						echo form_open_multipart('admin/agents/bulk_action', $attributes); 
					...
					<table class="table table-bordered table_margin_top">
						<thead>
							<tr>
                                ...
                                <th nowrap>Membership No. </th>
                                <th nowrap>Conatcat Person </th>
                                <th>Email Id </th>
                                <th>Phone  </th>
                                <!--<th>Address  </th>-->
                                <th>City  </th>
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                                ...
                                <td><?php  echo $val['ContactPerson'] ?></td>
             ...
             <a href="<?php  echo base_url('admin/agents/edit')."?id=".$val['user_id'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/agents/delete')."?id=".$val['user_id'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
                                  ...
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['user_id'],  'checked'=> false, 'class'=>" margin_bottom" );
