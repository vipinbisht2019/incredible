...
<?php date_default_timezone_set("Asia/Kolkata"); ?>
			...
			<div class="row">
				...
				<div class="col-md-4 details_cart">
					<p>Status : <span style="color: #5CB957;font-weight: bold;"><?php  $status=$user_flight_booking[0]['booking_status']; 
					if($status == 1) { echo "Success"; } elseif($status == 2){ echo "Unpaid"; } else { echo "Cancel"; } 
					?></span></p>
