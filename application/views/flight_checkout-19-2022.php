                                                                        ...
                                                                        <div class="grid-layout seat-map__mapper">
                                                                            <div class="plane">
                                                                                ...
                                                                                <?php 
                                                                                    $seat = 1;
                                                                                    $amountSeatClass = [];
                                                                                   // echo "<pre>"; print_r($tripSeatAmount);
                                                                                    ...
                                                                                    foreach ($tripSeatRowcolumn as $key => $seatValue) { 
                                                                                        ...
                                                                                        <li class="row row--1">  
                                                                                            ...
                                                                                            ?>
                                                                                                ...
                                                                                                <label for="<?php echo $seatValue1['seatNo']; ?>" class="<?php echo $amountSeatClass[$seatValue1['amount']]; ?>"><?php echo $seatValue1['seatNo']; ?></label>
        ...
        <script>
            ...
            function getSeatSelect(seatNo,seatAmount,paxType,autoId){
                ...
                if(paxTypecheck=='adult'){
                    ...
                    $('.seatsel6').addClass('seat-map__box seat-map__box--selected'); 
                }
