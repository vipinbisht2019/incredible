                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Contact View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/leadcontact/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">  Add Contact </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/leadcontact/bulk_action', $attributes); 
					?>                                
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                            	...
                            	<td><?php echo $val['ContactId'] ?></td> 
								<td><?php echo $val['Name'] ?></td>
                                <td><?php echo $val['MobileNo'] ?></td>
                                <td><?php echo $val['EmailAddress'] ?></td>
                                <td><?php if($val['IsConverted']=='Y') echo"Yes"; else echo"No"; ?></td>
							    <td> 
                                    
            <a href="<?php echo base_url('admin/leadcontact/edit')."?id=".$val['ContactId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/leadcontact/delete')."?id=".$val['ContactId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['ContactId'],  'checked'=> false, 'class'=>" margin_bottom" );
