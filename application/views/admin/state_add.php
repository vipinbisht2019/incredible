		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>State Add</b></h3>
						</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
										...
										echo form_open_multipart('admin/state/add', $attributes);
							     ?>
               ...
               $data = array('name'  => 'StatesName', 'id' => 'StatesName', 'value'=>set_value('StatesName'), 'placeholder' => 'State', 'class'=>"form-control margin_bottom");
                       ...
                       $data = array('name'  => 'StateCode', 'id' => 'StateCode','value'=>set_value('StateCode') ,  'placeholder' => 'code', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                                    ?>
