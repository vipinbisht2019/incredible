...
<html lang="en">
<head>
<title>Tours Info Detials Add</title>
<meta charset="utf-8">
		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Tours Info Detials Add</b></h3>
						</div>
			...
			<div class="panel">
                ...
                <div class="stepwizard">
                	<div class="stepwizard-row">
                        ...
                        <div class="stepwizard-step col-md-1">
                    		<a href="<?php echo base_url('admin/tour_infodetail/edit?TourId='.$TourId); ?>"><button type="button" class="btn btn-primary btn-circle" disabled="disabled">9</button></a>
                        	<p>Tour Info Detail</p>
                		 </div> 
                         <div class="stepwizard-step col-md-1">
                    		<a href="<?php echo base_url('admin/Tour_quotedetial/edit?TourId='.$TourId); ?>"><button type="button"  class="btn btn-default btn-circle">10</button></a>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/tour_infodetail/edit', $attributes);
							     ?>

		                
								         
                          		 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">Select Tour Info Category * </label>
		                			<div class="col-md-5 form-group padding_opx">
                                          <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('info_type'); ?></span>
                                          
                                          <select name="info_type" id="info_type">
                                          <option value="">Select Tour Info Category</option>
                                          	<option value="usefull_information">UseFull Infomation</option>
                                            <option value="important_information">Important Information</option>
                                          </select>
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">Info Head *</label>
		                			<div class="col-md-5 form-group padding_opx">
                                     <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('info_head'); ?></span>
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'info_head', 'id' => 'info_head',  'value' =>$edit_infodetail[0]['info_head'],  'placeholder' => 'Info Head ', 'class'=>"form-control margin_bottom");
                                 ...
                                 <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'description', 'id' => 'description',  'value' =>$edit_infodetail[0]['description'],  'placeholder' => 'description ', 'class'=>"form-control margin_bottom");
                                         echo form_textarea($data);
                                    ?>
                                    <p>&nbsp;</p>
		                		  </div>
