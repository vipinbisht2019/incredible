                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
						 ...
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/vehicle/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Tours Vehicle</a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/vehicle/bulk_action', $attributes); 
					?>                                
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                            	...
                            	<td><?php echo $val['VehicleId'] ?></td>
								<td><?php echo $val['VehicleName'] ?></td>
                                <td><?php echo $val['MinimumFare'] ?></td>
                                <td><?php echo $val['MaxPerson'] ?></td>
                                <td><?php if($val['IsVehicle']=='Y') echo"Yes"; else echo "No"; ?></td>
             ...
             <a href="<?php echo base_url('admin/vehicle/edit')."?id=".$val['VehicleId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
             <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/vehicle/delete')."?id=".$val['VehicleId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['VehicleId'],  'checked'=> false, 'class'=>" margin_bottom" );
