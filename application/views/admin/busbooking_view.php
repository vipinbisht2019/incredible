...
<html lang="en">
 <head>
	<title>Buses Booking View</title>
	<meta charset="utf-8">
...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Buses Booking View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="#" class="btn btn-primary btn-primary1 pull-right margin_bottom">Buses Booking View</a>
			...
			echo form_open_multipart('admin/busbooking/search', $attributes);
			
			//echo"<pre>";
			//print_r($routes_buses);
			//echo"</pre>";
	 ?>
                        ...
                        <div class="col-lg-3 col-xs-12">
                            <div class="form-group">
                               ...
                               <select name="BusesRoutsId" class="form-control">
                                <option value="">Select Bus & Route</option>
                                 <?php foreach($routes_buses as $bval) { ?>
                                 <option value="<?php echo $bval['BusesRoutsId']; ?>" <?php if($bval['BusesRoutsId']==set_value('BusesRoutsId')){ echo"selected";} ?> ><?php echo $bval['RoutesName']; ?>--<?php echo $bval['CategoryName']; ?> <?php echo $bval['TypeTitle']; ?></option>
                                 <?php } ?>  
                              </select>
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                                ...
                                <td><?php echo $val['fromcity'] ?>/<?php echo $val['tocity'] ?></td>
                                <td><?php echo $val['RoutesName'] ?></td>
                                <td nowrap><?php echo $val['TypeTitle'] ?> <?php echo $val['CategoryName'] ?></td>
                                ...
                                <td style="width: 5%;"> <a href="<?php echo base_url('admin/busbooking/details/'.$val['BookingId']); ?>" class="db-done"> <i class="fa fa-info-circle" aria-hidden="true"></i></a> </td>
                                <td style="width: 6%;"> <a href="<?php echo base_url('admin/busbooking/ticketprint/'.$val['BookingId']); ?>" class="db-done"> <i class="fa fa-print" aria-hidden="true"></i></a> </td>
                                <td style="width: 5%;"><a onClick="return confirm('Are you sure you want to cancel?')" href="<?php echo base_url('admin/busbooking/busbookingcancle/').$val['BookingId']; ?>" class="db-done"> <i class="fa fa-window-close" aria-hidden="true"></i></a></td>
