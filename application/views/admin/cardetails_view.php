...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Car Details View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/cardetails/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Car Details </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/cardetails/bulk_action', $attributes); 
					?>                                
					...
					<table class="table table-bordered table_margin_top">
						<thead>
							<tr>
                                ...
                                <th>Seating </th>
                                <th>Fare</th>
                                <th>Extra Mileage (<small>per km</small>)</th>
                                <th>Extra Hours (<small>per hours</small>)</th>
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                                ...
                                <td>INR <?php echo $val['Fare'] ?> For  <?php echo $val['TimeLimit'] ?> Hours / <?php echo $val['DistanceLimit'] ?> KM </td>
                                <td>INR <?php echo $val['ExtraMileage'] ?></td>
                                <td>INR <?php echo $val['ExtraHours'] ?></td>
            ...
            <a href="<?php echo base_url('admin/cardetails/edit')."?id=".$val['CarId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/cardetails/delete')."?id=".$val['CarId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['CarId'],  'checked'=> false, 'class'=>" margin_bottom" );
