...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Holiday Booking View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="#" class="btn btn-primary btn-primary1 pull-right margin_bottom">Holiday Booking View</a>
			...
			echo form_open_multipart('admin/holidaybooking/search', $attributes);
	 ?>
...
<td style="width: 5%;"> <a href="<?php echo base_url('admin/holidaybooking/toursbookingdetails/').$val['BookingId']; ?>" class="db-done"> <i class="fa fa-info-circle"></i></a></td>
<td style="width: 5%;"> <a href="<?php echo base_url('admin/holidaybooking/toursticketprint/'.$val['BookingId']);?>" class="db-done"> <i class="fa fa-print"></i> </a></td>
<td style="width: 6%;"> <a onClick="return confirm('Are you sure you want to cancel?')"  href="<?php echo base_url('admin/holidaybooking/toursbookingcancle/').$val['BookingId']; ?>" class="db-done"> <i class="fa fa-window-close" aria-hidden="true"></i></a> </td>
