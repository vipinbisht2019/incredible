...
<html lang="en">
  <head>
	<title>Tour Unpaid Bus Details</title>
	<meta charset="utf-8">
            	...
            	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Tour Unpaid Bus Detail </b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/busbookingenc/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
                            ...
                            <table class="table">
                             ...
                             <tbody>
                                ...
                                <tr>
                                   ...
                                   <td class="font_16px" style="border-top: 0px;"> <?php echo $busbookingenc_deatils[0]['Name'] ?></td>
                                </tr>
                    
                                <tr>
                                   <td class="font_16px"> <i class="fa fa-envelope"></i> Email : </td>
                                   <td class="font_16px"><?php echo $busbookingenc_deatils[0]['Email'] ?> </td>
                                </tr>
                    
                                <tr>
                                   <td class="font_16px"> <i class="fa fa-phone"></i> Phone No. : </td>
                                   <td class="font_16px"> <?php echo $busbookingenc_deatils[0]['PhoneNo'] ?> / <?php echo $busbookingenc_deatils[0]['AltPhoneNo'] ?> </td>
                                </tr>
                    
                                   <tr>
                                   <td class="font_16px"> <i class="fa fa-map"></i>Boarding Point  </td>
                             <td class="font_16px"><?php echo date('d-M-Y',strtotime($busbookingenc_deatils[0]['DepartureDate']))  ?>&nbsp;/&nbsp;<?php echo $busbookingenc_deatils[0]['boardingpoint'] ?>  </td>
                                </tr>
                                
                                 <tr>
                                   <td class="font_16px"> <i class="fa fa-envelope"></i> Address  </td>
                                   <td class="font_16px"> <?php echo $busbookingenc_deatils[0]['Address'] ?>  </td>
                                </tr>
                            ...
                            <table class="table">
                             ...
                             <tbody>
                                ...
                                <tr>
                                   ...
                                   <td class="font_16px" style="border-top: 0px;"> <i class="fa fa-inr"></i> <?php echo $busbookingenc_deatils[0]['Fare']  ?> </td>
                                </tr>
                    
                                <tr>
                                   <td class="font_16px">  GST (5%) : </td>
                                   <td class="font_16px"> <i class="fa fa-inr"></i>    <?php echo $busbookingenc_deatils[0]['Gst']  ?> </td>
                                </tr>
                    
                                <tr>
                                   <td class="font_16px">  Total Fare  : </td>
                                   <td class="font_16px"> <i class="fa fa-inr"></i> <?php echo $busbookingenc_deatils[0]['TotalFare']  ?></td>
                                </tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                   ...
                                   <td class="font_16px"> <?php echo $busbookingenc_deatils[0]['SeatNo'] ?>  </td>
                                </tr>
...
<div class="col-lg-12 col-xs-12">
  ...
  <table id="Mytable">
    <tbody>
       ...
       <tr>
          <td class="font_16px">  <img src="<?php echo base_url('/uploads/bus/'.$busbookingenc_deatils[0]['Photo1']) ?>" style="width: 100px;">   </td>
          <td class="font_16px">  <?php echo $busbookingenc_deatils[0]['TypeTitle']  ?>  <?php echo $busbookingenc_deatils[0]['CategoryName']  ?>  </td>
          <td class="font_16px"> <?php echo $busbookingenc_deatils[0]['RoutesName']  ?>  </td> 
          <td class="font_16px">  <?php echo $busbookingenc_deatils[0]['fromcity']  ?>   </td>  
          <td class="font_16px"> <?php echo $busbookingenc_deatils[0]['tocity']  ?>   </td>  
           <td class="font_16px"> <?php echo date("d-M-Y",strtotime($busbookingenc_deatils[0]['DepartureDate'])); ?> </td> 
          <td class="font_16px">  <?php echo $busbookingenc_deatils[0]['boardingpoint']  ?>   </td>
        ...
        <tr>
          <td  colspan="7">
            <p>&nbsp;</p>
           <b>Note:</b>  <?php echo $busbookingenc_deatils[0]['BookingNote']  ?>  </td>
