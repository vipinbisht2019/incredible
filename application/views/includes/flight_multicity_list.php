<?php //echo "<pre>"; print_r($completeResultfifth); die;?>
<style>
        .mealBasis__filter {
        display: block;
                    ...
                    <div id="sidebar" class="col-lg-12">                        
                        <aside class="detail-sidebar sidebar-wrapper">
                            ...
                            <div class="sidebar-item" style="height: 135px;">
                                ...
                                <p id="price_show"><span class="fa fa-rupee"> 500 </span> - <span class="fa fa-rupee"> <?php echo number_format($maximumPrice); ?> </span></p>
                                    ...
                                    <tr style="height: 120px;">
                                        <td class="text-center">
                                            <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;">
                                                ...
                                                <p style="font-size:11px;font-weight:400;line-height: 13px;"><?php echo $flightValue['flghtCode'] ?> - <?php echo $flightValue['flghtNumber']; ?></p>
                                                </li>
                                            </ul>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <h6 style="display: flex;flex-direction: column;text-align: center;font-size: 13px;align-items: baseline;"><?php echo $hours."h ".$min."m" ; ?>
                                        ...
                                        <td>
                                            <h6 style="font-size: 18px;color: #363636;font-weight: 600;justify-content: center;text-align: center;"> <?php echo $arrivalTime; ?></h6> 
                    ...
                    <div id="sidebar" class="col-lg-12">                        
                        <aside class="detail-sidebar sidebar-wrapper">
                            <div class="sidebar-item" style="height: 135px;">
                                ...
                                <input type="hidden" id="hidden_minimum_price1q" value="500" />
                                <input type="hidden" id="hidden_maximum_price1q" value="<?php echo $twomaximumPrice; ?>" />
                                <p id="price_show1q"><span class="fa fa-rupee"> 500 </span> - <span class="fa fa-rupee"> <?php echo number_format($twomaximumPrice); ?> </span></p>
                                <div id="price_range1q"></div> 
                            ...
                            <div class="sidebar-item">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-xs-3">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="directstq">
                                            <input type="checkbox" class="dep2" name="stopsq2" id="directstopq" onclick="getPageq2();" value="0">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="directsttq">0</span>
                                            </span>
                                        </label>
                                        <!--<p class="filter-p">Direct</p>-->
                                    </div>
                                    <div class="col-md-3 col-xs-3">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="onestq">
                                            <input type="checkbox" class="dep2" name="stopsq2" id="onestopq" onclick="getPageq2();" value="1">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="onesttq">1</span>
                                            </span>
                                        </label>
                                        <!--<p class="filter-p">1 Stop</p>-->
                                    </div>
                                    <div class="col-md-3 col-xs-3">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="twostq">
                                            <input type="checkbox" class="dep2" name="stopsq2" id="twostopq" onclick="getPageq2();" value="2">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="twosttq">2</span>
                                            </span>
                                        </label>
                                        <!--<p class="filter-p">2+ Stops</p>-->
                                    </div>
                                    <div class="col-md-3 col-xs-3">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="threestq">
                                            <input type="checkbox" class="dep2" name="stopsq2" id="threestopq" onclick="getPageq2();" value="3">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="threesttq">3+</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3"></div>
                            ...
                            <div class="sidebar-item" style="height: 135px;">
                                ...
                                <div class="sidebar-content">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="before111q">
                                                <input type="checkbox"  class="dep2" name="depatureIdq2" id="before11q" onclick="getPageq2();" value="0,1,2,3,4,5:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="before1111q"><img src="<?php echo base_url("assets/images/morning_inactive-1.png")?>" style="width: 60%;"> Before 6am</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after111q">
                                                <input type="checkbox" class="dep2"  name="depatureIdq2"   id="after11q" onclick="getPageq2();" value="6,7,8,9,10,11:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="after1111q"><img src="<?php echo base_url("assets/images/noon_inactive-1.png")?>" style="width: 60%;"> 6am - 12pm</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after55q">
                                                <input type="checkbox" class="dep2"  name="depatureIdq2" id="after5q" onclick="getPageq2();" value="12,13,14,15,16,17:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="after555q"><img src="<?php echo base_url("assets/images/evening_inactive-1.png")?>" style="width: 60%;"> 12pm - 6pm</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after99q">
                                                <input type="checkbox" class="dep2"  name="depatureIdq2" id="after9q" onclick="getPageq2();" value="18,19,20,21,22,23:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="after999q"><img src="<?php echo base_url("assets/images/night_inactive-1.png")?>" style="width: 60%;"> After 6pm</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="sidebar-item" style="height: 135px;">
                                ...
                                <div class="sidebar-content">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="arrival111q">
                                                <input type="checkbox"  class="dep2" name="arrivalIdq2" id="arrival11q" onclick="getPageq2();" value="0,1,2,3,4,5:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="arrival1111q"><img src="<?php echo base_url("assets/images/morning_inactive-1.png")?>" style="width: 60%;"> Before 6am</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter111q">
                                                <input type="checkbox" class="dep2"  name="arrivalIdq2"   id="aafter11q" onclick="getPageq2();" value="6,7,8,9,10,11:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="aafter1111q"><img src="<?php echo base_url("assets/images/noon_inactive-1.png")?>" style="width: 60%;"> 6am - 12pm</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter555q">
                                                <input type="checkbox" class="dep2"  name="arrivalIdq2" id="aafter5q" onclick="getPageq2();" value="12,13,14,15,16,17:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="aafter5555q"><img src="<?php echo base_url("assets/images/evening_inactive-1.png")?>" style="width: 60%;"> 12pm - 6pm</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter99q">
                                                <input type="checkbox" class="dep2"  name="arrivalIdq2" id="aafter9q" onclick="getPageq2();" value="18,19,20,21,22,23:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="aafter999q"><img src="<?php echo base_url("assets/images/night_inactive-1.png")?>" style="width: 60%;"> After 6pm</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="sidebar-item">
                                ...
                                <div class="sidebar-content">
                                    ...
                                    <div class="mealBasis__filter" style="display: flex;align-items: center;">
                                        ...
                                        <span class="starrating__check" style="display: flex;align-items: center;line-height: 10px;">
                                            <span class="checkmark">
                                            <input type="checkbox" name="airlineq2" onclick="getPageq2();" class="checkmark__input" value="<?php echo $flightValue2['flightCode'] ; ?>">
                                            <label for="airline" class="checkmark__label"> </label>
                                            </span>
                                        </span>
                                    </div>
                                    ...
                                    <tr style="height: 120px;">
                                        <td class="text-center">
                                            <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;">
                                                ...
                                                <p style="font-size:11px;font-weight:400;line-height: 13px;"><?php echo $flightValue1['flghtCode'] ?> - <?php echo $flightValue1['flghtNumber']; ?></p>
                                                </li>
                                            </ul>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <h6 style="display: flex;flex-direction: column;text-align: center;font-size: 13px;align-items: baseline;"><?php echo $hours1."h ".$min1."m" ; ?>
                                            <div class="relative fliStopsSep">
                                                <p class="fliStopsSepLine" style="border-top: 3px solid rgb(102, 137, 221);"></p>
                                            </div>
                                        ...
                                        <td>
                                            <h6 style="font-size: 18px;color: #363636;font-weight: 600;justify-content: center;text-align: center;"> <?php echo $arrivalTime1; ?></h6> 
                ...
                <div id="sidebar" class="col-lg-12">
                    ...
                    <aside class="detail-sidebar sidebar-wrapper">
                        ...
                        <div class="sidebar-item" style="height: 135px;">
                            ...
                            <input type="hidden" id="hidden_minimum_price3q" value="500" />
                            <input type="hidden" id="hidden_maximum_price3q" value="<?php echo $thirdMaximumPrice; ?>" />
                            <p id="price_show3q"><span class="fa fa-rupee"> 500 </span> - <span class="fa fa-rupee"> <?php echo number_format($thirdMaximumPrice); ?> </span></p>
                            <div id="price_range3q"></div> 
                        ...
                        <div class="sidebar-item">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="directstq3">
                                        <input type="checkbox" class="dep2" name="stopsq3" id="directstopq3" onclick="getPageq3();" value="0">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="directsttq3">0</span>
                                        </span>
                                    </label>
                                    <!--<p class="filter-p">Direct</p>-->
                                </div>
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="onestq3">
                                        <input type="checkbox" class="dep2" name="stopsq3" id="onestopq3" onclick="getPageq3();" value="1">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="onesttq3">1</span>
                                        </span>
                                    </label>
                                    <!--<p class="filter-p">1 Stop</p>-->
                                </div>
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="twostq3">
                                        <input type="checkbox" class="dep2" name="stopsq3" id="twostopq3" onclick="getPageq3();" value="2">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="twosttq3">2</span>
                                        </span>
                                    </label>
                                    <!--<p class="filter-p">2+ Stops</p>-->
                                </div>
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="threestq3">
                                        <input type="checkbox" class="dep2" name="stopsq3" id="threestopq3" onclick="getPageq3();" value="3">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="threesttq3">3+</span>
                                        </span>
                                    </label>
                                </div>
                                <div class="col-md-3"></div>
                        ...
                        <div class="sidebar-item" style="height: 135px;">
                            ...
                            <div class="sidebar-content">
                                <div class="row">
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="before111q3">
                                            <input type="checkbox"  class="dep2" name="depatureIdq3" id="before11q3" onclick="getPageq3();" value="0,1,2,3,4,5:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="before1111q3"><img src="<?php echo base_url("assets/images/morning_inactive-1.png")?>" style="width: 60%;"> Before 6am</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after111q3">
                                            <input type="checkbox" class="dep2"  name="depatureIdq3"   id="after11q3" onclick="getPageq3();" value="6,7,8,9,10,11:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="after1111q3"><img src="<?php echo base_url("assets/images/noon_inactive-1.png")?>" style="width: 60%;"> 6am - 12pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after55q3">
                                            <input type="checkbox" class="dep2"  name="depatureIdq3" id="after5q3" onclick="getPageq3();" value="12,13,14,15,16,17:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="after555q3"><img src="<?php echo base_url("assets/images/evening_inactive-1.png")?>" style="width: 60%;"> 12pm - 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after99q3">
                                            <input type="checkbox" class="dep2"  name="depatureIdq3" id="after9q3" onclick="getPageq3();" value="18,19,20,21,22,23:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="after999q3"><img src="<?php echo base_url("assets/images/night_inactive-1.png")?>" style="width: 60%;"> After 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="sidebar-item" style="height: 135px;">
                            ...
                            <div class="sidebar-content">
                                <div class="row">
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="arrival111q3">
                                            <input type="checkbox"  class="dep2" name="arrivalIdq3" id="arrival11q3" onclick="getPageq3();" value="0,1,2,3,4,5:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="arrival1111q3"><img src="<?php echo base_url("assets/images/morning_inactive-1.png")?>" style="width: 60%;"> Before 6am</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter111q3">
                                            <input type="checkbox" class="dep2"  name="arrivalIdq3"   id="aafter11q3" onclick="getPageq3();" value="6,7,8,9,10,11:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="aafter1111q3"><img src="<?php echo base_url("assets/images/noon_inactive-1.png")?>" style="width: 60%;"> 6am - 12pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter555q3">
                                            <input type="checkbox" class="dep2"  name="arrivalIdq3" id="aafter5q3" onclick="getPageq3();" value="12,13,14,15,16,17:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="aafter5555q3"><img src="<?php echo base_url("assets/images/evening_inactive-1.png")?>" style="width: 60%;"> 12pm - 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter99q3">
                                            <input type="checkbox" class="dep2"  name="arrivalIdq3" id="aafter9q3" onclick="getPageq3();" value="18,19,20,21,22,23:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="aafter999q3"><img src="<?php echo base_url("assets/images/night_inactive-1.png")?>" style="width: 60%;"> After 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="sidebar-item">
                            ...
                            <div class="sidebar-content">
                                ...
                                <div class="mealBasis__filter" style="display: flex;align-items: center;">
                                    ...
                                    <span class="starrating__check" style="display: flex;align-items: center;line-height: 10px;">
                                        <span class="checkmark">
                                        <input type="checkbox" name="airlineq3" onclick="getPageq3();" class="checkmark__input" value="<?php echo $flightValue3['flightCode'] ; ?>">
                                        <label for="airline" class="checkmark__label"> </label>
                                        </span>
                                    </span>
                                </div>
                                ...
                                <tr style="height: 120px;">
                                    <td class="text-center">
                                        <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;">
                                            ...
                                            <p style="font-size:11px;font-weight:400;line-height: 13px;"><?php echo $flightValue3['flghtCode'] ?> - <?php echo $flightValue3['flghtNumber']; ?></p>
                                            </li>
                                        </ul>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <h6 style="display: flex;flex-direction: column;text-align: center;font-size: 13px;align-items: baseline;"><?php echo $hours3."h ".$min3."m" ; ?>
                                        <div class="relative fliStopsSep">
                                            <p class="fliStopsSepLine" style="border-top: 3px solid rgb(102, 137, 221);"></p>
                                        </div>
                ...
                <div id="sidebar" class="col-lg-12">
                    ...
                    <aside class="detail-sidebar sidebar-wrapper">
                        ...
                        <div class="sidebar-item" style="height: 135px;">
                            ...
                            <input type="hidden" id="hidden_minimum_price4q" value="500" />
                            <input type="hidden" id="hidden_maximum_price4q" value="<?php echo $fourthMaximumPrice; ?>" />
                            <p id="price_show4q"><span class="fa fa-rupee"> 500 </span> - <span class="fa fa-rupee"> <?php echo number_format($fourthMaximumPrice); ?> </span></p>
                            <div id="price_range4q"></div> 
                        ...
                        <div class="sidebar-item">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="directstq4">
                                        <input type="checkbox" class="dep2" name="stopsq4" id="directstopq4" onclick="getPageq4();" value="0">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="directsttq4">0</span>
                                        </span>
                                    </label>
                                    <!--<p class="filter-p">Direct</p>-->
                                </div>
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="onestq4">
                                        <input type="checkbox" class="dep2" name="stopsq4" id="onestopq4" onclick="getPageq4();" value="1">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="onesttq4">1</span>
                                        </span>
                                    </label>
                                    <!--<p class="filter-p">1 Stop</p>-->
                                </div>
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="twostq4">
                                        <input type="checkbox" class="dep2" name="stopsq4" id="twostopq4" onclick="getPageq4();" value="2">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="twosttq4">2</span>
                                        </span>
                                    </label>
                                    <!--<p class="filter-p">2+ Stops</p>-->
                                </div>
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="threestq4">
                                        <input type="checkbox" class="dep2" name="stopsq4" id="threestopq4" onclick="getPageq4();" value="3">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="threesttq4">3+</span>
                                        </span>
                                    </label>
                                </div>
                                <div class="col-md-3"></div>
                        ...
                        <div class="sidebar-item" style="height: 135px;">
                            ...
                            <div class="sidebar-content">
                                <div class="row">
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="before111q4">
                                            <input type="checkbox"  class="dep2" name="depatureIdq4" id="before11q4" onclick="getPageq4();" value="0,1,2,3,4,5:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="before1111q4"><img src="<?php echo base_url("assets/images/morning_inactive-1.png")?>" style="width: 60%;"> Before 6am</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after111q4">
                                            <input type="checkbox" class="dep2"  name="depatureIdq4"   id="after11q4" onclick="getPageq4();" value="6,7,8,9,10,11:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="after1111q4"><img src="<?php echo base_url("assets/images/noon_inactive-1.png")?>" style="width: 60%;"> 6am - 12pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after55q4">
                                            <input type="checkbox" class="dep2"  name="depatureIdq4" id="after5q4" onclick="getPageq4();" value="12,13,14,15,16,17:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="after555q4"><img src="<?php echo base_url("assets/images/evening_inactive-1.png")?>" style="width: 60%;"> 12pm - 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after99q4">
                                            <input type="checkbox" class="dep2"  name="depatureIdq4" id="after9q4" onclick="getPageq4();" value="18,19,20,21,22,23:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="after999q4"><img src="<?php echo base_url("assets/images/night_inactive-1.png")?>" style="width: 60%;"> After 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="sidebar-item" style="height: 135px;">
                            ...
                            <div class="sidebar-content">
                                <div class="row">
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="arrival111q4">
                                            <input type="checkbox"  class="dep2" name="arrivalIdq4" id="arrival11q4" onclick="getPageq4();" value="0,1,2,3,4,5:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="arrival1111q4"><img src="<?php echo base_url("assets/images/morning_inactive-1.png")?>" style="width: 60%;"> Before 6am</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter111q4">
                                            <input type="checkbox" class="dep2"  name="arrivalIdq4"   id="aafter11q4" onclick="getPageq4();" value="6,7,8,9,10,11:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="aafter1111q4"><img src="<?php echo base_url("assets/images/noon_inactive-1.png")?>" style="width: 60%;"> 6am - 12pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter555q4">
                                            <input type="checkbox" class="dep2"  name="arrivalIdq4" id="aafter5q4" onclick="getPageq4();" value="12,13,14,15,16,17:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="aafter5555q4"><img src="<?php echo base_url("assets/images/evening_inactive-1.png")?>" style="width: 60%;"> 12pm - 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter99q4">
                                            <input type="checkbox" class="dep2"  name="arrivalIdq4" id="aafter9q4" onclick="getPageq4();" value="18,19,20,21,22,23:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="aafter999q4"><img src="<?php echo base_url("assets/images/night_inactive-1.png")?>" style="width: 60%;"> After 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="sidebar-item">
                            ...
                            <div class="sidebar-content">
                                ...
                                <div class="mealBasis__filter" style="display: flex;align-items: center;">
                                    ...
                                    <span class="starrating__check" style="display: flex;align-items: center;line-height: 10px;">
                                        <span class="checkmark">
                                        <input type="checkbox" name="airlineq4" onclick="getPageq4();" class="checkmark__input" value="<?php echo $flightValue4['flightCode'] ; ?>">
                                        <label for="airline" class="checkmark__label"> </label>
                                        </span>
                                    </span>
                                </div>
                                        ...
                                        <ul>
                                            ...
                                            foreach ($flightValue['pricelist'] as $key => $fareList) {
                                                ...
                                                <li>
                                                    ...
                                                    <div style="display: flex;align-items: center;margin-bottom: 5px;">
                                                    <input type="radio" name="fav_language4" id="pricecheck<?php echo $fp; ?>" value="<?php echo $fareList['flightId'] ; ?>"  style="width: 18px;height: 18px;margin-top: 0px;" <?php if($fareList['flightId'] == $flightValue['pricelist'][0]['flightId']){ echo "checked"; } ?> onClick="getFlightSelectionMultiCity4('<?php echo $fareList['flightId'] ; ?>','<?php echo $fp; ?>');getlightDetails('<?php echo $fareList['flightId'] ; ?>');getFlightDetails('<?php echo $fareList['flightId'] ; ?>','<?php echo $fareList['totalFare'] ; ?>','<?php echo $fareList['adultBaseFare'] ; ?>','<?php echo $fareList['adultTaxFare'] ; ?>','<?php echo $fareList['countadultPax'] ; ?>','<?php echo @$fareList['childBaseFare'] ; ?>','<?php echo @$fareList['childTaxFare'] ; ?>','<?php echo @$fareList['countchildPax'] ; ?>','<?php echo @$fareList['infantBaseFare'] ; ?>','<?php echo @$fareList['infantTaxFare'] ; ?>','<?php echo @$fareList['countinfantPax'] ; ?>'); getFlightBaggageInfo('<?php echo $fareList['adultCheckInBaggage']; ?>','<?php echo $fareList['childCheckInBaggage']; ?>','<?php echo $fareList['adultCabinBaggage'];?>','<?php echo $fareList['childCabinBaggage'];?>','<?php echo $fareList['infantCabinBaggage'];?>','<?php echo $fareList['flightId'];?>','<?php echo $flightValue['departureAirportCode']  ?>','<?php echo $flightValue['arrivalAirportCode']; ?>'); getFlightFareRules('<?php echo $fareList['flightId']; ?>','<?php echo $flightValue['departureAirportCode']  ?>','<?php echo $flightValue['arrivalAirportCode']; ?>'); " >&nbsp;&nbsp;
                ...
                <div id="sidebar" class="col-lg-12">
                    ...
                    <aside class="detail-sidebar sidebar-wrapper">
                        ...
                        <div class="sidebar-item" style="height: 135px;">
                            ...
                            <input type="hidden" id="hidden_minimum_price5q" value="500" />
                            <input type="hidden" id="hidden_maximum_price5q" value="<?php echo $fifthMaximumPrice; ?>" />
                            <p id="price_show5q"><span class="fa fa-rupee"> 500 </span> - <span class="fa fa-rupee"> <?php echo number_format($fifthMaximumPrice); ?> </span></p>
                            <div id="price_range5q"></div> 
                        ...
                        <div class="sidebar-item">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="directstq5">
                                        <input type="checkbox" class="dep2" name="stopsq5" id="directstopq5" onclick="getPageq5();" value="0">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="directsttq5">0</span>
                                        </span>
                                    </label>
                                    <!--<p class="filter-p">Direct</p>-->
                                </div>
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="onestq5">
                                        <input type="checkbox" class="dep2" name="stopsq5" id="onestopq5" onclick="getPageq5();" value="1">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="onesttq5">1</span>
                                        </span>
                                    </label>
                                    <!--<p class="filter-p">1 Stop</p>-->
                                </div>
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="twostq5">
                                        <input type="checkbox" class="dep2" name="stopsq5" id="twostopq5" onclick="getPageq5();" value="2">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="twosttq5">2</span>
                                        </span>
                                    </label>
                                    <!--<p class="filter-p">2+ Stops</p>-->
                                </div>
                                <div class="col-md-3 col-xs-3">
                                    <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="threestq5">
                                        <input type="checkbox" class="dep2" name="stopsq5" id="threestopq5" onclick="getPageq5();" value="3">
                                        <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                            <span class="black" id="threesttq5">3+</span>
                                        </span>
                                    </label>
                                </div>
                                <div class="col-md-3"></div>
                        ...
                        <div class="sidebar-item" style="height: 135px;">
                            ...
                            <div class="sidebar-content">
                                <div class="row">
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="before111q5">
                                            <input type="checkbox"  class="dep2" name="depatureIdq5" id="before11q5" onclick="getPageq5();" value="0,1,2,3,4,5:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="before1111q5"><img src="<?php echo base_url("assets/images/morning_inactive-1.png")?>" style="width: 60%;"> Before 6am</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after111q5">
                                            <input type="checkbox" class="dep2"  name="depatureIdq5"   id="after11q5" onclick="getPageq5();" value="6,7,8,9,10,11:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="after1111q5"><img src="<?php echo base_url("assets/images/noon_inactive-1.png")?>" style="width: 60%;"> 6am - 12pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after55q5">
                                            <input type="checkbox" class="dep2"  name="depatureIdq5" id="after5q5" onclick="getPageq5();" value="12,13,14,15,16,17:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="after555q5"><img src="<?php echo base_url("assets/images/evening_inactive-1.png")?>" style="width: 60%;"> 12pm - 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after99q5">
                                            <input type="checkbox" class="dep2"  name="depatureIdq5" id="after9q5" onclick="getPageq5();" value="18,19,20,21,22,23:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="after999q5"><img src="<?php echo base_url("assets/images/night_inactive-1.png")?>" style="width: 60%;"> After 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="sidebar-item" style="height: 135px;">
                            ...
                            <div class="sidebar-content">
                                <div class="row">
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="arrival111q5">
                                            <input type="checkbox"  class="dep2" name="arrivalIdq5" id="arrival11q5" onclick="getPageq5();" value="0,1,2,3,4,5:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="arrival1111q5"><img src="<?php echo base_url("assets/images/morning_inactive-1.png")?>" style="width: 60%;"> Before 6am</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter111q5">
                                            <input type="checkbox" class="dep2"  name="arrivalIdq5"   id="aafter11q5" onclick="getPageq5();" value="6,7,8,9,10,11:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="aafter1111q5"><img src="<?php echo base_url("assets/images/noon_inactive-1.png")?>" style="width: 60%;"> 6am - 12pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter555q5">
                                            <input type="checkbox" class="dep2"  name="arrivalIdq5" id="aafter5q5" onclick="getPageq5();" value="12,13,14,15,16,17:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="aafter5555q5"><img src="<?php echo base_url("assets/images/evening_inactive-1.png")?>" style="width: 60%;"> 12pm - 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter99q5">
                                            <input type="checkbox" class="dep2"  name="arrivalIdq5" id="aafter9q5" onclick="getPageq5();" value="18,19,20,21,22,23:59">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="aafter999q5"><img src="<?php echo base_url("assets/images/night_inactive-1.png")?>" style="width: 60%;"> After 6pm</span>
                                            </span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="sidebar-item">
                            ...
                            <div class="sidebar-content">
                                ...
                                <div class="mealBasis__filter" style="display: flex;align-items: center;">
                                    ...
                                    <span class="starrating__check" style="display: flex;align-items: center;line-height: 10px;">
                                        <span class="checkmark">
                                        <input type="checkbox" name="airlineq5" onclick="getPageq5();" class="checkmark__input" value="<?php echo $flightValue5['flightCode'] ; ?>">
                                        <label for="airline" class="checkmark__label"> </label>
                                        </span>
                                    </span>
                                </div>
                        ...
                        <?php 
                            ...
                            foreach($completeResultfifth as $key => $flightValue) {
                                ...
                                <tr style="height: 120px;">
                                    ...
                                    <td>
                                        <h6 style="text-align: center;"> <?php echo $arrivalTime; ?></h6> 
                                        <p style="text-align: center;"><?php echo $flightValue['arrivalCity'] ?></p> 
                                    </td>
                                    <?php if($bookingType == 'M'){ ?>
                                    <td>
                                        <ul>
                                            ...
                                            foreach ($flightValue['pricelist'] as $key => $fareList) {
                                                ...
                                                <li>
                                                    ...
                                                    <div style="display: flex;align-items: center;margin-bottom: 5px;">
                                                    <input type="radio" name="fav_language5" id="pricecheck<?php echo $fp; ?>" value="<?php echo $fareList['flightId'] ; ?>"  style="width: 18px;height: 18px;margin-top: 0px;" <?php if($fareList['flightId'] == $flightValue['pricelist'][0]['flightId']){ echo "checked"; } ?> onClick="getFlightSelectionMultiCity5('<?php echo $fareList['flightId'] ; ?>','<?php echo $fp; ?>');getlightDetails('<?php echo $fareList['flightId'] ; ?>');getFlightDetails('<?php echo $fareList['flightId'] ; ?>','<?php echo $fareList['totalFare'] ; ?>','<?php echo $fareList['adultBaseFare'] ; ?>','<?php echo $fareList['adultTaxFare'] ; ?>','<?php echo $fareList['countadultPax'] ; ?>','<?php echo @$fareList['childBaseFare'] ; ?>','<?php echo @$fareList['childTaxFare'] ; ?>','<?php echo @$fareList['countchildPax'] ; ?>','<?php echo @$fareList['infantBaseFare'] ; ?>','<?php echo @$fareList['infantTaxFare'] ; ?>','<?php echo @$fareList['countinfantPax'] ; ?>'); getFlightBaggageInfo('<?php echo $fareList['adultCheckInBaggage']; ?>','<?php echo $fareList['childCheckInBaggage']; ?>','<?php echo $fareList['adultCabinBaggage'];?>','<?php echo $fareList['childCabinBaggage'];?>','<?php echo $fareList['infantCabinBaggage'];?>','<?php echo $fareList['flightId'];?>','<?php echo $flightValue['departureAirportCode']  ?>','<?php echo $flightValue['arrivalAirportCode']; ?>'); getFlightFareRules('<?php echo $fareList['flightId']; ?>','<?php echo $flightValue['departureAirportCode']  ?>','<?php echo $flightValue['arrivalAirportCode']; ?>'); " >&nbsp;&nbsp;
                    ...
                    <div id="sidebar" class="col-lg-12">
                        ...
                        <aside class="detail-sidebar sidebar-wrapper">
                            ...
                            <div class="sidebar-item" style="height: 135px;">
                                ...
                                <input type="hidden" id="hidden_minimum_price6q" value="500" />
                                <input type="hidden" id="hidden_maximum_price6q" value="<?php echo $sixthMaximumPrice; ?>" />
                                <p id="price_show6q"><span class="fa fa-rupee"> 500 </span> - <span class="fa fa-rupee"> <?php echo number_format($sixthMaximumPrice); ?> </span></p>
                                <div id="price_range6q"></div> 
                            ...
                            <div class="sidebar-item">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-xs-3">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="directstq6">
                                            <input type="checkbox" class="dep2" name="stopsq6" id="directstopq6" onclick="getPageq6();" value="0">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="directsttq6">0</span>
                                            </span>
                                        </label>
                                        <!--<p class="filter-p">Direct</p>-->
                                    </div>
                                    <div class="col-md-3 col-xs-3">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="onestq6">
                                            <input type="checkbox" class="dep2" name="stopsq6" id="onestopq6" onclick="getPageq6();" value="1">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="onesttq6">1</span>
                                            </span>
                                        </label>
                                        <!--<p class="filter-p">1 Stop</p>-->
                                    </div>
                                    <div class="col-md-3 col-xs-3">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="twostq6">
                                            <input type="checkbox" class="dep2" name="stopsq6" id="twostopq6" onclick="getPageq6();" value="2">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="twosttq6">2</span>
                                            </span>
                                        </label>
                                        <!--<p class="filter-p">2+ Stops</p>-->
                                    </div>
                                    <div class="col-md-3 col-xs-3">
                                        <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="threestq6">
                                            <input type="checkbox" class="dep2" name="stopsq6" id="threestopq6" onclick="getPageq6();" value="3">
                                            <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                <span class="black" id="threesttq6">3+</span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-md-3"></div>
                            ...
                            <div class="sidebar-item" style="height: 135px;">
                                ...
                                <div class="sidebar-content">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="before111q6">
                                                <input type="checkbox"  class="dep2" name="depatureIdq6" id="before11q6" onclick="getPageq6();" value="0,1,2,3,4,5:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="before1111q6"><img src="<?php echo base_url("assets/images/morning_inactive-1.png")?>" style="width: 60%;"> Before 6am</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after111q6">
                                                <input type="checkbox" class="dep2"  name="depatureIdq6"   id="after11q6" onclick="getPageq6();" value="6,7,8,9,10,11:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="after1111q6"><img src="<?php echo base_url("assets/images/noon_inactive-1.png")?>" style="width: 60%;"> 6am - 12pm</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after55q6">
                                                <input type="checkbox" class="dep2"  name="depatureIdq6" id="after5q6" onclick="getPageq6();" value="12,13,14,15,16,17:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="after555q6"><img src="<?php echo base_url("assets/images/evening_inactive-1.png")?>" style="width: 60%;"> 12pm - 6pm</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="after99q6">
                                                <input type="checkbox" class="dep2"  name="depatureIdq6" id="after9q6" onclick="getPageq6();" value="18,19,20,21,22,23:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="after999q6"><img src="<?php echo base_url("assets/images/night_inactive-1.png")?>" style="width: 60%;"> After 6pm</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="sidebar-item" style="height: 135px;">
                                ...
                                <div class="sidebar-content">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter" id="arrival111q6">
                                                <input type="checkbox"  class="dep2" name="arrivalIdq6" id="arrival11q6" onclick="getPageq6();" value="0,1,2,3,4,5:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="arrival1111q6"><img src="<?php echo base_url("assets/images/morning_inactive-1.png")?>" style="width: 60%;"> Before 6am</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter111q6">
                                                <input type="checkbox" class="dep2"  name="arrivalIdq6"   id="aafter11q6" onclick="getPageq6();" value="6,7,8,9,10,11:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="aafter1111q6"><img src="<?php echo base_url("assets/images/noon_inactive-1.png")?>" style="width: 60%;"> 6am - 12pm</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter555q6">
                                                <input type="checkbox" class="dep2"  name="arrivalIdq6" id="aafter5q6" onclick="getPageq6();" value="12,13,14,15,16,17:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="aafter5555q6"><img src="<?php echo base_url("assets/images/evening_inactive-1.png")?>" style="width: 60%;"> 12pm - 6pm</span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-xs-3" style="padding: 5px;">
                                            <label class="filter-p dep1 flexCol alignItemsCenter justifyCenter " id="aafter99q6">
                                                <input type="checkbox" class="dep2"  name="arrivalIdq6" id="aafter9q6" onclick="getPageq6();" value="18,19,20,21,22,23:59">
                                                <span class="dep3 font11 dF alignItemsCenter justifyCenter">
                                                    <span class="black" id="aafter999q6"><img src="<?php echo base_url("assets/images/night_inactive-1.png")?>" style="width: 60%;"> After 6pm</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="sidebar-item">
                                ...
                                <div class="sidebar-content">
                                    ...
                                    <div class="mealBasis__filter" style="display: flex;align-items: center;">
                                        ...
                                        <span class="starrating__check" style="display: flex;align-items: center;line-height: 10px;">
                                            <span class="checkmark">
                                            <input type="checkbox" name="airlineq6" onclick="getPageq6();" class="checkmark__input" value="<?php echo $flightValue6['flightCode'] ; ?>">
                                            <label for="airline" class="checkmark__label"> </label>
                                            </span>
                                        </span>
                                    </div>
                                        ...
                                        <ul>
                                            ...
                                            foreach ($flightValue['pricelist'] as $key => $fareList) {
                                                ...
                                                <li>
                                                    ...
                                                    <div style="display: flex;align-items: center;margin-bottom: 5px;">
                                                    <input type="radio" name="fav_language6" id="pricecheck<?php echo $fp; ?>" value="<?php echo $fareList['flightId'] ; ?>"  style="width: 18px;height: 18px;margin-top: 0px;" <?php if($fareList['flightId'] == $flightValue['pricelist'][0]['flightId']){ echo "checked"; } ?> onClick="getFlightSelectionMultiCity6('<?php echo $fareList['flightId'] ; ?>','<?php echo $fp; ?>');getlightDetails('<?php echo $fareList['flightId'] ; ?>');getFlightDetails('<?php echo $fareList['flightId'] ; ?>','<?php echo $fareList['totalFare'] ; ?>','<?php echo $fareList['adultBaseFare'] ; ?>','<?php echo $fareList['adultTaxFare'] ; ?>','<?php echo $fareList['countadultPax'] ; ?>','<?php echo @$fareList['childBaseFare'] ; ?>','<?php echo @$fareList['childTaxFare'] ; ?>','<?php echo @$fareList['countchildPax'] ; ?>','<?php echo @$fareList['infantBaseFare'] ; ?>','<?php echo @$fareList['infantTaxFare'] ; ?>','<?php echo @$fareList['countinfantPax'] ; ?>'); getFlightBaggageInfo('<?php echo $fareList['adultCheckInBaggage']; ?>','<?php echo $fareList['childCheckInBaggage']; ?>','<?php echo $fareList['adultCabinBaggage'];?>','<?php echo $fareList['childCabinBaggage'];?>','<?php echo $fareList['infantCabinBaggage'];?>','<?php echo $fareList['flightId'];?>','<?php echo $flightValue['departureAirportCode']  ?>','<?php echo $flightValue['arrivalAirportCode']; ?>'); getFlightFareRules('<?php echo $fareList['flightId']; ?>','<?php echo $flightValue['departureAirportCode']  ?>','<?php echo $flightValue['arrivalAirportCode']; ?>'); " >&nbsp;&nbsp;
