				...
				<div class="panel-body">
                  ...
                  <?php                         
                    ...
                    <tr class="<?php echo $css; ?>">
						...
						<!--<td><?php //echo $val['MenuTitle'] ?></td>-->
						<td><?php echo $val['MenuTitle'] ?></td>
						<td><?php  if($val['view']=='Y') echo"Yes"; else echo"No"; ?></td>
						<td><?php  if($val['IsInFooter']=='Y') echo"Yes"; else echo"No"; ?> </td>
						<td><?php echo $val['Ordering'] ?></td>
						<td><?php  if($val['IsActive']=='Y') echo"Active"; else echo"Inactive"; ?></td>
						<td nowrap> 
         					<a href="<?php  echo base_url('admin/menu/edit')."?id=".$val['MenuID'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            				<a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/menu/delete')."?id=".$val['MenuID'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
                        </td>
						<td> 
							<?php
					...
					?>
                                <tr class="<?php echo $css; ?>">
                            		<td><?php echo $sval['MenuID'] ?></td>
									<td>|___<?php echo $sval['MenuName'] ?></td>
									<td><?php echo $sval['AssociatedId'] ?></td>
									<td><?php  if($sval['view']=='Y') echo"Yes"; else echo"No"; ?></td>
									<td><?php  if($sval['IsInFooter']=='Y') echo"Yes"; else echo"No"; ?> </td>
									<td><?php echo $sval['Ordering'] ?></td>
									<td><?php  if($sval['IsActive']=='Y') echo"Active"; else echo"Inactive"; ?></td>
									<td nowrap> 
         								<a href="<?php  echo base_url('admin/menu/edit')."?id=".$sval['MenuID'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            							<a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/menu/delete')."?id=".$sval['MenuID'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
                                	</td>
									<td> 
                                     <?php
										$data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$sval['MenuID'],  'checked'=> false, 'class'=>" margin_bottom" );
										echo form_checkbox($data);
                                     ?>
                                  </td>
								</tr>
