...
<span class="BNA"></span>
                                                                                    ...
                                                                                    foreach ($tripSeatRowcolumn as $key => $seatValue) { 
                                                                                        ...
                                                                                        <li class="row row--1">  
                                                                                            ...
                                                                                            ?>
                                                                                                ...
                                                                                                <label for="<?php echo $seatValue1['seatNo']; ?>" class="<?php echo $amountSeatClass[$seatValue1['amount']]; ?> <?php echo $seatValue1['seatNo']; ?>  B<?php echo $seatValue1['seatNo']; ?>"><?php echo $seatValue1['seatNo']; ?></label>
			...
			//	alert(seatValue);
				...
				$(function () {
						...
						if ($("#"+seatNo).is(":checked")) {
							...
							var seatTitle= $(".B"+seatNo).attr("dataseat"); 
							 
							$(".B"+seatNo).addClass("B"+seatNo+paxTypecheck+"-"+autoIdcheck);
							$(".B"+seatNo).addClass(paxTypecheck+"-"+autoIdcheck);
							
							
							 if(seatTitle == undefined)
							{
								alert("undefined color");
								$(".B"+seatNo).attr("dataseat",paxTypecheck+"-"+autoIdcheck);
							
							}
							else {
								alert("defined color");
								$(".B"+seatNo).attr("dataseat");								
							}
							
							
							
							var paxtypes_childs = $(".seat-map__seat-data--selected").find('span').text();
							var str_lowercase_childs = paxtypes_childs.toLowerCase();
						//	alert("left dataseat start");
						//	alert(str_lowercase_childs);
						
						
							
							
						//	alert("seat dataseat start");
						//	alert(seatTitle);
							
							
						//	if(str_lowercase_childs == seatTitle)
						//	{										
							 $(".B"+seatNo).css('background-color', 'red');
						//	} else {
								
						//		 $(".B"+seatNo).css('background-color', 'yellow');
	...
	$(function () {
                ...
                if(paxTypecheck=='child'){
						...
						alert("start left mmm why change");		
						alert(mmm);	
						alert("end left mmm  why changes");
						
					//	var paxtypes_childs = $(".seat-map__seat-data--selected").find('span').text();
					//	var str_lowercase_childs = paxtypes_childs.toLowerCase();
					//	alert(str_lowercase_childs);	
					//	var	paxtypes_child=$(en).find('span').text();
					//	var str_lowercase_child =paxtypes_childs.toLowerCase();
						
					//	var vss= $(".7C").attr("dataseat");
			...
			var seatAmountS = "0.00";			
                    ...
                    $("#adultchildseatselection").show();
						...
						var paxtypes_childs = $(".seat-map__seat-data--selected").find('span').text();
							...
							var seatTitle= $(".B"+mmm).attr("dataseat");
							alert("seat dataseat start");
							alert(seatTitle);
						...
						if(str_lowercase_childs == seatTitle)
							{
								if(mmm != seatNo)
								{
									...
									$(".B"+mmm).css({"background-color": "green"});
								}
							} else {
								alert("not same");
								...
								if(mmm == seatNo)
								{
									$(".B"+mmm).css({"background-color": "red"});
								} else {
									$(".B"+mmm).css({"background-color": "brown"});
								}
