...
<body>
	<div id="wrapper">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Suppliers View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/suppliers/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">  Add Suppliers </a>
     ...
     <?php 
			...
			echo form_open_multipart(base_url('admin/suppliers/search'), $attributes);
	          ?>
              ...
              <?php foreach($leadstatus as $sval) { ?>  
                 ...
                 <h4 style="font-size:16px; margin:0px;"><span class="lnr lnr-user"></span> <span style="font-size: 22px;"> <?php echo $sval['totalrecords']; ?> </span> </h4>
                                <h4 style="font-size:16px; margin:0px;"><?php echo $sval['SuppliersType']; ?></h4>
                            </div>
                        </div>
               <?php } ?>         
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/suppliers/bulk_action', $attributes); 
					?>                                
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							   <tr class="<?php echo $css; ?>">
                                    <td><?php echo $val['SuppliersId'] ?></td> 
                                    <td><?php echo $val['ContactPersonName'] ?></td>
            ...
            <a href="<?php echo base_url('admin/suppliers/edit')."?id=".$val['SuppliersId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/suppliers/delete')."?id=".$val['SuppliersId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['SuppliersId'],  'checked'=> false, 'class'=>" margin_bottom" );
