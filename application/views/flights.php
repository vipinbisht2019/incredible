...
.ui-datepicker{ top: 215.79px!important;z-index: 2!important; }
...
.tabr-links li.active a, .tabr-links li.active a:hover {
  ...
  <body class="not-front page-pages page-flights">
    <div id="main">
      ...
      <?php if($bookingType!='M'){ 
          ...
          include('includes/flight_bluebar_search.php'); 

      }else{
        include('includes/flight_bluebar_search_multi.php');
  ...
  <section class="flight-destinations">
      ...
      <div id="flightSelectionBhanu">
        <div class="flight-head scnd-stcky">                
          <div class="row" style="display: flex;overflow: hidden;">
                    ...
                    <tbody style="border-right: 1px solid #e6e6e6;">
                      ...
                      <tr style="background:#282828">
                        <td style="border: none;padding: 0px 5px;">
                          ...
                          <ul style="display: flex;justify-content: space-around;padding-left: 0px;align-items: center;">
                            <li><img src="<?php echo base_url('uploads/flights/'); ?><?php echo $completeResult[0]['flghtCode']; ?>.png" style="width: 30px;margin-top: 5px;"></li>
                            <div>
                              <li style="color:#fff;text-align: left;padding-left: 0px!important;font-size: 12px;"><?php echo $completeResult[0]['flghtName']; ?></li>
                              <li style="color:#fff;line-height: 17px;color: #999;float: left;overflow: hidden;max-width: 55px;white-space: nowrap;text-overflow: ellipsis;clear: both;font-size: 12px;"><?php echo $completeResult[0]['flghtCode']; ?> - <?php echo $completeResult[0]['flghtNumber']; ?></li>
                            </div>
                          </ul>
                        ...
                        <td style="border: none;padding: 0px 5px;" class="ars-list">
                          ...
                          <h6 style="font-size: 14px;margin-bottom: 5px;color:#fff;"><?php echo $depatureTime = date("H:i",strtotime($completeResult[0]['departureTime'])); ?></h6>
                          <p style="margin-bottom: 3px;font-size: 14px;color: #696969;font-weight: 500;"><?php echo $completeResult[0]['departureAirportCode']; ?></p>
                        ...
                        <td style="border: none;padding: 0px 5px;" class="ars-list">
                          ...
                          <h6 style="font-size: 14px;margin-bottom: 5px;color:#fff;"><?php echo $depatureTime = date("H:i",strtotime($completeResult[0]['arrivalTime'])); ?></h6>
                          <p style="margin-bottom: 3px;font-size: 14px;color: #696969;font-weight: 500;"><?php echo $completeResult[0]['arrivalAirportCode']; ?></p>
                        </td>
                        <td style="border: none;padding: 0px 5px;">
                    ...
                    <tbody style="border-right:  1px dashed rgb(194, 194, 194);">
                      <tr style="background:#282828">
                        <td style="border: none;padding: 0px 5px;">
                          ...
                          <ul style="display: flex;justify-content: space-around;padding-left: 0px;align-items: center;">
                            <li><img src="<?php echo base_url('uploads/flights/'); ?><?php echo $completeResultReturn[0]['flghtCode']; ?>.png" style="width: 30px;margin-top: 5px;"></li>
                            <div>
                              <li style="color:#fff;text-align: left;padding-left: 0px!important;font-size: 12px;color:#fff;"><?php echo $completeResultReturn[0]['flghtName']; ?></li>
                              <li style="color:#fff;line-height: 17px;color: #999;float: left;overflow: hidden;max-width: 55px;white-space: nowrap;text-overflow: ellipsis;clear: both;font-size: 12px;"><?php echo $completeResultReturn[0]['flghtCode']; ?> - <?php echo $completeResultReturn[0]['flghtNumber']; ?></li>
                            </div>
                          </ul>
                        ...
                        <td style="border: none;padding: 0px 5px;" class="ars-list">
                          ...
                          <h6 style="font-size: 14px;margin-bottom: 5px;color:#fff;"><?php echo  $arrivalDate = date("H:i",strtotime($completeResultReturn[0]['departureTime']));?></h6>
                          <p style="margin-bottom: 3px;font-size: 14px;color: #696969;font-weight: 500;"><?php echo $completeResultReturn[0]['departureAirportCode']; ?></p>
                        ...
                        <td style="border: none;padding: 0px 5px;" class="ars-list">
                          ...
                          <h6 style="font-size: 14px;margin-bottom: 5px;color:#fff;"><?php echo  $arrivalDate = date("H:i",strtotime($completeResultReturn[0]['arrivalTime']));?></h6>
                          <p style="margin-bottom: 3px;font-size: 14px;color: #696969;font-weight: 500;"><?php echo $completeResultReturn[0]['arrivalAirportCode']; ?></p>
                        </td>
                        <td style="border: none;padding: 0px 5px;">
            ...
            <div class="col-md-3">
              <div class="row" style="display: flex;align-items: center;height: 42px;">
                <div class="col-md-6" style="padding-right: 0;">
                  <table>
                    <tbody>
                      <tr style="background:#282828">
                        <td style="border: none;padding: 0px 5px;"><h3 style="margin-top: 0px;margin-bottom: 0;padding-bottom: 0;text-align: right;font-weight:600;color:#fff;padding-top: 0px;"><i class="fa fa-inr"></i><?php $totaFare = $completeResultReturn[0]['pricelists'][0]['totalFare'] + $completeResult[0]['pricelist'][0]['totalFare']; echo number_format($totaFare,2); ?></h3></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
    ...
    <?php } ?>
    <!----------------------------------------------------END RETURN STICKY --------------------------------------------------------------->
    <!-------------------------------------------------START MULTICITY STICKY -------------------------------------------------------->

    <?php 
    
      if($bookingType != 'O'  && $bookingType != 'R'){ 

        error_reporting(0);
        include('includes/flight_multi_sticky.php'); 
        
      } 

    ?>

    <!-------------------------------------------------END MULTICITY STICKY -------------------------------------------------------->
      ...
      <div class="row">
        <div class="col-lg-12"> 
          <?php 
            ...
            if($bookingType != 'M' && $bookingType != 'R' ){ 
          ...
          <?php 
            ...
            // if($bookingType != 'R' && $bookingType != 'O'){ 

            //   include('includes/flight_multimenu.php');
        ...
        <div>
          ...
          <?php 
            ...
            if($bookingType == 'M'){
              ...
              include('includes/flight_multicity_list.php');
        ...
        <div class="col-lg-9">           
                              ...
                              <td>
                                ...
                                <?php $newflight_Id=array(); $fp = 0; foreach ($flightValue['pricelist'] as $key => $fareList) {
                                  ...
                                  <li>
                                    ...
                                    <div class="row">
                                      <div class="col-md-12">
                                      <?php  if($fareList['fareIdentifier'] == 'LITE' || $fareList['fareIdentifier'] == 'SALE'){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: green;background: #c0f1c0;"><?php  echo "SNS PRO"; ?></span><?php }else if($fareList['fareIdentifier'] == 'PUBLISHED'){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #002880;background: #cbd2e1;"><?php  echo "SNS Saver"; ?></span><?php } else if($fareList['fareIdentifier'] == 'FLEXI_PLUS' || $fareList['fareIdentifier'] ==  'PREMIUM_FLEX' ){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #a55319;background: #e5d9cf;"><?php  echo "SNS Flexi"; ?></span><?php }  else if($fareList['fareIdentifier'] == 'FAMILY'){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #796b51;background: #FFE5B4;"><?php  echo "SNS Family"; ?></span><?php }else if($fareList['fareIdentifier'] == 'SPECIAL_RETURN'){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #b1941e;background: #fff5cf;"><?php  echo "SNS Return"; ?></span><?php }else{  echo $fareList['fareIdentifier']; }  ?>
          ...
          <!-------------------------------End One Way Search List----------------------------->

          <!------------------------------------------------- START RETURN FLIGHT LIST ---------------------->
          
          <?php if($bookingType != 'O' && $bookingType != 'M'){ ?>

              <div class="row">

                <!------------------------------------------  START RETURN FLIGHT ONWARDS LISTS -------------------------------------------->
                <?php //echo "<pre>"; print_r($completeResult);?>
                  <div id="flightSingleReturn"> 
                    <div class="col-md-6">
                      
                      <div class="flight-table">
                        <p class="fontSize16 blackText appendLR20 appendBottom20 paddingTop20"><b><?php echo $departure; ?> → <?php echo $destination; ?></b> <?php  echo date("D, d M",strtotime($completeResult[0]['departureTime'])); ?></p>
                        <table>
                          <thead>
                            <tr>
                              <th>Airlines</th>
                          ...
                          <tbody>
                           ...
                           // echo "<pre>"; print_r($completeResult[0]['pricelist'][0]['flightId']); 
                            
                            $i=0; foreach($completeResult as $key => $flightValue) { 
                            ...
                            <tr style="height: 120px">
                              <td class="text-center">
                                <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;flex-direction: row;">
                                  <li><img src="<?php echo base_url('uploads/flights/');?><?php echo $flightValue['flghtCode'] ; ?>.png" alt=""></li>
                                  <li style="font-size:12px;font-weight:600;text-align: left;left: 5px;position: relative;"><?php echo $flightValue['flghtName']; ?>
                                  <p style="font-size:10px;font-weight:400;line-height: 13px;"><?php echo $flightValue['flghtCode'] ?> - <?php echo $flightValue['flghtNumber']?></p>
                                    </li>
                                  </ul>
                                ...
                                <ul>
                                    <?php  $fp = 0; 
                                      ...
                                      <li>
                                        ...
                                        <div class="row">
                                          <div class="col-md-12">
                                          <?php  if($fareList['fareIdentifier'] == 'LITE' || $fareList['fareIdentifier'] == 'SALE'){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: green;background: #c0f1c0;"><?php  echo "SNS PRO"; ?></span><?php }else if($fareList['fareIdentifier'] == 'PUBLISHED'){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #002880;background: #cbd2e1;"><?php  echo "SNS Saver"; ?></span><?php } else if($fareList['fareIdentifier'] == 'FLEXI_PLUS' || $fareList['fareIdentifier'] ==  'PREMIUM_FLEX' ){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #a55319;background: #e5d9cf;"><?php  echo "SNS Flexi"; ?></span><?php }else if($fareList['fareIdentifier'] == 'FAMILY'){ ?> <span class="label label-warning ars-flightlabel ars-refunsleft" style="color: #796b51;background: #FFE5B4;"><?php  echo "SNS Family"; ?></span><?php } else{  echo $fareList['fareIdentifier']; }  ?>
                                            <div class="atls-holder">
                                              <span class="ars-refunsleft ars-lastre">
                                                <?php 
                                                  if($fareList['adultcabinClassFare'] !=''){
                ...
                <!------------------------------------------  END RETURN FLIGHT ONWARDS LISTS -------------------------------------------->
                <!------------------------------------------  START RETURN FLIGHT RETURN LISTS -------------------------------------------->
          
                <div id="flightDoubleReturn">

                  <div class="col-md-6">
                    <div class="flight-table">
                      <p class="fontSize16 blackText appendLR20 appendBottom20 paddingTop20"><b><?php echo $destination; ?> → <?php echo $departure; ?></b> <?php  echo date("D, d M",strtotime($completeResultReturn[0]['departureTime'])); ?></p>
                      <table>
                        <thead>
                          <tr>
                            <th>Airlines</th>
                          ...
                          <tr style="height: 120px">
                            <td class="text-center">
                              <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;flex-direction:row">
                                ...
                                <li style="font-size:12px;font-weight:600;text-align: left;left: 5px;position: relative;"><?php echo $flightValue1['flghtName'] ?>
                                <p style="font-size:10px;font-weight:400;line-height: 13px;"><?php echo $flightValue1['flghtCode']; ?> - <?php echo $flightValue1['flghtNumber']; ?> </p>
                                </li>
                              </ul>
                            </td>
                            <td>
                            ...
                            <td>
                              <h6 style="font-size: 18px;color: #363636;font-weight: 600;justify-content: center;"> <?php echo $arrivalTime; ?></h6> 
                              <p><?php echo $flightValue1['arrivalCity']; ?></p>
                            </td>
                            <td>
                              <ul>
                                <?php  $fp1 = 0; foreach ($flightValue1['pricelists'] as $key => $fareList1) { 
                                  
                                  if($fareList1['fareIdentifier']!='CORPORATE' && $fareList1['fareIdentifier'] != 'SPECIAL_RETURN'){ 
                                    ...
                                    <div class="tab-content">
                                      ...
                                      <div id="farerules1">
                                                <div id="divMsg" style="background-color: rgb(234 240 253); color: rgb(255, 255, 255); height: auto; width: 93%; text-align: center; display: block; border-radius: 4px;">
                                                  <button class="ars-activelist fare-rules-tabs" style="display: block;margin-right: auto;width: 11%;"><?php echo $flightValue['departureAirportCode']; ?>-<?php echo $flightValue['arrivalAirportCode']; ?></button>
                                                  <div class="farerules__contain--data">
                                                      <div class="star-text">Mentioned fees are Per Pax Per Sector</div>
                                                      <div class="star-text">Apart from airline charges, GST + RAF + applicable charges if any, will be charged.</div>
                                                      <div class="farerule__innercontent">
                ...
                <!------------------------------------------  END RETURN FLIGHT RETURN LISTS -------------------------------------------->

              </div>
          <?php } ?>

          <!------------------------------------------------------ END RETURN FLIGHT LIST -------------------------------------->
...
$(".input-number").keydown(function (e) {
   ...
   function getFlightSelectionBhanu(id,fn){
      ...
      var flightId = id;
	  //   var flightIds = $("#flightsIds").val();				// second flight id
		
      //var flightIds =  $("#pricecheck"+fn).val();
  		//alert(flightIds);
	    //	alert(flightId); 
	/*	
	alert("Start first id");
		alert(flightId); 
	alert("End first id");
	  
	alert("Start second id");
  		alert(flightIds);
	alert("End second id");
	*/
	
	
	  var flightIds = $('input[name="fav_languages"]:checked').val();
     //   alert(flightIds);
  ...
  //  var flightId =  $("#pricecheck"+fn).val();
	 ...
	 var flightId = $('input[name="fav_language"]:checked').val();
      //  alert(flightId);
    ...
    function getFlightSelectionMultiCity(id,fn){
     ...
     // var flightIds = $("#flightsIds").val();
      var flightIds = $('input[name="fav_languages"]:checked').val();
      var flightId3 = $('input[name="fav_language3"]:checked').val();
      var flightId4 = $('input[name="fav_language4"]:checked').val();
      var flightId5 = $('input[name="fav_language5"]:checked').val();
      var flightId6 = $('input[name="fav_language6"]:checked').val();
      // alert(flightId);
      // alert(flightIds);
      ...
      $.ajax({
        ...
        type: 'post',
        dataType: "HTML",
        data: {'flightId':flightId,'flightIds':flightIds,'flightId3':flightId3,'flightId4':flightId4,'flightId5':flightId5,'flightId6':flightId6},
        success: function( data ) {
          console.log(data);
     ...
     // var flightIds = $('input[name="fav_languages"]:checked').val();
      ...
      $.ajax({
        ...
        success: function( data ) {
          ...
          $('#flightSelectionBhanu1').html(data);
          // response( data ); 
        }
      });  
    ...
    function getFlightSelectionMultiCity3(id,fn){
      ...
      $.ajax({
        ...
        success: function( data ) {
          ...
          $('#flightSelectionBhanu2').html(data);
          // response( data ); 
        }
      });  
    ...
    function getFlightSelectionMultiCity4(id,fn){
      ...
      $.ajax({
        ...
        success: function( data ) {
          ...
          $('#flightSelectionBhanu3').html(data);
          // response( data ); 
        }
      });  
    ...
    function getFlightSelectionMultiCity5(id,fn){
    ...
    $.ajax({
      ...
      success: function( data ) {
        ...
        $('#flightSelectionBhanu4').html(data);
        // response( data ); 
      }
    });  
    ...
    function getFlightSelectionMultiCity6(id,fn){
      ...
      $.ajax({
        ...
        success: function( data ) {
          ...
          $('#flightSelectionBhanu5').html(data);
          // response( data ); 
        }
      });  
