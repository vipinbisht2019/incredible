...
<html lang="en">
<head>
<title>Buses Type/Name Modify</title>
<meta charset="utf-8">
             	...
             	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b><i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Buses Type/Name Modify</b></h3>
						</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
							        ...
							        // echo"<pre>";
									   //print_r($lower_deck_seatno);
									// echo"</pre>";
							          // ------------------------------ admin form open ---------------------------------
										$attributes = array('class' => 'form-auth-small form-inline', 'name'=>'form1', 'id' => 'form1');
										echo form_open_multipart('admin/busestype/edit', $attributes);
							     ?>
                                  ...
                                  <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
											...
											foreach($dropdown_category as $val)
											 ...
											 $selected=$edit_busestype[0]['CatId'];	
		                		 ...
		                		 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'TypeTitle', 'id' => 'TypeTitle', 'value'=>$edit_busestype[0]['TypeTitle'], 'placeholder' => 'Name', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
		                		...
		                		<?php /*?> <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'NumberOfSeats', 'id' => 'NumberOfSeats', 'value'=>$edit_busestype[0]['NumberOfSeats'], 'placeholder' => 'Number Of Seats', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>  
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                     ...
                                     <?php 
										      foreach($dropdown_bustype as $val)
                                               ...
                                               <option  value="<?php echo $val['MapId']; ?>" <?php if($edit_busestype[0]['MapId']==$val['MapId']){ echo"selected"; } ?>><?php echo $val['SeatingTitle']."  -- Seats [".$val['TotalSeats']."]" ?></option>
                                               <?php } ?>
                                  ...
                                  <?php /*?> <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span>Seats Map </span></label>
		                			   <div class="col-md-5 form-group padding_opx">
                                       <?php
                                            unset($options);									
									        $options['']='Select Seat Map';
											foreach($dropdown_bustype as $val)
										       {
												   $options[$val['MapId']] = $val['SeatingTitle']."  -- Seats [".$val['TotalSeats']."]";
											   }		
											 $selected=$edit_busestype[0]['MapId'];	
										     echo form_dropdown('MapId', $options,$selected,'class="form-control margin_bottom"');
										?> 
                         ...
                         <!-- *********************************************************Seat Map***************************************************************** -->     
                                 ...
                                 <div id="map_replace" style="margin-top:10px;"> 
                                            ...
                                            <?php include('buses_seatmap_modify.php') ?>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			...
		                			<div class="col-md-8 form-group padding_opx">
                                     ...
                                     <?php
											 ...
											 if(in_array($val['AmentiesId'],$edit_amenties))  
											      {
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			...
		                			<div class="col-md-8 form-group padding_opx">
                                        ...
                                        <?php
											 ...
											 if(in_array($val['TermsconditionID'],$edit_termcondition))  
											      {
                         ...
                         <?php
											 ...
											 if(in_array($val['CancellationID'],$edit_cancellationpolicies))  
											      {
                             ...
                             <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'ShortDescription', 'id' => 'ShortDescription', 'value'=>$edit_busestype[0]['ShortDescription'], 'placeholder' => 'Short Description', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div> 
                                 ...
                                 <div class="col-md-12 padding_opx">
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Current Photo-1 (900 X 410) </span></label>
		                			      <div class="col-md-5 form-group padding_opx">
                                    
								             <?php
											  if($edit_busestype[0]['Photo1']!='') { ?>
                                               <img src="<?php echo base_url('uploads/bus/'.$edit_busestype[0]['Photo1']) ?>"  class="margin_bottom"  width="200px"> <br>
											  <?php } else { ?>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Current Photo-2 (900 X 410) </span></label>
		                			      <div class="col-md-5 form-group padding_opx">
                                    
								             <?php
											  if($edit_busestype[0]['Photo2']!='') { ?>
                                               <img src="<?php echo base_url('uploads/bus/'.$edit_busestype[0]['Photo2']) ?>"  class="margin_bottom"  width="200px"> <br>
											  <?php } else { ?>
                                               Image does not exist
                                              <?php } ?>
                                     </div>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Current Photo-3 (900 X 410) </span></label>
		                			      <div class="col-md-5 form-group padding_opx">
                                    
								             <?php
											  if($edit_busestype[0]['Photo3']!='') { ?>
                                               <img src="<?php echo base_url('uploads/bus/'.$edit_busestype[0]['Photo3']) ?>"  class="margin_bottom"  width="200px"> <br>
											  <?php } else { ?>
                                               Image does not exist
                                              <?php } ?>
                                     </div>
                               ...
                               <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ adm_status form  ---------------------------------
											...
											$selected=$edit_busestype[0]['Status'];							
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
										...
										//-------------------------------------------------------------------------------------------------------------------
										$data = array('id'  => $edit_busestype[0]['TypeId'] );
										echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
