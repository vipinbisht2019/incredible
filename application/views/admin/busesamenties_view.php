...
<html lang="en">
 <head>
	<title>Buses Amenties View</title>
	<meta charset="utf-8">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Buses Amenties View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/busesamenties/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Buses Amenties </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                      ...
                      <div class="col-md-12 col-xs-12 margin_top">  <?php
                                    if($error = $this->session->flashdata('busesamenties')){  ?>
                    ...
                    <?php                         
						  ...
						  echo form_open_multipart('admin/busesamenties/bulk_action', $attributes); 
					?>                                
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                            	...
                            	<td><?php echo $val['AmentiesId'] ?></td>
								<td><?php echo $val['AmentiesName'] ?></td>
                            	<td><?php if($val['Status']=='Y') echo"Active"; else echo"Inactive"; ?></td>
							  <td> 
                                  
                                  
                                  
            <a href="<?php echo base_url('admin/busesamenties/edit')."?id=".$val['AmentiesId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/busesamenties/delete')."?id=".$val['AmentiesId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['AmentiesId'],  'checked'=> false, 'class'=>" margin_bottom" );
