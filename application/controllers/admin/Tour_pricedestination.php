					 ...
					 //-------------------------------------------------------------------------------------------------------------------------------		
						...
						$SeasonalEndDateArr=explode("-",$this->input->post('SeasonalEndDate'));
						 ...
						 //---------------------------Tour location add --------------------------   
			                       ...
			                       $locationsIdArr= $this->input->post('locationsId');
								   $this->Tour_pricedestinationmanage->tours_location_insert($locationsIdArr,$TourId_1);
						  //---------------------------Tour location add --------------------------   	
				     ...
				     //---------------------------------------------------------------------------------------------------------------------------------------	
					  ...
					  {   
							...
							$data['tour_accomadtion_faretype']=$this->Tour_pricedestinationmanage->get_accomadtion_faretype();
							 $data['tours_location']=$this->Tour_pricedestinationmanage->tours_location_edit($TourId);
