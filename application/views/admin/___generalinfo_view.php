...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Tours View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/tour_generalinfo/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Tour General Info</a>
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                            	...
                            	<td><?php echo $val['TourId'] ?></td>
								<td><?php echo $val['TourName'] ?></td>
                                <td><?php echo $val['Rating'] ?></td>
                                <td><?php if($val['Image']!='') { ?> <img src="<?php echo base_url('uploads/tourimage/'.$val['Image']) ?>" width="200px"><?php } ?></td>
                                <td><?php //echo $val['TourName'] ?></td>
                                <td><?php // echo $val['TourName'] ?></td>
                                <td><?php //echo $val['TourName'] ?></td>
                                
                                  <td><?php echo $val['NoofDay'] ?> Days /  <?php echo $val['NoofNight'] ?>  Night</td>
            ...
            <a href="<?php echo base_url('admin/generalinfo/edit')."?id=".$val['TourId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/generalinfo/delete')."?id=".$val['TourId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['TourId'],  'checked'=> false, 'class'=>" margin_bottom" );
