			   ...
			   <div class="col-md-12">
					...
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Members View</b></h3>
						</div>
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
									 ...
									 // echo"<pre>";
									   // print_r($edit_members);
									  //echo"</pre>";
                          
							
							          // ------------------------------ admin form open ---------------------------------
										$attributes = array('class' => 'form-auth-small form-inline', 'name'=>'form1', 'id' => 'form1');
										echo form_open_multipart('admin/members/edit', $attributes);
							     ?>
                             ...
                             <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ adm_status form  ---------------------------------
											   ...
											   $selected=$edit_members[0]['ResionId'];
     	                   	...
     	                   	<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'CompanyName', 'id' => 'CompanyName', 'value' =>$edit_members[0]['CompanyName'],  'placeholder' => 'Company Name', 'class'=>"form-control margin_bottom");
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'MembershipNo', 'id' => 'MembershipNo', 'value' =>$edit_members[0]['MembershipNo'],  'placeholder' => 'Membership No.', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'RepresentativeName', 'id' => 'RepresentativeName', 'value' =>$edit_members[0]['RepresentativeName'],  'placeholder' => 'Representative Name', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'user_email', 'id' => 'user_email', 'value' =>$edit_members[0]['user_email'], 'placeholder' => 'Email Address', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'user_loginid', 'id' => 'user_loginid','value' =>$edit_members[0]['user_loginid'],  'placeholder' => 'Login Id', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
		                		...
		                		<div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ Password form open ---------------------------------
                                        $password_data = array('name'  => 'user_passwd', 'id' => 'user_passwd','value' =>$edit_members[0]['user_passwd'],  'placeholder' => 'Password ', 'class'=>"form-control margin_bottom");
                               ...
                               <div class="col-md-12 padding_opx">
                                   ...
                                   <?php
								     // ------------------------------ Confirm Password form open ---------------------------------
                                      $cpassword_data = array('name'  => 'conpwd', 'id' => 'conpwd', 'value' =>$edit_members[0]['user_passwd'],  'placeholder' => 'Confirm Password ', 'class'=>"form-control margin_bottom");
                                 ...
                                 <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'user_address1', 'id' => 'user_address1','value' =>$edit_members[0]['user_address1'],  'placeholder' => 'Address ', 'class'=>"form-control margin_bottom");
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                          <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'user_phone', 'id' => 'user_phone',  'value' =>$edit_members[0]['user_phone'], 'placeholder' => 'Phone Number', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                          ?>
                                      </div>
		                		</div>
                               ...
                               <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                          <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'user_city', 'id' => 'user_city', 'value' =>$edit_members[0]['user_city'],  'placeholder' => 'City', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                          ?>
                                      </div>
		                		</div>
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                          <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'user_state', 'id' => 'user_state', 'value' =>$edit_members[0]['user_state'],  'placeholder' => 'State', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                          ?>
                                      </div>
		                		</div>
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                          <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'user_zip', 'id' => 'user_zip', 'value' =>$edit_members[0]['user_zip'],  'placeholder' => 'Zipcode', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                          ?>
                                      </div>
		                		</div>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                          <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'user_country', 'id' => 'user_country',  'value' =>$edit_members[0]['user_country'], 'placeholder' => 'Country', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                          ?>
                                      </div>
		                		</div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-9 form-group padding_opx">
                                          <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'ProductItem', 'id' => 'ProductItem',   'value' =>$edit_members[0]['ProductItem'], 'placeholder' => 'Product Item', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                          ?>
                                          (<i>comma separated </i>)
                                      </div>
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-2 form-group padding_opx">
									...
									<?php
										...
										$data = array('id'  => $edit_members[0]['user_id'] );
											echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
