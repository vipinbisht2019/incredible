                            ...
                            <div>
                                <div class="post post-full">
                                    ...
                                    <div class="body">
									                    ...
									                    <span style="font-weight:600;"><?php $sentence= $hotelDetail['des'];
                                      $pos = 40; $begin = substr($sentence, 0, $pos+1); echo strip_tags($begin); ?><br></span>
                                      <details>
                                      <summary>
                                          ...
                                          <span id="close">read less</span> 
				                              ...
				                              <?php   $sentence= $hotelDetail['des'];
				                                echo strip_tags(substr($sentence,41,800));
                                    // $pos = 40; $begin = substr($sentence, 0, $pos+1); 
                                    // $end = substr($sentence, $pos+1);
                                    // echo $end ;  ?>
									                   <?php //  echo $hotelDetail['des']; ?>
                                    </details>
                                    </div>
                                        ...
                                        <table>
                                         <!-- <thead>
                                          ...
                                          <tbody>
                                            ...
                                            foreach ($hotelDetail['ops'] as $key => $roomValue) { 
                                            ...
                                            ?>
                                             ...
                                             <tr>
                                                ...
                                                <?php foreach ($roomValue['ris'] as $key => $optionsValue) { ?>
                                                  <p style="font-size: 13px;font-weight: 500;height: 135px;"><?php echo $optionsValue['rc']; ?></p>
                                                  <?php } ?>
                                              ...
                                              <!-- <td>
                                                   ...
                                                   <!-- <button type="button" onclick="getCancellation('<?php //echo $hotelDetail['id']?>','<?php //echo $roomValue['id'] ?>');"  data-toggle="modal" data-target="#modal-with-tab" style="text-align:left;"><a class="dwebCommonstyles__PrimaryLink-sc-112ty3f-8 npTjr">Cancellation Policy</a></button> --> </div></span></div>
                                                     ...
                                                     <!-- <div class="modal fade displaycontent" id="myModal">
                                                      ...
                                                      <?php  include('hotel_cancellation'); ?>
                                               ...
                                               <td>
                                                    ...
                                                    <?php foreach ($roomValue['ris'] as $key => $optionsValue) { ?>
                                                    <div style="background: #f5f5f5;border-radius: 8px;margin-bottom: 10px;padding: 10px;">
                                                        <!-- <span class="eQHknX"><i class="fa fa-inr"></i> 4875</span> -->
                                                        <div class="dcHqnQ"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="#141823" width="1.4rem" height="1.4rem" class="guwrRX"><path d="M21.482 7.945h3.536c.982 0 1.786.818 1.786 1.818s-.804 1.818-1.786 1.818h-3.536a9.429 9.429 0 01-2.625 5.109 9.509 9.509 0 01-6.75 2.891h-.679l9.661 9.255c0 .018.018.018.036.036.679.673.696 1.782.036 2.473a1.742 1.742 0 01-2.518.091L5.714 19a1.78 1.78 0 01-.554-1.364c.036-.964.839-1.727 1.786-1.691h5.179a5.902 5.902 0 004.214-1.836 6.327 6.327 0 001.482-2.527H6.946c-.982 0-1.786-.818-1.786-1.818s.804-1.818 1.786-1.818h10.875C17 5.455 14.714 3.782 12.125 3.764H6.946c-.982 0-1.786-.818-1.786-1.818S5.964.128 6.946.128h18.071c.982 0 1.786.818 1.786 1.818s-.804 1.818-1.804 1.818h-5.464a8.504 8.504 0 011.946 4.182z"></path></svg><?php echo $optionsValue['tp']; ?></div>
                                                        <p style="margin-bottom: 0;text-transform: capitalize;"><?php echo $optionsValue['mb']; ?></p>
                                                        <span style="font-size: 11px;"> for <?php echo count($roomValue['ris'][0]['pis']);  ?> Night(s) for <?php echo $roomValue['ris'][0]['adt']; ?> adult <?php echo $roomValue['ris'][0]['chd']; ?> child</span>
                                                         <a class="btn btn-primary" data-popup-open="popup-1<?php echo $rm; ?>" href="#" style="font-size:12px;background: transparent;color: #357ebd;border: none;"><span class="roomtype__link--pernightPrice"> 
                                                    ...
                                                    <div>
                                                      ...
                                                      <div class="popup" data-popup="popup-1<?php echo $rm; ?>">
                                                        ...
                                                        <!--      <th class="tabular__row--heading" style="text-align:center;">Date</th> -->
																...
																<?php // echo "<pre>"; print_r($roomValue); ?>
                                                                <?php foreach ($roomValue['ris'][0]['pis'] as $key => $perNightValue) { ?>                                                              
                                                               
                                                                <tr class="tabular__row">
                                                    <!--  <td class="tabular__row--text"><?php echo $perNightValue['fc']['TF']; ?></td> -->
                                                                  <td class="tabular__row--text"><?php echo $perNightValue['fc']['TF']; ?></td>
                                                                </tr>
                                                                <?php } ?>
                                                              </table>
                                                            </div>
                                                            <a class="popup-close" data-popup-close="popup-1<?php echo $rm; ?>" href="#">x</a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <?php //echo $hotelDetail['ops'][0]['id']; ?>
                                                        ...
                                                        $("#select_hotel22").click(function(){  


                                                          $(".hotel_11").css("background", "green"); 
                                                        //  alert(aaa);
                                                          $(".hotel_111").css("background", "#ff6d38");
                                                          
                                                        //	if(aaa == )
                                                        //	$("#select_hotel22").prop('disabled', true);
                                                          
                                                        
                                                            
                                                        $(".hotel_11").text($(".hotel_11").text() == 'select' ? 'selected' : 'select');
                                                        
                                                        $(".hotel_111").text($(".hotel_111").text() == 'selected' ? 'select' : 'selected');
                                                        ...
                                                        $("#select_hotel222").click(function(){  

                                                        $(".hotel_111").css("background", "green");  
                                                          $(".hotel_11").css("background", "#ff6d38");
                                                        ...
                                                        /*
                                                          if(aaa == 'selected')
                                                          {
                                                              $("#select_hotel222").removeAttr("disabled").button('refresh');
                                                          //	 $("#select_hotel222").attr("disabled", true);
                                                          //	$("#select_hotel22").attr('disabled', true);
                                                          } else{
                                                            $("#select_hotel222").attr("disabled", "disabled").button('refresh');
                                                          //	$("#select_hotel222").attr('disabled', true);
                                                        }*/
                                                        ...
                                                        <?php if($hotelDetail['ops'][0]['id'] == $roomValue['id'] ){ ?>
                                                                <button class="KETBj bIgcAI active hotel_11" id="select_hotel22">Selected</button>
                                                                                    <?php }else{ ?>
                                                                <button class="KETBj bIgcAI hotel_111" id="select_hotel222" onclick="getSelectedRoom('<?php echo $hotelDetail['id']; ?>','<?php echo $roomValue['id']; ?>','<?php $option = count($hotelDetail['ops'][0]['ris']); echo $roomValue['ris'][0]['tp'] * $option; ?>','<?php echo $roomValue['ris'][0]['rc']; ?>','<?php echo $roomValue['ris'][0]['mb']; ?>','<?php echo $hotelDetail['name']; ?>','<?php echo $hotelDetail['ad']['adr']; ?>, <?php echo $hotelDetail['ad']['city']['name']; ?> , <?php echo $hotelDetail['ad']['country']['name']; ?>','<?php echo $hotelDetail['rt']; ?>');">Select</button>  
                                                        <?php } ?>
                          ...
                          <div class="clearfix"></div>
                            ...
                            <div class="row">
                              <div class="summarybox">
                                <h2 class="summarybox__price">₹ <?php $option = count($hotelDetail['ops'][0]['ris']); echo  $hotelDetail['ops'][0]['ris'][0]['tp'] * $option; ?> </h2>
                            ...
                            <a href="<?php echo base_url('hotels/booking?hId='.$hotelDetail['id'].'&oid='.$hotelDetail['ops'][0]['id'].'&ad='.$adults.'&ch='.$childs.'&ro='.$rooms.'&gi='.$guestInfo)?>">
...
<script>
    ...
    function getSelectedRoom(hotelId,optionId,price,roomName,roomType,hotelName,address,rating){
      ...
      var guestinfo = "<?php echo $guestInfo ;?>" ;

      $.ajax({
        url: "<?php echo base_url('hotels/getRoomOptions')?>",
        type: 'post',
        dataType: "HTML",
        data: {'optionId':optionId,'hotelId':hotelId,'totalPrice':price,'roomName':roomName,'roomType':roomType,'hotelName':hotelName,'address':address,'rating':rating,'adults': adults, 'childs': childs,'rooms' : rooms,  'guestinfo' :guestinfo},
...
function getCancellation(hid,oid){
  ...
  $.ajax({
        ...
        success: function( data ) {
          console.log(data);
		  $(".displaycontent").html(data);  	// display data 06092021
		  
		//  $(".displaycontent").html(response);
		  
           //     $('#modal-with-tab').modal({backdrop: 'static', keyboard: true, show: true});
