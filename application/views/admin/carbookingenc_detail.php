...
<html lang="en">
  <head>
	<title>Tour Unpaid Booking Details</title>
	<meta charset="utf-8">
            	...
            	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Car Booking Detail </b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/carbookingenc/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
  ...
  <table id="Mytable">
    ...
    <tbody>
       ...
       <tr>
           ...
           <th class="font_16px" style="width: 10%;"> B.R. Number  </th>
