                                                        ...
                                                        <?php 
                                                            ...
                                                            foreach ($tripInfoResult as $key => $tripReviwvalue) {                                                            
                                                                ...
                                                                foreach($tripReviwvalue['sI'] as $key1 => $segValue){ 
                                                                    ...
                                                                    // echo "<pre>"; print_r($segValue['ssrInfo']); 
                                                        ?> 
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5 form-group ">
                                                                ...
                                                                <select name="baggage_return[]" id="baggage_return<?php echo $ib; ?>" onchange="getBaggage('<?php echo $ib; ?>');">
                                                                    ...
                                                                    <?php foreach ($SSRInfoBaggageReturn as $key => $baggagevalueRet) { ?> 
                                                                        ...
                                                                        <option value="<?php echo $baggagevalueRet['code']; ?>~<?php echo $baggagevalueRet['amount']; ?>~<?php echo $baggagevalueRet['desc']; ?>"><?php echo $baggagevalueRet['desc']; ?> <?php if(!empty($baggagevalueRet['amount'])){ ?>   @ <?php echo $baggagevalueRet['amount'];} ?></option>
                                                            ...
                                                            <div class="col-md-5 form-group padding_5px " >
                                                                ...
                                                                <select name="meal_return[]" id="meal_adult_return<?php echo $ib; ?>" onchange="getBaggage('<?php echo $ib; ?>');">
                                                                    ...
                                                                    <option value="<?php echo $mealvalueRet['code']; ?>~<?php echo @$mealvalueRet['amount']; ?>~<?php echo $mealvalueRet['desc']; ?>"><?php echo $mealvalueRet['desc']; ?> <?php if(!empty($baggagevalueRet['amount'])){ ?> @ <?php echo @$mealvalueRet['amount'];  } ?></option>
                                                                    <?php } ?>                                                        
                                                                </select>   
                                                            </div>
                                                        </div> 
