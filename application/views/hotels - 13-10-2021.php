...
(function() {
    ...
    function getPage(){
      ...
      jQuery.ajax({
        url: "<?php echo base_url('hotels/hotel_filter')?>",
              type: 'post',
              dataType: "html",
              data: {'ratingId':ratingId,'mealsId':mealsId,'propertyId':propertyId,'cityname':cityName,'checkinDate':checkinDate,'checkoutDate':checkoutDate,'adults':adults,'childs':childs,'specialCategory':specialCategory},
              success: function( data ) {
                //console.log(data);
                $("#hotelData").html(data);
              }
  ...
  <!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> -->
    ...
    //   var cityName = document.getElementById('search_hotelname').value;
