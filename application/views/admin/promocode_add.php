		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Promo Code Add</b></h3>
						</div>
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
		                		 ...
		                		 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'CouponName', 'id' => 'CouponName', 'value'=>set_value('CouponName'), 'placeholder' => 'Coupon Title', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
				$data = array('name'  => 'CouponPrice', 'id' => 'CouponPrice', 'value'=>set_value('CouponName'), 'placeholder' => 'Coupon Price', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
				$data = array('name'  => 'CouponCode', 'id' => 'CouponCode', 'value'=>set_value('CouponCode'), 'placeholder' => 'Coupon Code', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'StartDate', 'id' => 'datepicker1', 'value'=>set_value('StartDate'), 'placeholder' => 'Start Date', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'EndDate', 'id' => 'datepicker2', 'value'=>set_value('EndDate'), 'placeholder' => 'End Date', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'CouponDescription', 'id' => 'CouponDescription', 'value'=>set_value('CouponDescription'), 'placeholder' => 'Coupon Description', 'class'=>"form-control margin_bottom");
                       echo form_textarea($data);
                                       ...
                                       <?php
                                         /*   unset($options);									
											...
											foreach($edit_tours as $val)
										       {
												   $options[$val['TourId']] = $val['TourName'];
											   }		*/
											
										    // echo form_dropdown('TourId', $options, $selected,'class="form-control margin_bottom"');  onChange="tour_buses(this.value)" 
											
											 $selected=set_value('TourId');	
										?> 
                                        
                                        
                                        <select name="TourId" class="form-control margin_bottom">
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                             ...
                                             <p>
                                               <label>
                                                 <input type="radio" name="CouponFor" value="S" id="RadioGroup1_0"> For Seats</label>
                                               <br>
                                               <label>
                                                 <input type="radio" name="CouponFor" value="T" id="RadioGroup1_1"> For Tour</label>
                                               <br>
                                               <!--<label>
                                                 <input type="radio" name="CouponFor" value="B" checked id="RadioGroup1_2"> For Bus</label>
                                               <br>-->
                                             </p>
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span>Coupon For Seats</span></label>
		                			   <div class="col-md-5 form-group padding_opx">
                                         <p>
                           <?php
					 // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'SeatNo', 'id' => 'SeatNo', 'value'=>set_value('SeatNo'), 'placeholder' => 'Seat No', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?> 
                                        </p>
