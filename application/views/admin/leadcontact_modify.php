             	...
             	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b><i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Contact Modify</b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/leadcontact/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    if($error = $this->session->flashdata('leadcontact')){  ?>
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/leadcontact/edit', $attributes);
							     ?>
                                 
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Select Group  *</span></label>
		                			   <div class="col-md-5 form-group padding_opx">
                                        ...
                                        <?php
								   	        unset($options);									
									        $options['']='Select Contact Group';
											foreach($groupdropdown as $val)
										       {
												    $options[$val['GroupId']] = $val['GroupName'];
											   }		
											 $selected=$edit_leadcontact[0]['GroupId'];	
										     echo form_dropdown('GroupId', $options,$selected,'class="form-control margin_bottom"');
                                        ?>   
                                      </div>
		                		  </div>  
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'Name', 'id' => 'Name', 'value' =>$edit_leadcontact[0]['Name'], 'placeholder' => 'Name', 'class'=>"form-control margin_bottom");
               ...
               $data = array('name'  => 'EmailAddress', 'id' => 'EmailAddress', 'value'=>$edit_leadcontact[0]['EmailAddress'], 'placeholder' => 'Email Address', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-3 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('MobileNo'); ?></span>
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'MobileNo', 'id' => 'MobileNo', 'value'=>$edit_leadcontact[0]['MobileNo'], 'placeholder' => 'Mobile No', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'CityId', 'id' => 'CityId', 'value'=>$edit_leadcontact[0]['CityId'], 'placeholder' => 'City', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'CountryId', 'id' => 'CountryId', 'value'=>$edit_leadcontact[0]['CountryId'], 'placeholder' => 'CountryId', 'class'=>"form-control margin_bottom");
                echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
										...
										//-------------------------------------------------------------------------------------------------------------------
										$data = array('id'  => $edit_leadcontact[0]['ContactId'] );
										echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
