...
defined('BASEPATH') OR exit('No direct script access allowed');
   ...
   */
class Flightsmanage extends CI_Model
   {
         //-----------------------------------------add------------------------------------------------			 
/*	 public	function hoteles_add($data)
	 ...
	 public function hoteles_facilities_add($data_1,$hotel_id)
	  ...
	  public function hoteles_facilities_delete($id)
       ...
       //------------------------------------view-----------------------------------------------------		
	 /*      
	 public function flights_view($limit,$offset)
			 {
	   ...
	   public function flights_view($limit,$offset)
			 {
			   // Updateing in Table(usc_admin) of Database(usc)
				   ...
				   $query = $this->db->get('usc_flight_booking',$limit,$offset);
                   return $query->result_array();
                  $this->db->close();
	  ...
	  public function get_tatal()
			 {
			   // Updateing in Table(usc_flash) of Database(usc)
				   ...
				   $query = $this->db->get('usc_flight_booking');
	  ...
	  public function flights_delete($id)
			 {
				 
			   // Deleteing in Table(usc_flight_booking) of Database(usc)
			    			  
					$this->db->where('id', $id);
					$this->db->delete('usc_flight_booking');
	  ...
	  public function hoteles_edit_data($data,$id)
			  {
			     // Deleteing in Table(usc_flight_booking) of Database(usc)
						...
						$this->db->where('id', $id);
						$query = $this->db->update('usc_flight_booking',$data);
