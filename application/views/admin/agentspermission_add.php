...
<html lang="en">
<head>
<title>Agents Permission Add</title>
<meta charset="utf-8">
		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Agents Permission Add</b></h3>
						</div>
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/agentspermission/add', $attributes);
							     ?>
		                		 ...
		                		 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span>Agents Permission *</span></label>
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'PermisionName', 'id' => 'PermisionName', 'value'=>set_value('PermisionName'), 'placeholder' => 'Agents Permission', 'class'=>"form-control margin_bottom");
                               ...
                               <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
                                            ...
                                            $data = array('name'  => 'AccessUrl', 'id' => 'AccessUrl', 'value'=>set_value('AccessUrl')  , 'placeholder' => '', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
