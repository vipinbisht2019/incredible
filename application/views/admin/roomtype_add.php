		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Room Type Add</b></h3>
						</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
										...
										echo form_open_multipart('admin/roomtype/add', $attributes);
							     ?>
               ...
               $data = array('name'  => 'RoomTitle', 'id' => 'RoomTitle', 'value'=>set_value('RoomTitle'), 'placeholder' => 'Room Type', 'class'=>"form-control margin_bottom");
