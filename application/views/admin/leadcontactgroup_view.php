...
<html lang="en">
<head>
<title>Contact Group View</title>
<meta charset="utf-8">
...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Contact Group View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/leadcontactgroup/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">  Add Contact Group </a>
				...
				<div class="panel-body">
                    <div class="col-lg-12 col-xs-12" style="padding-top: 10px;"></div>
                      ...
                      <div class="col-md-12 col-xs-12 margin_top">  <?php
                                    if($error = $this->session->flashdata('leadcontactgroup')){  ?>
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/leadcontactgroup/bulk_action', $attributes); 
					?>                                
                 ...
                 <?php 
					foreach($leadcontactgroup as $val) 
					   {
					   // var $css;
            ...
            <a href="<?php echo base_url('admin/leadcontactgroup/edit')."?id=".$val['GroupId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/leadcontactgroup/delete')."?id=".$val['GroupId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['GroupId'],  'checked'=> false, 'class'=>" margin_bottom" );
