...
<html lang="en">
 <head>
	<title>Agents Commission View</title>
	<meta charset="utf-8">
...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Agents Commission View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
		       ...
		       <div class="panel-body">
                 <div class="col-md-12 col-xs-12 margin_top">  <?php
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/agentscommission/bulk_action', $attributes); 
					?>                                
					...
					<table class="table table-bordered table_margin_top">
						<thead>
							<tr>
                                <th>ID</th>
                                <th>Cmmission Title </th>
                               <!-- <th>Tour Package (%) </th>
                                <th>Buses Oneway (%) </th>
                                <th>Termpo Travellar  (%) </th>
                                 <th>Cars  (%) </th>-->
                 ...
                 <?php 
					foreach($agentscommission as $val) 
					   {
					   // var $css;
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                            	...
                            	<td><?php echo $val['CommissionId'] ?></td>
								<td><?php echo $val['CommissionTitle'] ?></td>
                                <?php /*?><td><?php echo $val['TourPackage'] ?></td>
                                <td><?php echo $val['BusesOneway'] ?></td>
                                <td><?php echo $val['TermpoTravellar'] ?></td>
                                <td><?php echo $val['Cars'] ?></td><?php */?>
            ...
            <a href="<?php echo base_url('admin/agentscommission/edit')."?id=".$val['CommissionId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/agentscommission/delete')."?id=".$val['CommissionId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['CommissionId'],  'checked'=> false, 'class'=>" margin_bottom" );
