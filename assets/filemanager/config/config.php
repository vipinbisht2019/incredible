...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST']."/2020/projects/mta/assets",
	...
	*/
	...
	'ftp_user'         => "user",
	'ftp_pass'         => "pass",
	'ftp_base_folder'  => "battkartnew",
	'ftp_base_url'     => "http://".$_SERVER['HTTP_HOST']."/2018/ndorse/includes",
	/* --------------------------------------------------------------------------
...
return array_merge(
	...
	array(
		...
		'aviary_defaults_config' => array(
			...
			'tndorsee'      => $config['aviary_tndorsee'],
