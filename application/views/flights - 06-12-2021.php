                  ...
                  ?>
                          ...
                          <tr style="height: 120px;">
                            <td class="text-center">
                              ...
                              <td style="border: none;padding: 13px 5px;float: right;position: relative;top: 25px;"><button  type="button" onClick="bookFlight('<?php echo $newflight_Id[0]; ?>');" id="priceids" value="<?php echo $newflight_Id[0]; ?>" style="background: #244082;border: 1px solid #244082;padding: 10px 32px;color: #fff;font-weight: 400;border-radius: 3px;margin-top: 0px;margin-bottom: 0;height: 35px;line-height: 10px;">BOOK</button></td>
...
//	alert(id);
    $(document).ready(function(){
      ...
      var id = $("#priceids").val();
      window.location.href= "<?php echo base_url("flights/details/")?>"+flightIds;
