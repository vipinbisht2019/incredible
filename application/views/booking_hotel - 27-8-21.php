                                   ...
                                   <td>
                                        ...
                                        <?php //echo $hotelDetail['ops'][0]['id']; ?>
                                            ...
                                            <?php if($hotelDetail['ops'][0]['id'] == $roomValue['id'] ){ ?>
                                              <button class="KETBj bIgcAI">Selected</button>
                                            <?php }else{ ?>
                                              <button class="KETBj bIgcAI" onclick="getSelectedRoom('<?php echo $hotelDetail['id']; ?>','<?php echo $roomValue['id']; ?>','<?php echo $roomValue['ris'][0]['tp']; ?>','<?php echo $roomValue['ris'][0]['rc']; ?>','<?php echo $roomValue['ris'][0]['mb']; ?>');">Select</button>  
                                            <?php } ?>
...
<script>
    ...
    function getSelectedRoom(hotelId,optionId,price,roomName,roomType){

      $.ajax({
        url: "<?php echo base_url('hotels/getRoomOptions')?>",
        type: 'post',
        dataType: "HTML",
        data: {'optionId':optionId,'hotelId':hotelId,'totalPrice':price,'roomName':roomName,'roomType':roomType},
