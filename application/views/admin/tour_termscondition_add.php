...
<html lang="en">
<head>
<title>Tours Terms Conditions Add</title>
<meta charset="utf-8">
...
tinymce.init({
   selector: "#ConditionsNote, #CancellationNote",
	  formats: {
...
<body>
		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Tours Terms Condition Add</b></h3>
						</div>
    ...
    <div class="stepwizard-step col-md-1">
       <a href="<?php echo base_url('admin/tour_train/edit?TourId='.$TourId); ?>"><button type="button" class="btn btn-primary btn-circle">9</button></a>
      <p>Train</p>
    </div>
    ...
    <div class="stepwizard-step col-md-1">
    <a href="<?php echo base_url('admin/tour_costing/edit?TourId='.$TourId); ?>"><button type="button" class="btn btn-primary btn-circle">11</button></a>
     <p>Costing</p>
    </div>
            
    
        <div class="stepwizard-step col-md-1">
         <a href="<?php echo base_url('admin/tour_termscondition/edit?TourId='.$TourId); ?>"><button type="button" class="btn btn-primary btn-circle" disabled="disabled">12</button></a>
...
<?php
        ...
        // ------------------------------ admin form open ---------------------------------
			...
			echo form_open_multipart('admin/tour_termscondition/edit', $attributes);
				 ?>
                                     ...
                                     <!-- *********************************************Hotel********************************************************* -->        
                                           <div class="form-group col-md-12 col-xs-12" style="margin-bottom: 10px;">
                                                          <label class="col-md-2 text-left padding_opx">
                                                            <span> Term Conditions Note </span></label>
                                                              <div class="col-md-5 form-group padding_opx">
                                                              <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'ConditionsNote', 'id' => 'ConditionsNote', 'value'=>$tour_notes[0]['ConditionsNote'],    'placeholder' => 'Term Conditions Note', 'class'=>"form-control margin_bottom");
                         ...
                         <!-- ********************************************* Terms and condition ***************************************** -->                              
                              ...
                              <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span>Terms and Condition </span></label>
		                			   <div class="col-md-5 form-group padding_opx">
                                             ...
                                             <div class="col-md-12 padding_opx"  style="margin-left:5px;">
                                              <?php
										         $i=0;
											   foreach($tour_termconditions as $in_val)
											     {
												   
												   $termconditions[$i]=$in_val['TermsconditionID'];
												   
												   $i++;
												 }
											
											 
											   foreach($terms_condition as $val) { ?>
                                                    <div class="col-md-12 form-group padding_opx" style="margin-top:10px; ">
                                                    <?php
													//'checked'     => TRUE,
													
                                                     
											 if(in_array($val['TermsconditionID'],$termconditions))  
											      {
											        $data = array('name' => 'terms_condition[]', 'id' => 'inclusion', 'value' => $val['TermsconditionID'],'checked' => TRUE);
												  }
												else
												 {
												      $data = array('name' => 'terms_condition[]', 'id' => 'inclusion', 'value' => $val['TermsconditionID']);
												 }   
                                     ...
                                     <!-- *********************************************Hotel********************************************************* -->        
                                           <div class="form-group col-md-12 col-xs-12" style="margin-bottom: 10px;">
                                                          <label class="col-md-2 text-left padding_opx">
                                                            <span>Cancellation Policy Note </span></label>
                                                              <div class="col-md-5 form-group padding_opx">
                                                              <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'CancellationNote', 'id' => 'CancellationNote', 'value'=>$tour_notes[0]['CancellationNote'],    'placeholder' => 'Cancellation Note ', 'class'=>"form-control margin_bottom");
                                         echo form_textarea($data);
                                    ?>
                              ...
                              <div class="col-md-12 padding_opx" style="margin-bottom: 10px;">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span>Cancellation Policy </span></label>
		                			   <div class="col-md-5 form-group padding_opx">
                                             <div style="height:250px;width:700px;overflow:scroll;border:1px solid #7F9DB9;">
                                             ...
                                             <div class="col-md-12 padding_opx"  style="margin-left:5px;">
                                              <?php
										         $i=0;
											   foreach($tour_cancellationpolicy as $in_val)
											     {
												   
												   $cancellationpolicy_1[$i]=$in_val['CancellationID'];
												   
												   $i++;
												 }
											
											 
											   foreach($cancellationpolicy as $val) { ?>
                                                    <div class="col-md-6 form-group padding_opx" style="margin-top:10px; ">
                                                    <?php
													//'checked'     => TRUE,
													
                                                     
											 if(in_array($val['CancellationID'],$cancellationpolicy_1))  
											      {
											        $data = array('name' => 'CancellationID[]', 'id' => 'CancellationID', 'value' => $val['CancellationID'],'checked' => TRUE);
												  }
												else
												 {
												      $data = array('name' => 'CancellationID[]', 'id' => 'CancellationID', 'value' => $val['CancellationID']);
												 }   
														 
                                                     echo form_checkbox($data);
													 echo $val['CancellationTime']; ?></div>
                                  ...
                                  <div class="col-md-12 padding_opx" style="margin-bottom: 10px;">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span>Boarding Point </span></label>
		                			   <div class="col-md-5 form-group padding_opx">
                                             <div style="height:250px;width:700px;overflow:scroll;border:1px solid #7F9DB9;">
                                             
                                       
                                              <?php
											     //print_r($tour_boardingpoint);
											  
										         $i=0;
											   foreach($tour_boardingpoint as $in_val)
											     {
												   
												   $boardingpoint_1[$i]=$in_val['BoardingId'];
												   $boardingpointtime_arr[$in_val['BoardingId']]=$in_val['PickUpTime'];
												   
												   $i++;
												 }
											
											 
											   foreach($boardingpoint as $val) { ?>
                                                     <div class="col-md-12 padding_opx"  style="margin-left:5px;">
                                                    <div class="col-md-6 form-group padding_opx" style="margin-top:10px; ">
												<?php
                                                     if(in_array($val['BoardingId'],$boardingpoint_1))  
                                                          {
                                                            $data = array('name' => 'BoardingId[]', 'id' => 'BoardingId', 'value' => $val['BoardingId'],'checked' => TRUE);
                                                          }
                                                        else
                                                         {
                                                              $data = array('name' => 'BoardingId[]', 'id' => 'BoardingId', 'value' => $val['BoardingId']);
                                                         }   
                                                                 
                                                              echo form_checkbox($data);
                                                              echo $val['BoardingPoint']; ?>  [<?php echo $val['TotalPrice']; ?>]
                                                     </div>
                                                     
                                                       <div class="col-md-3 form-group padding_opx" style="margin-top:10px;">
		<?php   
                $BoardingId=$val['BoardingId'];
                $data = array('name'  => "PickUpTime[$BoardingId]", 'id' => 'PickUpTime', 'value'=>$boardingpointtime_arr[$val['BoardingId']],    'placeholder' => 'Time ', 'class'=>"form-control margin_bottom");
          ...
          ?>
                             ...
                             <!-- *********************************************Hotel********************************************************* -->        
                                           <div class="form-group col-md-12 col-xs-12" style="margin-bottom: 10px;">
                                                          <label class="col-md-2 text-left padding_opx">
                                                            <span>Loactions Map </span></label>
                                                              <div class="col-md-5 form-group padding_opx">
                                                              <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'LocationMap', 'id' => 'LocationMap', 'value'=>$tour_notes[0]['LocationMap'],    'placeholder' => 'Locations Map ', 'class'=>"form-control margin_bottom");
                                         echo form_textarea($data);
                                    ?>
                       ...
                       <?php
						   foreach($commission_type as $cval) 
						     { ?>   
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx"> 
