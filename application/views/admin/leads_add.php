		   		...
		   		<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Leads Add</b></h3>
						</div>
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/leads/add', $attributes);
							     ?>
                           ...
                           <div class="col-md-12 padding_opx">
		                			<label class="col-md-3 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               							$data = array('name'  => 'Name', 'id' => 'Name', 'value'=>set_value('Name'), 'placeholder' => 'Company Name', 'class'=>"form-control margin_bottom");
                 echo form_input($data);
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-3 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'Email', 'id' => 'Email', 'value'=>set_value('Email'), 'placeholder' => 'Company EMail', 'class'=>"form-control margin_bottom");
                 echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
		                			...
		                			<label class="col-md-3 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-3 form-group padding_opx">
											...
											<?php
												...
												$data = array('name'  => 'ContactNumber', 'id' => 'ContactNumber', 'value'=>set_value('ContactNumber'), 'placeholder' => 'Company Contact Number', 'class'=>"form-control margin_bottom");
								...
								<div class="col-md-12 padding_opx">
		                			<label class="col-md-3 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'branch_name', 'id' => 'branch_name', 'value'=>set_value('branch_name'), 'placeholder' => 'Branch Name', 'class'=>"form-control margin_bottom");
                 echo form_input($data);
                                        ?>
                                      </div>
		                		</div></div>
								...
								<div class="col-md-12 col-xs-12">
		                			<label class="col-md-3 text-left padding_opx">
                                       ...
                                       <?php
               								...
               								$data = array('name'  => 'contact_name[]', 'id' => 'contact_name', 'value'=>set_value('contact_name'), 'placeholder' => 'Contact Name', 'class'=>"form-control margin_bottom");
                 							echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
								...
								<div class="col-md-12 col-xs-12">
		                			<label class="col-md-3 text-left padding_opx">
                                       ...
                                       <?php
               								...
               								$data = array('name'  => 'contact_number[]', 'id' => 'contact_number', 'value'=>set_value('contact_number'), 'placeholder' => ' Contact Number', 'class'=>"form-control margin_bottom");
                 							echo form_input($data);
								...
								<div class="col-md-12 col-xs-12">
		                			<label class="col-md-3 text-left padding_opx">
                                       ...
                                       <?php
               								...
               								$data = array('name'  => 'contact_email[]', 'id' => 'contact_email', 'value'=>set_value('contact_email'), 'placeholder' => 'Contact Email', 'class'=>"form-control margin_bottom");
                 							echo form_input($data);
											 
                                        ?>
                                      </div> 
                                      
                                       <!---- Multiple Contcat Add----->
								<!-- <div class="col-md-1 form-group padding_0px">
                                      <buton id="myBtn">
                                        <a href="javascript:void(0)" class="btn btn-success addMoreContact"><span class="glyphicon glyphicon glyphicon-plus" aria-hidden="true"></span> Add</a>
                                      </buton>
                                </div>
                                
                                <div class="row">
                                	<div class="col-lg-12  fieldContact">
                                    	<div class="col-md-12 fieldContactDetails" style="display: none">                                     
                                    		<div class="col-md-12 col-xs-12">
                                                <label class="col-md-3 text-left padding_opx">
                ...
                /*
                         ...
                         */
                                            ...
                                            <div class="col-md-1 "> 
                                             <a href="javascript:void(0)" class="btn btn-danger contactremove"><span class="glyphicon glyphicon glyphicon-remove" aria-hidden="true"></span> Remove</a>
                                            </div>
							   ...
							   <div class="panel-body">
                                 ...
                                 <div class="col-md-12 col-xs-12">
	                				...
	                				<span> City  </span></label>
                                       ...
                                       <select name="City" id="cityid" style="width: 100%;box-shadow: 0px 1px 2px 0 rgb(0 0 0 / 10%);border-radius: 2px;border-color: #eaeaea;padding: 6px 12px;background: #fcfcfc;">
									  	...
									  	<!-- <div class="col-md-4">
											<button type="button" id="city">Add New</button>
										</div> -->
		                		</div>  
                                ...
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <?php
             						...
             						$data = array('name'  => 'Address', 'id' => 'Address','value'=>set_value('Address') ,  'placeholder' => 'Address 1', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                                    ?>
								...
								<div class="col-md-12 col-xs-12">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
             							$data = array('name'  => 'Address_second', 'id' => 'Address_second','value'=>set_value('Address_second') ,  'placeholder' => 'Address 2', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                                    ?>
                                ...
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
             							$data = array('name'  => 'zip_code', 'id' => 'zip_code','value'=>set_value('zip_code') ,  'placeholder' => 'Zip Code', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
                                    ?>
								...
								<div class="col-md-12 col-xs-12">
		                			<label class="col-md-3 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
           										$data = array('name'  => 'fit', 'id' => 'fit', 'value'=>set_value('fit'),  'placeholder' => 'FIT', 'class'=>"form-control margin_bottom");
                 									echo form_input($data);
								...
								<div class="col-md-12 col-xs-12">
		                			<label class="col-md-3 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'git', 'id' => 'git', 'value'=>set_value('git'), 'placeholder' => 'GIT', 'class'=>"form-control margin_bottom");
                 echo form_input($data);
                                        ?>
                                      </div>
		                		</div></div>
								...
								<div class="panel-body">
								 <div class="col-md-12 col-xs-12">
		                			<label class="col-md-3 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
             							$data = array('name'  => 'TravelDate', 'id' => 'datepicker3', 'value'=>set_value('TravelDate'), 'placeholder' => 'Travel Date', 'class'=>"form-control margin_bottom");
                						 echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
                               ...
                               <?php //echo '<pre>'; print_r($leads_leadsource); ?>
                               ...
                               <div class="col-md-12 col-xs-12">
                                 ...
                                 <div class="col-md-12 col-xs-12">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
             						$data = array('name'  => 'Note', 'id' => 'Description','value'=>set_value('Note') ,  'placeholder' => 'Note', 'class'=>"form-control margin_bottom");
                          ...
                          <div class="col-md-12 col-xs-12">
									...
									<!-- <div class="col-md-4">
										<button type="button" id="assignto">Add New</button>
									</div> -->
                               	</div>                                                         
...
$(document).ready(function(){
	...
	// Start Accomodations Images //
	
	
	 $(".addMoreContact").click(function(){
        if($('body').find('.fieldContact').length < maxGroup){
            var fieldHTML = '<div  class=" col-md-12 form-group fieldContact">'+$(".fieldContactDetails").html()+'</div>';
            $('body').find('.fieldContact:last').after(fieldHTML);
        }else{
	...
	$("body").on("click",".contactremove",function(){ 
        $(this).parents(".fieldContact").remove();
    });
	
	
	// End Accomodation Images //
