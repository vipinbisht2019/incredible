             	...
             	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b><i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Bus Routes Modify</b></h3>
						</div>

						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/busesroutes/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    if($error = $this->session->flashdata('busesroutes')){  ?>
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/busesroutes/edit', $attributes);
							     ?>
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Routes Name  * </span></label>
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('RoutesName'); ?></span>
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'RoutesName', 'id' => 'RoutesName', 'value' =>$edit_busesroutes[0]['RoutesName'], 'placeholder' => 'Routes Name', 'class'=>"form-control margin_bottom");
                       ...
                       <?php for($i=0;$i<count($edit_busesroutes_city);$i++) { ?>         
		                			...
		                			<div class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        ...
                                        <?php
											...
											unset($options);									
									        $options['']='-------Choose-----------';
											foreach($location_dropdown as $val)
										       {
												   $options[$val['CityId']] = $val['CityName'];
											   }		
											 $selected=$edit_busesroutes_city[$i];	
										     echo form_dropdown('CityId[]', $options,$selected,'class="form-control margin_bottom"');
                                    ?>
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        ...
                                        <?php
											...
											foreach($location_dropdown as $val)
											 ...
											 $selected=$edit_cardetails[0]['CityId'];	
										     echo form_dropdown('CityId[]', $options,$selected,'class="form-control margin_bottom"');
                                    ?>
               ...
               $data = array('name'  => 'CommissionPrice[]', 'id' => 'CommissionPrice', 'value'=>$commission_type_edit[$cval['CommissionId']], 'placeholder' => $cval['CommissionTitle'].' Agents Commission', 'class'=>"form-control margin_bottom");
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
                                        ...
                                        echo form_hidden($data);
										//-------------------------------------------------------------------------------------------------------------------
										$data = array('id'  => $edit_busesroutes[0]['RoutesId'] );
										echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
                     ...
                     <!--   class="form-group fieldGroupCopy" style="display: none;-->
