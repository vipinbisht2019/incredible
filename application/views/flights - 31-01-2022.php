                            ...
                            <tr style="height: 120px">
                              <td class="text-center">
                                <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;flex-direction: row;">
                                  <li><img src="<?php echo base_url('uploads/flights/');?><?php echo $flightValue['flghtCode'] ; ?>.png" alt=""></li>
                                  <li style="font-size:12px;font-weight:600;text-align: left;left: 0px;position: relative;"><?php echo $flightValue['flghtName']; ?>
                                  <p style="font-size:10px;font-weight:400;"><?php echo $flightValue['flghtCode'] ?> - <?php echo $flightValue['flghtNumber']?></p>
                                    </li>
                                  </ul>
                          ...
                          <tr style="height: 120px">
                            <td class="text-center">
                              <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;flex-direction:row">
                                ...
                                <li style="font-size:12px;font-weight:600;text-align: left;left: 10px;position: relative;"><?php echo $flightValue1['flghtName'] ?>
                                <p style="font-size:10px;font-weight:400;"><?php echo $flightValue1['flghtCode']; ?> - <?php echo $flightValue1['flghtNumber']; ?> </p>
                                </li>
                              </ul>
                            </td>
                            <td>
