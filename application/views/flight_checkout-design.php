...
echo "<pre>";
print_r($tripInfoResultthird);

echo "<pre>";
print_r($tripInfoResultforth);

echo "<pre>";
print_r($tripInfoResultfifth);
                                ...
                                <div class="description detail-box flight-book">
                                    ...
                                    <div class="dscrpton-cntnt detail-box">
                                        ...
                                        <div class="dF alignItemsCenter">
                                            <span class="padR5"><!--<span class="flight-detailstyles__BaggageCancellationRulesSelection-sc-1i6unua-16 iytGnu">Baggage and Fare Rules</span>-->
                                            ...
                                            </span><!--<div class="flight-detailstyles__Refundability-sc-1i6unua-15 edFviB  white">PARTIALLY REFUNDABLE</div>-->
                                        </div>
                                    </div>
                                        ...
                                        <span><?php echo $tripInfoResult['totalPriceList'][0]['fareIdentifier']; ?></span>
									...
									if($countMultiways > 4) { 
                                       ...
                                       // echo "<pre>";  print_r($tripInfoResultfifth);     die;
                                    ?>
                            ...
                            <div class="description-content">
                                ...
                                <!-- <div style="width: 95%;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" name="issuedate" id="issuedate" placeholder="Issue Date">
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="accordion__container">
                                                    ...
                                                    <?php if(count($adult_Pax1) > 0) {
                                                       ...
                                                       // while($adult_Pax1 > 0) { ?>
                                                        <div class="row">
                                                            <div class="col-md-2 form-group padding_5px " >
                                                                <span style="text-align:left; color:rgb(119, 119, 119);font-size:15px;";>Adult <?php echo $i; ?></span>
                                                            </div>
                                                            <div class="col-md-5 form-group ">
                                                                ...
                                                                <select name="baggage[]">
                                                                    ...
                                                                    <?php foreach ($SSRInfoBaggage as $key => $baggagevalue) { ?> 
                                                                        ...
                                                                        <option value="<?php echo $baggagevalue['desc']; ?>"><?php echo $baggagevalue['desc']; ?> @ <?php echo $baggagevalue['amount']; ?></option>
                                                            ...
                                                            <div class="col-md-5 form-group padding_5px " >
                                                                ...
                                                                <select name="meal[]">
                                                                    ...
                                                                    <option value="<?php echo $mealvalue['desc']; ?>"><?php echo $mealvalue['desc']; ?> @ <?php echo $mealvalue['amount']; ?></option>
                                                                    <?php } ?>                                                        
                                                                </select>
                                                            </div>
                                                        </div> 
                                                ...
                                                <?php if(count($child_Pax1) > 0) {
                                                     ...
                                                     // while($adult_Pax1 > 0) { ?>
                                                      <div class="row">
                                                          <div class="col-md-2 form-group padding_5px " >
                                                              <span style="text-align:left; color:rgb(119, 119, 119);font-size:15px;";>Child <?php echo $j; ?></span>
                                                          </div>
                                                          <div class="col-md-5 form-group ">
                                                              <span style="text-align:left; color:#FF0000;font-size:12px;";><?php echo form_error('baggage'); ?></span>
                                                              <!-- <input type="hidden" name="paxType[]" value="ADULT" /> -->
                                                    ...
                                                    <?php if(count($infant_Pax1) > 0) {
                                                     ...
                                                     // while($adult_Pax1 > 0) { ?>
                                                      <div class="row">
                                                          <div class="col-md-2 form-group padding_5px " >
                                                              <span style="text-align:left; color:rgb(119, 119, 119);font-size:15px;";>Infant <?php echo $k; ?></span>
                                                          </div>
                                                          <div class="col-md-5 form-group ">
                                                              <span style="text-align:left; color:#FF0000;font-size:12px;";><?php echo form_error('baggage'); ?></span>
                                                              <!-- <input type="hidden" name="paxType[]" value="ADULT" /> -->
                                                ...
                                                <div class="accordion__container">
                                                    ...
                                                    <div class="accordion__answer__container">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <p class="p-20"><b><span>Delhi</span><span class="ars-arright">→</span> <span>Dubai</span></b><span class="graycolor "> on Nov 15, 2021</span></p>
                                                            </div>
                                                            <div class="col-md-4">
                                                                ...
                                                                <div id="myModal1" class="modal">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="seat-map__select-container">
                                                                            <ul class="seat-map__select-container__header"><!--<h3 class="apt-heading"> Select Seats </h3>-->
                                                                                <li class="seat-map__select-container__item">
                                                                                    <span class="search-inlinecontent">
                                                                                        <img class="airline-logo search-logoallflight" src="//static.tripjack.com/img/airlineLogo/6E.png">
                                                                                        <h5 class="search-flightsname"> IndiGo <span class="search-flightscode">6E-23</span></h5>
                                                                                    </span>
                                                                                </li>
                                                                                <li class="seat-map__select-container__item">
                                                                                    <h5 class="search-flightsname">DEL-DXB</h5>
                                                                                </li>
                                                                            </ul>
                                                                            ...
                                                                            <ul class="seat-map__select-box">
                                                                                <li class="seat-map__seat-data seat-map__seat-data--selected">
                                                                                    <div class="seat-map__select-box__item seat-map--passenger paxname-ellipsis"> ADULT-1 </div>
                                                                                    <div class="seat-map__select-box__item seat-map--seatNo">  </div>
                                                                                    <div class="seat-map__select-box__item seat-map--fee"> ₹0.00 </div>
                                                                                </li>
                                                                                <li class="seat-map__seat-data">
                                                                                    <div class="seat-map__select-box__item seat-map--passenger paxname-ellipsis"> ADULT-2 </div>
                                                                                    <div class="seat-map__select-box__item seat-map--seatNo">  </div>
                                                                                    <div class="seat-map__select-box__item seat-map--fee"> ₹0.00 </div>
                                                                                </li>
                                                                                <li class="seat-map__seat-data"><div class="seat-map__select-box__item seat-map--passenger paxname-ellipsis"> CHILD-1 </div>
                                                                                    <div class="seat-map__select-box__item seat-map--seatNo">  </div>
                                                                                    <div class="seat-map__select-box__item seat-map--fee"> ₹0.00 </div>
                                                                                </li>
                                                                                <li class="seat-map__seat-data">
                                                                                    <div class="seat-map__select-box__item seat-map--passenger paxname-ellipsis"> CHILD-2 </div>
                                                                                    <div class="seat-map__select-box__item seat-map--seatNo">  </div>
                                                                                    <div class="seat-map__select-box__item seat-map--fee"> ₹0.00 </div>
                                                                                </li>
                                                                                <li class="seat-map__seat-data">
                                                                                ...
                                                                                <ul class="seat-map__select-box">
                                                                                    <li class="seat-map__select-box__item seat-map__select-box__item--proceed">Proceed</li>
                                                                                    <li class="seat-map__seat-data">
                                                                                ...
                                                                                <ol class="cabin fuselage">
                                                                                    <li class="row row--1">
                                                                                        ...
                                                                                        <li class="seat">
                                                                                          ...
                                                                                          <label for="1A" class="clr-1">1A</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                          <input type="checkbox" id="1B" />
                                                                                          <label for="1B" class="clr-1">1B</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                          <input type="checkbox" id="1C" />
                                                                                          <label for="1C" class="clr-1">1C</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                        ...
                                                                                        <li class="seat">
                                                                                          ...
                                                                                          <label for="1E" class="clr-1">1E</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                          <input type="checkbox" id="1F" />
                                                                                          <label for="1F" class="clr-1">1F</label>
                                                                                        </li>
                                                                                    </ol>
                                                                                </li>
                                                                                <li class="row row--2">
                                                                                    <ol class="seats" type="A">
                                                                                        <li class="seat">
                                                                                            ...
                                                                                            <label for="2A" class="clr-6">2A</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="2B" />
                                                                                            <label for="2B" class="clr-6">2B</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="2C" />
                                                                                            <label for="2C" class="clr-6">2C</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="2D" />
                                                                                            <label for="2D" class="clr-6">2D</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="2E" />
                                                                                            <label for="2E" class="clr-6">2E</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="2F" />
                                                                                            <label for="2F" class="clr-6">2F</label>
                                                                                        </li>
                                                                                    </ol>
                                                                                </li>
                                                                                <li class="row row--3">
                                                                                    <ol class="seats" type="A">
                                                                                        <li class="seat">
                                                                                            ...
                                                                                            <label for="3A" class="clr-6">3A</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="3B" />
                                                                                            <label for="3B" class="clr-6">3B</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="3C" />
                                                                                            <label for="3C" class="clr-6">3C</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="3D" />
                                                                                            <label for="3D" class="clr-6">3D</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="3E" />
                                                                                            <label for="3E" class="clr-6">3E</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="3F" />
                                                                                            <label for="3F" class="clr-6">3F</label>
                                                                                        </li>
                                                                                    </ol>
                                                                                </li>
                                                                                <li class="row row--4">
                                                                                    <ol class="seats" type="A">
                                                                                        <li class="seat">
                                                                                            ...
                                                                                            <label for="4A" class="clr-5">4A</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="4B" />
                                                                                            <label for="4B" class="clr-4">4B</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="4C" />
                                                                                            <label for="4C" class="clr-5">4C</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                ...
                                                                                <li class="row row--5">
                                                                                    <ol class="seats" type="A">
                                                                                        <li class="seat">
                                                                                            ...
                                                                                            <label for="5A" class="clr-5">5A</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="5B" />
                                                                                            <label for="5B" class="clr-6">5B</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="5C" />
                                                                                            <label for="5C" class="clr-5">5C</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="5D" />
                                                                                            <label for="5D" class="clr-6">5D</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="5E" />
                                                                                            <label for="5E" class="clr-5">5E</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="5F" />
                                                                                            <label for="5F" class="clr-5">5F</label>
                                                                                        </li>
                                                                                    </ol>
                                                                                </li>
                                                                                <li class="row row--6">
                                                                                    <ol class="seats" type="A">
                                                                                        <li class="seat">
                                                                                            ...
                                                                                            <label for="6A" class="clr-5">6A</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="6B" />
                                                                                            <label for="6B" class="clr-2">6B</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="6C" />
                                                                                            <label for="6C" class="clr-1">6C</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="6D" />
                                                                                            <label for="6D" class="clr-5">6D</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="6E" />
                                                                                            <label for="6E" class="clr-5">6E</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="6F" />
                                                                                            <label for="6F" class="clr-3">6F</label>
                                                                                        </li>
                                                                                    </ol>
                                                                                </li>
                                                                                <li class="row row--7">
                                                                                    <ol class="seats" type="A">
                                                                                        <li class="seat">
                                                                                            ...
                                                                                            <label for="7A" class="clr-5">7A</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="7B" />
                                                                                            <label for="7B" class="clr-1">7B</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="7C" />
                                                                                            <label for="7C" class="clr-5">7C</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="7D" />
                                                                                            <label for="7D" class="clr-6">7D</label>
                                                                                        </li>
                                                                                        <li class="seat">
                                                                                            <input type="checkbox" id="7E" />
                                                                                            <label for="7E" class="clr-5">7E</label>
                                                                                        </li>
                                                                                    <li class="seat">
                                                                            ...
                                                                            <li class="row row--8">
                                                                                <ol class="seats" type="A">
                                                                                    <li class="seat">
                                                                                        ...
                                                                                        <label for="8A" class="clr-5">8A</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                    ...
                                                                                    <li class="seat">
                                                                                        ...
                                                                                        <label for="8C" class="clr-5">8C</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                        <input type="checkbox" id="8D" />
                                                                                        <label for="8D" class="clr-1">8D</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                        <input type="checkbox" id="8E" />
                                                                                        <label for="8E" class="clr-2">8E</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                        <input type="checkbox" id="8F" />
                                                                                        <label for="8F" class="clr-5">8F</label>
                                                                                    </li>
                                                                                </ol>
                                                                            </li>
                                                                            <li class="row row--9">
                                                                                <ol class="seats" type="A">
                                                                                    <li class="seat">
                                                                                        ...
                                                                                        <label for="9A" class="clr-3">9A</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                        <input type="checkbox" id="9B" />
                                                                                        <label for="9B" class="clr-2">9B</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                        <input type="checkbox" id="9C" />
                                                                                        <label for="9C" class="clr-3">9C</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                    ...
                                                                                    <li class="seat">
                                                                                        ...
                                                                                        <label for="9E" class="clr-3">9E</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                        <input type="checkbox" id="9F" />
                                                                                        <label for="9F" class="clr-2">9F</label>
                                                                                    </li>
                                                                                </ol>
                                                                            </li>
                                                                            <li class="row row--10">
                                                                                <ol class="seats" type="A">
                                                                                    <li class="seat">
                                                                                        ...
                                                                                        <label for="10A" class="clr-3">10A</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                        <input type="checkbox" id="10B" />
                                                                                        <label for="10B" class="clr-2">10B</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                      <input type="checkbox" id="10C" />
                                                                                      <label for="10C" class="clr-3">10C</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                        <input type="checkbox" id="10D" />
                                                                                        <label for="10D" class="clr-2">10D</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                        <input type="checkbox" id="10E" />
                                                                                        <label for="10E" class="clr-3">10E</label>
                                                                                    </li>
                                                                                    <li class="seat">
                                                                                        <input type="checkbox" id="10F" />
                                                                                        <label for="10F" class="clr-3">10F</label>
                                                                                    </li>
                                                                                </ol>
                                                                            </li>
                                                                        </ol>
                                                                    ...
                                                                    <!--<div class="grid-column" style="width: calc(14.2857% - 10px);">
                                                                        <div class="grid-item seat-map__box--background-4 seat-map__box--booked">
                                                                            <span class="grid-item__text"> 1A </span>
                                                                        </div>
                                                                        <div class="grid-item seat-map__box--background-3">
                                                                            <span class="grid-item__text"> 2A </span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="grid-column" style="width: calc(14.2857% - 10px);">
                                                                        <div class="grid-item seat-map__box--background-4">
                                                                            <span class="grid-item__text"> 1B </span>
                                                                        </div>
                                                                        <div class="grid-item seat-map__box--background-3">
                                                                            <span class="grid-item__text"> 2B </span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="grid-column" style="width: calc(14.2857% - 10px);">
                                                                        <div class="grid-item seat-map__box--background-4">
                                                                            <span class="grid-item__text"> 1C </span>
                                                                        </div>
                                                                        <div class="grid-item seat-map__box--background-3">
                                                                            <span class="grid-item__text"> 2C </span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="grid-column" style="width: calc(14.2857% - 10px);">
                                                                        <div class="grid-item__empty">
                                                                            <span class="grid-item__text"> </span>
                                                                        </div>
                                                                        <div class="grid-item__empty">
                                                                            <span class="grid-item__text"> </span>
                                                                        </div>
                                                                    ...
                                                                    <div class="grid-column" style="width: calc(14.2857% - 10px);">
                                                                        <div class="grid-item seat-map__box--background-4">
                                                                            <span class="grid-item__text"> 1D </span>
                                                                        </div>
                                                                        <div class="grid-item seat-map__box--background-3">
                                                                            <span class="grid-item__text"> 2D </span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="grid-column" style="width: calc(14.2857% - 10px);">
                                                                        <div class="grid-item seat-map__box--background-4">
                                                                            <span class="grid-item__text"> 1E </span>
                                                                        </div>
                                                                        <div class="grid-item seat-map__box--background-3">
                                                                            <span class="grid-item__text"> 2E </span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="grid-column" style="width: calc(14.2857% - 10px);">
                                                                        <div class="grid-item seat-map__box--background-4">
                                                                            <span class="grid-item__text"> 1F </span>
                                                                        </div>
                                                                        <div class="grid-item seat-map__box--background-3">
                                                                            <span class="grid-item__text"> 2F </span>
                                                                        </div>
                                                                    </div>-->
                                                                </div>
                                            ...
                                            <?php if($tripConditions['gst']['gstappl'] == 'true' ){ ?>
                                                <div class="accordion__container">
                                                    ...
                                                    <div class="accordion__answer__container">
                                                        ...
                                                        <div class="row">
                                                        <div class="col-md-12">    
                                                            <p>To claim credit of GST charged by airlines, Please enter your company's GST number</p>
                                                        </div>
                            ...
                            ?>
                                ...
                                <div class="input2_wrapper">
                                    ...
                                    <div class="col-md-6 pad-l-r">
                                        <span class="red total-amt mp"><i class="fa fa-inr"></i> &nbsp;<?php echo number_format($grossTotal,2) ;?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
