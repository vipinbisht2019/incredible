...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Car Class View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/carclass/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Car class </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                      ...
                      <div class="col-md-12 col-xs-12 margin_top">  <?php
                                    if($error = $this->session->flashdata('carclass')){  ?>
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/carclass/bulk_action', $attributes); 
					?>                                
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                            	...
                            	<td><?php echo $val['carclassId'] ?></td>
								<td><?php echo $val['carclassName'] ?></td>
            ...
            <a href="<?php echo base_url('admin/carclass/edit')."?id=".$val['carclassId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/carclass/delete')."?id=".$val['carclassId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['carclassId'],  'checked'=> false, 'class'=>" margin_bottom" );
