    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
           ...
           <div class="col-xs-12 col-md-12 col-xs-12 padding_opx">
				...
				<!-- <a href="<?php // base_url('booking/flight'); ?>">Flight Booking</a>
				<a href="<?php //echo base_url('booking/hotel'); ?>">Hotel Booking</a> -->

				<div class="panel">
					<div class="panel-heading hidden-xs hidden-sm"> <h3 style="font-size:20px;margin-top:0px;margin-bottom:0px;padding:5px;font-size: 18px;text-transform: capitalize;"> Booking Details <?php  //echo $this->session->userdata('user_id'); ?> </h3>
				</div>
			...
			<table class="table">
				...
				<tr>
					...
					<td>
						...
						<a href="<?php echo base_url('booking/flight_details/');?><?php echo $bookValue['booking_id']; ?>" style="text-decoration:none; color : #0079b1
">
				...
				<tbody>
					...
					?>
                           	<tr>
								...
								<td><?php echo $user_booking['booking_status']; //if($user_booking['booking_status']==1) { echo "Confirm"; } 
