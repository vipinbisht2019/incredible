                    ...
                    <table>
                     ...
                     // error_reporting(0);
                      ...
                      // echo '<pre>'; print_r($return);
                        ...
                        // $adultCount = $completeResult[$i]['totalPriceList']['fd']['ADULT']['fC']['TF'];
                        // @$childCount = $completeResult[$i]['totalPriceList'][$j]['fd']['CHILD']['fC']['TF']; 
                        // @$infantCount = $completeResult[$i]['totalPriceList'][$j]['fd']['INFANT']['fC']['TF']; 
...
//  alert(DipartureID);
  ...
  jQuery.ajax({
     url: "<?php echo base_url('flights/flight_filter')?>",
          type: 'post',
          dataType: "html",
          data: {'AirlineID':AirlineID,'departureId':DipartureID,'stopId':stopId,'departure':departure11,'destination':destination11,'bookingType':bookingType11,'departureDate':departureDate11,'travelClass':travelClass11,'adultPax':adultPax11,'childPax':childPax11,'infantPax':infantPax11,'returnDate':returnDate},
          success: function( data ) {
            console.log(data);
