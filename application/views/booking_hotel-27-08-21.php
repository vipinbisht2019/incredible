                ...
                <div class="container">
                    <div class="row">
                                    ...
                                    <div class="post-header">
                                        <div class="post-slide">
                                            <div id="sl1">
                                              ...
                                              <p>  <?php echo '<pre>'; print_r($hotelDetail['des']);?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-4">
                             ...
                             <div class="summarybox"><h2 class="summarybox__price">₹ <?php echo $hotelDetail['ops'][0]['ris'][0]['tp']; ?> <!--<svg title="Change markup" class="svg-inline--fa fa-edit fa-w-18 changemarkup-icons" aria-labelledby="svg-inline--fa-title-ezaorxZOpEfv" data-prefix="far" data-icon="edit" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg=""><title id="svg-inline--fa-title-ezaorxZOpEfv">Change markup</title><path fill="currentColor" d="M402.3 344.9l32-32c5-5 13.7-1.5 13.7 5.7V464c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V112c0-26.5 21.5-48 48-48h273.5c7.1 0 10.7 8.6 5.7 13.7l-32 32c-1.5 1.5-3.5 2.3-5.7 2.3H48v352h352V350.5c0-2.1.8-4.1 2.3-5.6zm156.6-201.8L296.3 405.7l-90.4 10c-26.2 2.9-48.5-19.2-45.6-45.6l10-90.4L432.9 17.1c22.9-22.9 59.9-22.9 82.7 0l43.2 43.2c22.9 22.9 22.9 60 .1 82.8zM460.1 174L402 115.9 216.2 301.8l-7.3 65.3 65.3-7.3L460.1 174zm64.8-79.7l-43.2-43.2c-4.1-4.1-10.8-4.1-14.8 0L436 82l58.1 58.1 30.9-30.9c4-4.2 4-10.8-.1-14.9z"></path></svg> -->
                            <!-- <i title="Change markup" class="far fa-edit changemarkup-icons"></i> --></h2><h4 class="summarybox__roomtype"><?php echo $hotelDetail['ops'][0]['ris'][0]['rc']; ?> <span class="summarybox__roomtype--text"></span></h4><div class="summarybox__type"><div class="summarybox__type--content"><p class="summarybox__type--inclusion"><?php echo $hotelDetail['ops'][0]['ris'][0]['mb']; ?></p></div><ul class="hidden summarybox__facilities"><li class="summarybox__facilities--list"><span class="summarybox__facilities--icon"><use xlink:href="icons.svg#air-conditioner"></use></span></li></ul><p class="hidden summarybox__facilities--counter ">23+</p></div><p class="summarybox__select">Select Other Room<span class="summarybox__select--icon"><svg class="svg-inline--fa fa-angle-down fa-w-10" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""><path fill="currentColor" d="M143 352.3L7 216.3c-9.4-9.4-9.4-24.6 0-33.9l22.6-22.6c9.4-9.4 24.6-9.4 33.9 0l96.4 96.4 96.4-96.4c9.4-9.4 24.6-9.4 33.9 0l22.6 22.6c9.4 9.4 9.4 24.6 0 33.9l-136 136c-9.2 9.4-24.4 9.4-33.8 0z"></path></svg><!-- <i class="fas fa-angle-down"></i> --></span></p></div>
                            
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="dgYyfz">
                                        <!-- <p class="kUvMXU">price starts at</p> -->
                                        <div class="jyqvHA">
                                            <div class="eHNNyP">
                                                <div class="fkOjQZ">
                                                    <!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="1.4rem" height="1.4rem" fill="#141823" class="guwrRX">
                                                        <path d="M21.482 7.945h3.536c.982 0 1.786.818 1.786 1.818s-.804 1.818-1.786 1.818h-3.536a9.429 9.429 0 01-2.625 5.109 9.509 9.509 0 01-6.75 2.891h-.679l9.661 9.255c0 .018.018.018.036.036.679.673.696 1.782.036 2.473a1.742 1.742 0 01-2.518.091L5.714 19a1.78 1.78 0 01-.554-1.364c.036-.964.839-1.727 1.786-1.691h5.179a5.902 5.902 0 004.214-1.836 6.327 6.327 0 001.482-2.527H6.946c-.982 0-1.786-.818-1.786-1.818s.804-1.818 1.786-1.818h10.875C17 5.455 14.714 3.782 12.125 3.764H6.946c-.982 0-1.786-.818-1.786-1.818S5.964.128 6.946.128h18.071c.982 0 1.786.818 1.786 1.818s-.804 1.818-1.804 1.818h-5.464a8.504 8.504 0 011.946 4.182z"></path>
                                                    </svg> -->
                                                    <!-- <p class="gpxhWi"><?php //echo $hotelDetail['ops'][0]['ris'][0]['tp']; ?></p>
                                                    <p class="gpxhWi"><?php //echo $hotelDetail['ops'][0]['ris'][0]['rc']; ?></p>
                                                    <p class="gpxhWi"><?php //echo $hotelDetail['ops'][0]['ris'][0]['mb']; ?></p> -->
                                                </div>
                                                <!-- <div class="fkOjQZ">+<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width=".8rem" height=".8rem" fill="#141823" class="kjxuYv">
                                                    <path d="M21.482 7.945h3.536c.982 0 1.786.818 1.786 1.818s-.804 1.818-1.786 1.818h-3.536a9.429 9.429 0 01-2.625 5.109 9.509 9.509 0 01-6.75 2.891h-.679l9.661 9.255c0 .018.018.018.036.036.679.673.696 1.782.036 2.473a1.742 1.742 0 01-2.518.091L5.714 19a1.78 1.78 0 01-.554-1.364c.036-.964.839-1.727 1.786-1.691h5.179a5.902 5.902 0 004.214-1.836 6.327 6.327 0 001.482-2.527H6.946c-.982 0-1.786-.818-1.786-1.818s.804-1.818 1.786-1.818h10.875C17 5.455 14.714 3.782 12.125 3.764H6.946c-.982 0-1.786-.818-1.786-1.818S5.964.128 6.946.128h18.071c.982 0 1.786.818 1.786 1.818s-.804 1.818-1.804 1.818h-5.464a8.504 8.504 0 011.946 4.182z"></path>
                                                    </svg>
                                                    <p class="kXa-DyS">758 taxes &amp; fees</p>
                                                </div>
                                                <p class="kaZjev">per room / night</p>
                                            </div> -->
                                            <!-- <div class="eHNNyP">
                                                <div class="fkOjQZ hSjZuk">
                                                    <svg viewBox="0 0 32 32" width="2rem" height="2rem" fill="#777777" class="bEvPce">
                                                    ...
                                                    <p class="krdDso">2 x Guests</p>
                                                </div>
                                                <div class="fkOjQZ hSjZuk">
                                                    <svg viewBox="0 0 32 32" width="2rem" height="2rem" fill="#777777" class="jZiQuq">
                                                    ...
                                                    <p class="krdDso">1 x Room</p>
                                                </div> -->
                                                 <a href="<?php echo base_url('hotels/booking/')?><?php echo $hotelDetail['id']; ?>/<?php echo $hotelDetail['ops'][0]['id']; ?>"><button data-id="" type="button" class="hoteldetails__rightbox--bookbtn">Book this room<span class="sublabel-content"></span></button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table>
                              ...
                              <tbody>
                                ...
                                ?>
                                 ...
                                 <tr>
                                   <td style="position:sticky;top:0px;"><p><b><?php echo $roomValue['ris'][0]['rc']; ?></b></p></td>
                                   <td>
                                        <p><b><?php echo $roomValue['ris'][0]['mb']; ?></b></p>
                                   ...
                                   <td>
                                        ...
                                        <div>
                                            ...
                                            <span> for <?php echo $roomValue['ris'][0]['pis'][0]['day']; ?> Night(s) for <?php echo $roomValue['ris'][0]['adt']; ?> adult <?php echo $roomValue['ris'][0]['chd']; ?> child
