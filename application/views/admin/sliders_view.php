			   ...
			   <div class="panel-heading col-md-12 col-xs-12 panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Sliders Image View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/sliders/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom"> Add Sliders </a>
                            <br>
						 </div>
					</div>
				</div>
			...
			<div class="panel">
				...
				<div class="panel-body">
                      ...
                      <div class="col-md-12 col-xs-12 margin_top">  <?php
						...
						echo form_open_multipart('admin/sliders/bulk_action', $attributes); 
					?>                      
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                            	<td><?php echo $val['FlashId'] ?></td>
								<td><?php echo $val['Heading'] ?></td>
								<td><?php echo $val['SortOrder'] ?></td>
								<th><?php if($val['Image']!='') { ?> <img src="<?php echo base_url('uploads/sliders/'.$val['Image']) ?>" width="200px"><?php } ?></th>
								<td><?php if($val['Status']=='Y') echo"Active"; else echo"Inactive";  ?></td>
                                
	   <td> 
            <a href="<?php echo base_url('admin/sliders/edit')."?id=".$val['FlashId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/sliders/delete')."?id=".$val['FlashId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
       </td>
       
                                 <td> 
                                  <?php
									  
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['FlashId'],  'checked'=> false, 'class'=>" margin_bottom" );
