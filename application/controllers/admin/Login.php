						  ...
						  if(count($login_id[0]) > 0)
							{
								...
								$this->session->set_userdata('user_id', $login_id[0]['adm_id']);
							    $this->session->set_userdata('adm_name', $login_id[0]['adm_name']);
								$this->session->set_userdata('admin_role', $login_id[0]['admin_role']);
