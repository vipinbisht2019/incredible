		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Tours General Add</b></h3>
						</div>
								...
								//echo"</pre>";
		                		 ...
		                		 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'TourName', 'id' => 'TourName', 'value'=>$edit_generalinfo[0]['TourName'], 'placeholder' => 'Tour Name', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
		                		 ...
		                		 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('TourTitle'); ?></span>
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
               $data = array('name'  => 'TourTitle', 'id' => 'TourTitle', 'value'=>$edit_generalinfo[0]['TourTitle'], 'placeholder' => 'Tour Title', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			...
		                			<div class="col-md-5 form-group padding_opx">
                                          <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('TourCatId'); ?></span>
                                   <?php
								
											unset($options);									
									        $options['']='Select Category';
											foreach($tour_category_dropdown as $val)
										       {
												   $options[$val['TourCategoriesId']] = $val['TourCategoriesName'];
											   }		
											 $selected=$edit_generalinfo[0]['TourCatId'];	
										     echo form_dropdown('TourCatId', $options,$selected,'class="form-control margin_bottom"');
                                    ?>
		                		  </div>
                               </div>    
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">Select Theam  * </label>
		                			<div class="col-md-5 form-group padding_opx">
                                          <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('TheamsId'); ?></span>
                                   <?php
								
											unset($options);									
									        $options['']='Select Location ';
											foreach($tour_theams_dropdown as $val)
										       {
												   $options[$val['TheamsId']] = $val['TheamsName'];
											   }		
											 $selected=$edit_generalinfo[0]['TheamsId'];	
										     echo form_dropdown('TheamsId', $options,$selected,'class="form-control margin_bottom"');
                                    ?>
		                		  </div>
                               </div>        
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			...
		                			<div class="col-md-8 form-group padding_opx">
                                     <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('TourDescription'); ?></span>
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'TourDescription', 'id' => 'TourDescription','value'=>$edit_generalinfo[0]['TourDescription'] ,  'placeholder' => 'Description ', 'class'=>"form-control margin_bottom");
                                ...
                                <div class="col-md-12 padding_opx">
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Current Small Image  </span></label>
		                			    <div class="col-md-5 form-group padding_opx">
                                    
								             <?php
											  if($edit_generalinfo[0]['Image']!='') { ?>
                                               <img src="<?php echo base_url('uploads/tourimage/'.$edit_generalinfo[0]['Image']) ?>" width="200px"> <br>
											  <?php } else { ?>
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                				<span> Current Big Image  </span></label>
		                			    <div class="col-md-5 form-group padding_opx">
                                    
								             <?php
											  if($edit_generalinfo[0]['BigImage']!='') { ?>
                                               <img src="<?php echo base_url('uploads/tourimage/'.$edit_generalinfo[0]['BigImage']) ?>" width="200px"> <br>
											  <?php } else { ?>
                                               Image does not exist
                                              <?php } ?>
                               ...
                               <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
									 ...
									 if($edit_generalinfo[0]['IsView']=='Y')
									      {
														$data = array(
														'name'        => 'IsView',
														'id'          => 'IsView',
                                  ...
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
                                        ...
                                        echo form_hidden($data);
										  ...
										  $data = array('id'  => $edit_generalinfo[0]['TourId'] );
											echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
