             	...
             	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong><i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Tempo Bus Enquiry View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                            	...
                            	<td><?php echo $val['Enq_id'] ?></td>

					<!-- 	 	<td><?php if ($val['Enq_type'] == 5) {
									 echo "Tempo And Buses Booking";
								}  ?>
