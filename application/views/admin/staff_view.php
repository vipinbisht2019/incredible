...
<body>
	<div id="wrapper">
     ...
     <div class="main">
        		...
        		<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Staff View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/staff/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom"> Add Staff</a>
                            <br>
						 </div>
					</div>
				</div>
			...
			<div class="panel">
				...
				<div class="panel-body">
                      ...
                      <div class="col-md-12 col-xs-12 margin_top">  <?php
                                    if($error = $this->session->flashdata('staff')){  ?>
               ...
               <?php                         
						...
						echo form_open_multipart('admin/staff/bulk_action', $attributes); 
					?>                      
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
						        ...
						        <th><?php if($val['member_photo']!='') { ?> <img src="<?php echo base_url('uploads/staff/'.$val['member_photo']) ?>" width="200px"><?php } ?></th>
            ...
            <a href="<?php echo base_url('admin/staff/edit')."?id=".$val['team_id'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php echo base_url('admin/staff/delete')."?id=".$val['team_id'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
                                  ...
                                  <?php
                                            ...
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['team_id'],  'checked'=> false, 'class'=>" margin_bottom" );
