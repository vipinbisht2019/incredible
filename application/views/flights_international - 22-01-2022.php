                  ...
                  <table id="flightSortTable">
                    <tbody>
                      <?php foreach ($flightArray as $key => $flightArrayValue) { 
                              ...
                              //echo "<pre>"; print_r($flightArrayValue['segmentListValReturn']);
                      ...
                      ?>
                        <tr style="height: 160px;">
                            ...
                            <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;">                            
                              ...
                              <li style="font-size:13px;font-weight:600;text-align: left;left: 10px;position: relative;"><?php echo $flightArrayValue['segmentListValOnward'][0]['flightName']?>
                                ...
                                <?php foreach ($flightArrayValue['segmentListValOnward'] as $key => $onwardValue) { ?>
                                  <span style="font-size:11px;font-weight:400;"><?php echo $onwardValue['flightCode']?>-<?php echo $onwardValue['flightNumber'] ?><?php if(count($flightArrayValue['segmentListValOnward']) > 1){ ?>,<?php } ?></span>
                                <?php } ?>
                              </li>
                            </ul>
                            <ul style="list-style: none;padding-left: 0px;display:flex;align-items: center;">

                              <?php foreach ($flightArrayValue['segmentListValReturn'] as $key => $returnVal) { ?>
                             
                              <li><img src="<?php echo base_url('uploads/flights/'); ?><?php echo $returnVal['flightCode'] ?>.png" alt=""></li>
                              <li style="font-size:13px;font-weight:600;text-align: left;left: 10px;position: relative;"><?php echo $returnVal['flightName']; ?>
                              <br>
                                <span style="font-size:11px;font-weight:400;"><?php echo $returnVal['flightCode']?>-<?php echo $returnVal['flightNumber'] ?><?php if(count($flightArrayValue['segmentListValReturn']) > 1){ ?>,<?php } ?></span>
                              </li>
                              <?php } ?>
                            </ul>
                          </td>
                          <td>    
                            ...
                            <?php foreach ($flightArrayValue['segmentListValReturn'] as $key => $returnVal) { ?>
                              <p style="text-align: left;"><?php $deptDate = date('M d',strtotime($returnVal['departureDateNTime'])); echo $deptDate; ?></p> 
                            <h6 style="font-size: 18px;color: #363636;font-weight: 600;"><?php $retdeptTime = date('H:i',strtotime($returnVal['departureDateNTime'])); echo $retdeptTime; ?></h6>                              
                            <p> <?php echo $returnVal['deptCityName']; ?>  </p>        
                            <?php } ?>                      
                          </td>                          
                          <td>
                            <?php if(count($flightArrayValue['segmentListValOnward']) > 1){ 

                              ?>
                            <h6 style="display: flex;flex-direction: column;text-align: left;font-size: 13px;"><?php echo count($flightArrayValue['segmentListValOnward']); ?>                               
                            ...
                            <?php  }else{ 
                                    foreach ($flightArrayValue['segmentListValOnward'] as $key => $onwardVal) {  
                            ?>
                                <h6 style="display: flex;flex-direction: column;text-align: left;font-size: 13px;"><?php $minutes = $onwardVal['flightDuration']; $hours = floor($minutes / 60); $min = $minutes - ($hours * 60); echo $hours."h ".$min."m" ; ?>                               
                                <div class="relative fliStopsSep">
                                  <p class="fliStopsSepLine" style="border-top: 3px solid rgb(102, 137, 221);"></p>
                                </div>
                                <?php if(empty($onwardVal['flightConnectingTime'])){ ?>
                                <span style="font-size: 9px;"><?php echo "Non-Stop"; ?></span></h6>
                                <?php }else{ ?>
                                  <span style="font-size: 9px;"><?php echo "1 Stop"; ?></span></h6>
                            <?php } } } ?>
                                     
                            <?php foreach ($flightArrayValue['segmentListValReturn'] as $key => $returnVal) { ?>
                            <h6 style="display: flex;flex-direction: column;text-align: left;font-size: 13px;"><?php $minutes = $returnVal['flightDuration']; $hours = floor($minutes / 60); $min = $minutes - ($hours * 60); echo $hours."h ".$min."m" ; ?>                             
                            <div class="relative fliStopsSep">
                              <p class="fliStopsSepLine" style="border-top: 3px solid rgb(102, 137, 221);"></p>
                            </div>
                            <?php if(empty($returnVal['flightConnectingTime'])){ ?>
                                <span style="font-size: 9px;"><?php echo "Non-Stop"; ?></span></h6>
                                <?php }else{ ?>
                                  <span style="font-size: 9px;"><?php echo "1 Stop"; ?></span></h6>
                            <?php } } ?>
                          ...
                          <td>
                            <?php 
                                if(count($flightArrayValue['segmentListValOnward']) > 1){
                                //  foreach ($flightArrayValue['segmentListValOnward'] as $key => $onwardVal) { ?>
                                    <p style="text-align: left;"><?php $deptDate = date('M d',strtotime($flightArrayValue['segmentListValOnward'][count($flightArrayValue['segmentListValOnward']) - 1]['arrivalDateNTime'])); echo $deptDate; ?></p>
                                    <h6 style="font-size: 18px;color: #363636;font-weight: 600;justify-content: center;"> <?php $onarriveTime = date('H:i',strtotime($flightArrayValue['segmentListValOnward'][count($flightArrayValue['segmentListValOnward']) - 1]['arrivalDateNTime'])); echo $onarriveTime; ?></h6> 
                            ...
                            <?php } else {  
                                  foreach ($flightArrayValue['segmentListValOnward'] as $key => $onwardVal) { ?>
                                    <p style="text-align: left;"><?php $deptDate = date('M d',strtotime($onwardVal['arrivalDateNTime'])); echo $deptDate; ?></p>
                                    <h6 style="font-size: 18px;color: #363636;font-weight: 600;justify-content: center;"> <?php $onarriveTime = date('H:i',strtotime($onwardVal['arrivalDateNTime'])); echo $onarriveTime; ?></h6> 
                                    <p style="text-align: left;"><?php echo $onwardVal['arivCityName']; ?></p>
                            <?php } }  if(count($flightArrayValue['segmentListValReturn']) > 1){ ?>
                            ...
                            <?php } else{ foreach ($flightArrayValue['segmentListValReturn'] as $key => $returnVal) { ?>
                                  <p style="text-align: left;"><?php $retdeptDate = date('M d',strtotime($returnVal['arrivalDateNTime'])); echo $retdeptDate; ?></p>
                                  <h6 style="font-size: 18px;color: #363636;font-weight: 600;justify-content: center;"> <?php $retarriveTime = date('H:i',strtotime($returnVal['arrivalDateNTime'])); echo $retarriveTime; ?></h6> 
                                  <p style="text-align: left;"><?php echo $returnVal['arivCityName']; ?></p><?php } }  ?>
                          </td>
                          <td>
                            <ul class="price-list">
