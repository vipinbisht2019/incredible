...
<html lang="en">
	...
	$(function () {
                ...
                if(paxTypecheck=='child'){
						...
						//	if($("#seatchildno"+autoIdcheck).text() == mmm) {
								
					//	$("#"+mmm).css("color", "yellow");
			...
			// 	alert($("#seatchildno"+autoIdcheck).html());
									
								//	var mmm= document.getElementById("#seatchildno"+autoIdcheck).innerHTML;
				//	var jjj = $("."+jj).css("color", "white");
				//	var kkkk =  $("."+jj).text();
		//	alert(jjjj);
		//	alert("this new");
		//	alert(mmm);
		...
		//	alert(mmm);
                    ...
                    $("#adultchildseatselection").show();
						...
						//	mmm = $("#seatchildno"+autoIdcheck).text();					// new		 
						//	alert(mmm);													// new
						//	 $("."+mmm).css("color", "yellow");							// new
				...
				/*
				if($("#seatchildno"+autoIdcheck).is(':empty')) {
