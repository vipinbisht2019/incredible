...
<html lang="en">
 <head>
	<title>Unpaid Tempo & Coach Booking View</title>
	<meta charset="utf-8">
...
<body>
	<div id="wrapper">
     ...
     <div class="main">
			...
			echo form_open_multipart('admin/temppobookingenc/search', $attributes);
	 ?>
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                                ...
                                <td style="width: 5%;"> <a href="<?php echo base_url('admin/temppobookingenc/details')."/".$val['BookingId']; ?>" class=" db-done"> <i class="fa fa-info-circle"></i> </a> </td>


                            <!--     <td style="width: 5%;"> <a href="<?php echo base_url('admin/temppobookingenc/printticket')."/".$val['BookingId'];?>" class="db-done"> <i class="fa fa-print"></i> </a></td> -->

                            <!--     <td style="width: 6%;">
                                 <a onclick="return confirm('Are you sure you want to cancel?')"  href="<?php echo base_url('admin/temppobookingenc/temppobookingenccancle/').$val['BookingId']; ?>" class="db-done"> <i class="fa fa-window-close" aria-hidden="true"></i></a>
                                </td> -->
