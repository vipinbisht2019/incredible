             	...
             	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b><i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Clients Modify</b></h3>
						</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12">
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open --------------------------------- $edit_clients[0]['
										$attributes = array('class' => 'form-auth-small form-inline', 'name'=>'form1', 'id' => 'form1');
										echo form_open_multipart('admin/clients/edit', $attributes);
							     ?>
                               ...
                               <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Name form open ---------------------------------
               $data = array('name'  => 'FirstName',  'value'=>$edit_clients[0]['FirstName'], 'placeholder' => 'FirstName', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Name form open ---------------------------------
               $data = array('name'  => 'LastName',  'value'=>$edit_clients[0]['LastName'], 'placeholder' => 'Last Name', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
               ...
               $data = array('name'  => 'EMailAddress', 'id' => 'EMailAddress', 'value'=>$edit_clients[0]['EMailAddress'], 'placeholder' => 'EMail Address', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'Password', 'id' => 'Password', 'value'=>$edit_clients[0]['Password'], 'placeholder' => 'Password', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
			    // ------------------------------------------------ EmailAddress form open -----------------------------------
                $data = array('name'  => 'ContactNumber', 'id' => 'ContactNumber', 'value'=>$edit_clients[0]['ContactNumber'], 'placeholder' => 'Contact Number', 'class'=>"form-control margin_bottom");
                echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
								     ...
								     // ------------------------------ adm_status form  ---------------------------------
										 ...
										 $selected=	$edit_clients[0]['Gender'];						
               ...
               $data = array('name'  => 'Website', 'class'=>"form-control margin_bottom");
                       echo form_upload($data);
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'FacebookID', 'id' => 'FacebookID', 'value'=>$edit_clients[0]['FacebookID'], 'placeholder' => 'Facebook ID', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'InstagramID', 'id' => 'InstagramID', 'value'=>$edit_clients[0]['InstagramID'], 'placeholder' => 'InstagramID', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'TwitterID', 'id' => 'TwitterID', 'value'=>$edit_clients[0]['TwitterID'], 'placeholder' => 'TwitterID', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'Relationship', 'id' => 'Relationship', 'value'=>$edit_clients[0]['Relationship'], 'placeholder' => 'Relationship', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'Profession', 'id' => 'Profession', 'value'=>$edit_clients[0]['Profession'], 'placeholder' => 'Profession', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'CityofLiving', 'id' => 'CityofLiving', 'value'=>$edit_clients[0]['CityofLiving'], 'placeholder' => 'City of Living', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                 ...
                                 <div style="background: #00aaff70;width: 100%;margin-top: 5px;height: 1px; margin-bottom:10px;"></div>     
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'PassportNumber', 'id' => 'PassportNumber', 'value'=>$edit_clients[0]['PassportNumber'], 'placeholder' => 'Passport Number', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                ...
                                <?php
								      if($edit_clients[0]['PassportExpiryDate']!='0000-00-00')
									   {
									
										$PassportExpiryDateArr=explode("-",$edit_clients[0]['PassportExpiryDate']);    
								...
								?>  
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'PassportExpiryDate', 'id' => 'datepicker1', 'value'=>$PassportExpiryDateArrStr, 'placeholder' => 'Passport Expiry Date', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'Nationality', 'id' => 'Nationality', 'value'=>$edit_clients[0]['Nationality'], 'placeholder' => 'Nationality', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'Married', 'id' => 'Married', 'value'=>$edit_clients[0]['Married'], 'placeholder' => 'Married', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                  ...
                                  <?php 
								 if($edit_clients[0]['DateofBirth']!='0000-00-00')
									   {
								            $birthDateArr=explode("-",$edit_clients[0]['DateofBirth']); 
										    $birthDateStr=$birthDateArr['2']."-".$birthDateArr['1']."-".$birthDateArr['0'];
									   }
							   if($edit_clients[0]['AnniversaryDate']!='0000-00-00')
									   {	   		
								       
								            $AnnivDateArr=explode("-",$edit_clients[0]['AnniversaryDate']);    
								  ...
								  ?>
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'DateofBirth', 'id' => 'datepicker2', 'value'=>$birthDateStr, 'placeholder' => 'Date of Birth', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                   ...
                                   <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'AnniversaryDate', 'id' => 'datepicker3', 'value'=>$AnnivDateArrStr, 'placeholder' => 'Anniversary Date', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
                                 ...
                                 <div style="background: #00aaff70;width: 100%;margin-top: 5px;height: 1px; margin-bottom:10px;"></div>  
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'MealPreference', 'id' => 'MealPreference', 'value'=>$edit_clients[0]['MealPreference'], 'placeholder' => 'Meal Preference', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
		                			...
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'SeatingPreference', 'id' => 'SeatingPreference', 'value'=>$edit_clients[0]['SeatingPreference'], 'placeholder' => 'Seating Preference', 'class'=>"form-control margin_bottom");
                       echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
         ...
         <?php
				 // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'MedicalRequirement', 'id' => 'content1', 'value'=>$edit_clients[0]['MedicalRequirement'], 'placeholder' => 'Medical Requirement', 'class'=>"form-control margin_bottom");
                       echo form_textarea($data);
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ EmailAddress form open ---------------------------------
               $data = array('name'  => 'SpecialServiceRequirement', 'id' => 'content2', 'value'=>$edit_clients[0]['SpecialServiceRequirement'], 'placeholder' => 'Special Service Requirementt', 'class'=>"form-control margin_bottom");
                       echo form_textarea($data);
                                        ?>
                                         <p>&nbsp;</p>
                                      </div>
                       ...
                       <!-- ***************************** appending fields ************************************** -->  
                                   ...
                                   <?php
								     // ------------------------------ adm_status form  ---------------------------------
										 ...
										 $selected=	$edit_clients[0]['Status'];						
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
										...
										//-------------------------------------------------------------------------------------------------------------------
										$data = array('id'  => $edit_clients[0]['CustomersId'] );
										echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
