...
<!-- Html ##################################################### -->
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/busesroutes_broading/edit', $attributes);
										   ...
										   foreach($vcities['BoardingPoint'] as $val) 
											     {
														...
														$city_boarding_points=$route_cities_boarding[$CityId][$BoardingId]['BoardingId']
												      
												   ?>
                                                    <div class="col-md-6 form-group padding_opx" style="margin-top:10px; ">
													  <?php         
													   if($val['BoardingId']==$city_boarding_points) 
														  {
   ...
   $data = array('name'  => "DepartureTime[$CityId][$BoardingId]", 'id' => 'DepartureTime', 'value'=>$route_cities_boarding[$CityId][$BoardingId]['DepartureTime'],    'placeholder' => 'Departure Time ', 'class'=>"form-control margin_bottom");
	  ...
	  $data = array('name'  => "ArrivalTime[$CityId][$BoardingId]", 'id' => 'ArrivalTime', 'value'=>$route_cities_boarding[$CityId][$BoardingId]['ArrivalTime'],    'placeholder' => 'Arrival Time', 'class'=>"form-control margin_bottom");
                                         echo form_input($data);
										            }
                                    ?>
