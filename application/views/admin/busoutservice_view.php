...
<html lang="en">
 <head>
	<title>Bus Out Of Service Date View</title>
	<meta charset="utf-8">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Bus Out Of Service View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/busoutservice/add?bid='.$bid); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom"> Add Bus Out Of Service </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/busoutservice/bulk_action', $attributes); 
					?>                                
						  ...
						  @$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
                             ...
                             <tr class="<?php echo $css; ?>">
                            	...
                            	<td><?php echo $val['ServiceId'] ?></td>
								<td><?php echo $val['ServiceOfServiceDate'] ?></td>
                          
							  <td> 
                                  
                                  
       
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/busoutservice/delete')."?id=".$val['ServiceId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['ServiceId'],  'checked'=> false, 'class'=>" margin_bottom" );
