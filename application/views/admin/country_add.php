		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Country Add</b></h3>
						</div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                      ...
                      <?php
                        ...
                        echo form_open_multipart('admin/country/add', $attributes);
                        ?>
                          ...
                          <div class="col-md-12 padding_opx">
                            ...
                            <div class="col-md-2 form-group padding_opx">
                              ...
                              <?php
                                ...
                                $data = array('name'  => 'code', 'id' => 'code','value'=>set_value('code') ,  'placeholder' => 'Country code', 'class'=>"form-control margin_bottom");
                                    echo form_input($data);
                              ?>
                          ...
                          <div class="col-md-12 padding_opx">
                            ...
                            <div class="col-md-2 form-group padding_opx">
                              ...
                              <?php
                                ...
                                $data = array('name'  => 'phon_code', 'id' => 'phon_code','value'=>set_value('phon_code') ,  'placeholder' => 'Tel code', 'class'=>"form-control margin_bottom");
                                    echo form_input($data);
                              ?>
