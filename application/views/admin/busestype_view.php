...
<body>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Buses Type/Name View</strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/busestype/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Add Bus Type/Name </a>
			...
			<div class="panel">
				...
				<div class="panel-body">
                  ...
                  <?php                         
						  ...
						  echo form_open_multipart('admin/busestype/bulk_action', $attributes); 
					?> 
						...
						@$css = ($css=='trOdd')?'success':'trOdd';
					       ?>   
							<tr class="<?php echo $css; ?>">
                                ...
                                <td><?php echo $val['SeatingTitle']."  -- Seats [".$val['TotalSeats']."]"; ?></td>
                                ...
                                <td><?php 
											  ...
											  if($val['Photo1']!='') { ?>
                                               <img src="<?php echo base_url('uploads/bus/'.$val['Photo1']) ?>"  class="margin_bottom"  width="200px"> <br>
											  <?php } else { ?>
            ...
            <a href="<?php echo base_url('admin/busestype/edit')."?id=".$val['TypeId'];  ?>"><img src="<?php echo base_url('assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/busestype/delete')."?id=".$val['TypeId'] ?>"><img src="<?php echo base_url('assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
...
<!--             <script type="text/javascript">
            ...
            -->
                      ...
                      <td> 
                                  <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['TypeId'],  'checked'=> false, 'class'=>" margin_bottom" );
