<?php 
 ...
 public function car_termscondition($id)
		       { 
				        $this->db->from('usc_tempo_termscondition as condin')
							     ->join("usc_car_cartermscondition as tempcondition", "condin.TermsconditionID = tempcondition.TermsconditionID", 'inner')
							     ->where('CarId',$id);
						$query = $this->db->get();	
					    return $query->result_array();
		        }				 
