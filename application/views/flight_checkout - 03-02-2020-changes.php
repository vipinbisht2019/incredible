                                                                                    ...
                                                                                    foreach ($tripSeatRowcolumn as $key => $seatValue) { 
                                                                                        ...
                                                                                        <li class="row row--1">  
                                                                                            ...
                                                                                            ?>
                                                                                                ...
                                                                                                <input id="<?php echo $seatValue1['seatNo']; ?>" type="checkbox" class="cc<?php echo $seatValue1['seatNo']; ?>" value="<?php echo $seatValue1['seatNo']; ?>">
			...
			//	alert(seatValue);
				...
				$(function () {
					...
					var kkkk = $(".seat-map__seat-data--selected").find(".seat-map--seatNo").text(); 
						...
						alert("start left side");
						alert(kkkk);
						alert("end left side");
						
						alert("start right side");
						alert(seatNo);
						alert("end right side");
						
						var yy = "NA";
						
							if(kkkk != seatNo && kkkk != yy)
								{
								
								var pop=$(".cc"+seatNo).val();
							$(".cc"+seatNo).attr('disabled', true);
							
							alert(pop);

							}  else  { 
								$(".cc"+seatNo).attr('disabled', false);
	...
	$(function () {
			...
			var seatAmountS = "0.00";			
                    ...
                    $("#adultchildseatselection").show();
						...
						var kkkk_child = $(".seat-map__seat-data--selected").find(".seat-map--seatNo").text();
						alert("child start left side");
						alert(kkkk_child);
						alert("child end left side");
						
						alert("child start right side");
						alert(seatNo);
						alert("child end right side");
							...
							if($("#"+seatNo).is(":checked"))
						{
							...
							$(".cc"+hh).attr('disabled', true);
							
									
							}  else  { 
							alert ("new remove color");
