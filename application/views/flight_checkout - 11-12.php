                                            ...
                                            if(!empty($tripInfoResult['sI'][1]['cT'])){  ?> 
                                                ...
                                                <ul class="brdrBot">
                                                    <li>
                                                        ...
                                                        <p class="flight-detl"><?php echo $tripInfoResult['sI'][2]['fD']['aI']['name']; ?></p>
                                                        <p class="flight-detl"><?php echo ucfirst($tripInfoResult['totalPriceList'][0]['fd']['ADULT']['cc']); ?></p>
                                                        <p class="flight-detl"><?php echo $tripInfoResult['sI'][2]['fD']['aI']['code']; ?> - <?php echo $tripInfoResult['sI'][2]['fD']['fN']; ?></p>
                                                        <p class="flight-detl" style="font-weight: 500;">(Aircraft: <?php echo $tripInfoResult['sI'][2]['fD']['eT']; ?>)</p>
                                                        </span>
                                                    </li>
                                                    <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResult['sI'][2]['dt'])); ?></p>
                                                        ...
                                                        <p style="font-size: 13px;font-weight: 500;color: #8b8b8b;line-height: 15px;margin-bottom: 0;"><?php echo $tripInfoResult['sI'][2]['da']['name']; ?> <?php //echo $tripInfoResult['sI'][0]['da']['city']; ?> <?php //echo $tripInfoResult['sI'][0]['da']['country']; ?><br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResult['sI'][2]['da']['terminal']; ?>)</span></p>
                                                    </li>
                                                    <li>
                                                        <div class="common-elementsstyles__Wid25-sc-ilw4bs-16 sGaBo flexCol TxtCenter padR20 padL10"><div class="flight-detailstyles__BackgroundLn-sc-1i6unua-6 iGruED dF justifyBetween alignItemsCenter backgroundLn"><div class="flight-detailstyles__Oval2-sc-1i6unua-7 dHNyva"></div><span class="padL10 padR10 whiteBg font20"><?php  
                                                    ...
                                                    <li><p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("M d, D, H:i",strtotime($tripInfoResult['sI'][2]['at'])); ?></p>
                                                        ...
                                                        <p style="font-size: 13px;font-weight: 500;color: #8b8b8b;line-height: 15px;margin-bottom: 0;"><?php echo $tripInfoResult['sI'][2]['aa']['name']; ?><br><span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResult['sI'][2]['aa']['terminal']; ?>)</span></p>
                                                    </li>
                                                </ul>
                                                <span><?php if($tripInfoResult['totalPriceList'][0]['fareIdentifier'] == 'LITE'){ echo "SNS PRO"; }else if($tripInfoResult['totalPriceList'][0]['fareIdentifier'] == 'PUBLISHED'){ echo "SNS Saver"; }else if($tripInfoResult['totalPriceList'][0]['fareIdentifier'] == 'FLEXI_PLUS'){ echo "SNS Flexi"; } ?></span>
                                                <div class="grey padT10 font12 padL20 padR20 dF">
                                        ...
                                        if($countMultiways > 2) { ?>
                                            ...
                                            <div class="dF pad10 justifyBetween alignItemsCenter">
                                                <div class="dF alignItemsCenter font18">
                                                    ...
                                                    <span class="padL5"><?php echo $tripInfoResultthird['sI'][0]['da']['city'] ?> - <?php echo $tripInfoResultthird['sI'][0]['aa']['city'] ?>&nbsp;&nbsp;<?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultthird['sI'][0]['dt'])); ?></span>
                                                </div>
                                                <div class="dF alignItemsCenter">
                                                    <span class="padR5">
                                                    </span>
                                        ...
                                        if($countMultiways > 3) { ?>
                                            ...
                                            <div class="dF pad10 justifyBetween alignItemsCenter">
                                                <div class="dF alignItemsCenter font18">
                                                    ...
                                                    <span class="padL5"><?php echo $tripInfoResultforth['sI'][0]['da']['city'] ?> - <?php echo $tripInfoResultforth['sI'][0]['aa']['city'] ?>&nbsp;&nbsp;<?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultforth['sI'][0]['dt'])); ?></span>
                                                </div>
                                                <div class="dF alignItemsCenter">
                                                    <span class="padR5">
                                                    </span>
                                            ...
                                            <div class="dscrpton-cntnt detail-box">
                                                <ul class="brdrBot">
                                                    ...
                                                    <li>
                                                        <p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultforth['sI'][0]['dt'])); ?></p>
                                                    ...
                                                    <li>
                                                        <div class="common-elementsstyles__Wid25-sc-ilw4bs-16 sGaBo flexCol TxtCenter padR20 padL10">
                                                            <div class="flight-detailstyles__BackgroundLn-sc-1i6unua-6 iGruED dF justifyBetween alignItemsCenter backgroundLn">
                                                                <div class="flight-detailstyles__Oval2-sc-1i6unua-7 dHNyva"></div>
                                                                <span class="padL10 padR10 whiteBg font20">
                                                                    <?php  
                                                            ...
                                                            <span class="font12 grey padT5 txtCap">Flight Duration</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultforth['sI'][0]['at'])); ?></p>
                                        ...
                                        if($countMultiways > 4) { ?>
                                            ...
                                            <div class="dscrpton-cntnt detail-box">
                                                <ul class="brdrBot">
                                                    ...
                                                    <li>
                                                        <p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultfifth['sI'][0]['dt'])); ?></p>
                                                    ...
                                                    <li>
                                                        <p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultfifth['sI'][0]['at'])); ?></p>
                                        ...
                                        if($countMultiways > 5) { ?>
                                            ...
                                            <div class="dF pad10 justifyBetween alignItemsCenter">
                                                <div class="dF alignItemsCenter font18">
                                                    ...
                                                    <span class="padL5"><?php echo $tripInfoResultsixth['sI'][0]['da']['city'] ?> - <?php echo $tripInfoResultsixth['sI'][0]['aa']['city'] ?>&nbsp;&nbsp;<?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultsixth['sI'][0]['dt'])); ?></span>
                                                </div>
                                                <div class="dF alignItemsCenter">
                                                    <span class="padR5">
                                                    </span>
                                            ...
                                            <div class="dscrpton-cntnt detail-box">
                                                <ul class="brdrBot">
                                                    ...
                                                    <li>
                                                        <p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultsixth['sI'][0]['dt'])); ?></p>
                                                        ...
                                                        <p style="font-size: 14px;font-weight: 400;margin-bottom: 0;"><?php echo $tripInfoResultsixth['sI'][0]['da']['name']; ?>, <?php echo $tripInfoResultsixth['sI'][0]['da']['city']; ?>, <?php echo $tripInfoResultsixth['sI'][0]['da']['country']; ?><br>
                                                            <span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResultsixth['sI'][0]['da']['terminal']; ?>)</span>
                                                        </p>
                                                    </li>
                                                    <li>
                                                        <div class="common-elementsstyles__Wid25-sc-ilw4bs-16 sGaBo flexCol TxtCenter padR20 padL10">
                                                            <div class="flight-detailstyles__BackgroundLn-sc-1i6unua-6 iGruED dF justifyBetween alignItemsCenter backgroundLn">
                                                                <div class="flight-detailstyles__Oval2-sc-1i6unua-7 dHNyva"></div><span class="padL10 padR10 whiteBg font20">
                                                                    <?php  
                                                    ...
                                                    <li>
                                                        <p style="font-size: 14px;font-weight: 500;margin-bottom: 0;"><?php echo $arrivalDate = date("D, d M Y",strtotime($tripInfoResultsixth['sI'][0]['at'])); ?></p>
                                                        ...
                                                        <p style="font-size: 14px;font-weight: 400;margin-bottom: 0;"><?php echo $tripInfoResultsixth['sI'][0]['aa']['name']; ?>, <?php echo $tripInfoResultsixth['sI'][0]['aa']['city']; ?>, <?php echo $tripInfoResultsixth['sI'][0]['aa']['country']; ?><br>
                                                            <span style="color: #000;font-size: 11px;color: #a7a7a7;">(<?php echo @$tripInfoResultsixth['sI'][0]['aa']['terminal']; ?>)</span>
                                                        </p>
                                                    </li>
                                                </ul>
                                                <div class="grey padT10 font12 padL20 padR20 dF">
                                                    ...
                                                    <div class="accordion__container">
                                                        ...
                                                        <div class="accordion__answer__container active__accordion">
                                                            ...
                                                            <span style="text-align:left; color:#FF0000;font-size:12px;";>
                                                                <?php echo form_error('first_middle_name'); ?> 
                                                            </span>
                            ...
                            <!------------------------- Return Trip ------------------------------->                                         
                                                ...
                                                <div class="row">
                                                    ...
                                                    <?php if(!empty($tripInfoResultReturn['sI'][0]['ssrInfo']['BAGGAGE'])){ ?>
                                                        <div class="col-md-5 form-group ">
                                                            <span style="text-align:left; color:#FF0000;font-size:12px;";><?php echo form_error('baggage'); ?></span>
                                                            <select name="baggage_return[]" id="baggage_return<?php echo $ib; ?>" onchange="getBaggage('<?php echo $ib; ?>');">
                                                                <option value="">Add Baggage</option>
                                                    ...
                                                    <?php if(!empty($tripInfoResultReturn['sI'][0]['ssrInfo']['MEAL'])){ ?>
                                                        <div class="col-md-5 form-group padding_5px " >
                                                            ...
                                                            <select name="meal_return[]" id="meal_adult_return<?php echo $ib; ?>" onchange="getBaggage('<?php echo $ib; ?>');">
                                                                <option value="">Add Meal</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <?php if(!empty($tripInfoResultReturn['sI'][0]['ssrInfo']['BAGGAGE'])){ ?>
                                                        <div class="col-md-5 form-group ">
                                                            <span style="text-align:left; color:#FF0000;font-size:12px;";><?php echo form_error('baggage'); ?></span>
                                                            <select name="baggage_return[]" id="baggage_child_return<?php echo $jb; ?>" onchange="getBaggage('<?php echo $jb; ?>');">
                                                                <option value="">Add Baggage</option>
                                                                <?php foreach ($tripInfoResultReturn['sI'][0]['ssrInfo']['BAGGAGE'] as $key => $baggagevalueSecond) { ?> 
                                                    ...
                                                    <?php if(!empty($tripInfoResultReturn['sI'][0]['ssrInfo']['MEAL'])){ ?>
                                                        <div class="col-md-5 form-group padding_5px " >
                                                            ...
                                                            <select name="meal_return[]" id="meal_child_return<?php echo $jb; ?>" onchange="getBaggage('<?php echo $jb; ?>');">
                                                                <option value="">Add Meal</option>
                                                                <?php foreach ($tripInfoResultReturn['sI'][0]['ssrInfo']['MEAL'] as $key => $mealvalueSecond) { ?> 
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div id="myModal1" class="modal">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    //     foreach ($seatValue as $key => $seatValue1) { 

                                                                    //         if(in_array($seatValue1['amount'],$tripSeatAmount1, TRUE )){
                                ...
                                <div class="detail-title"><h3>Fare Summary <span class="fare-sumry"></span></h3></div>
                                    ...
                                    <div class="input2_wrapper" id="seat_price">
                                        ...
                                        <div class="col-md-4 pad-l-r" style="position: relative;right: 35px;">
                                            <span class="red"><i class="fa fa-inr"></i> 100 </span>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
    ...
    <!-------------------------------------------------- FARE SUMMARY ------------------------------------------------------------------->
        ...
        <script>
            ...
            function getSeatSelect(seatNo,seatAmount,paxType){
               ...
               // alert(totalSeatsAmount);
                $("#totalSSeatAmount").html('<i class="fa fa-inr" style="margin-top:8px; margin-right:2px;"></i> ' + totalSeatsAmount)
