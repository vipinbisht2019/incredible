...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Travel Article">
    <meta name="keywords" content="Travel Article">
    ...
    <body class="not-front page-post">
        <div id="main">
            ...
            <div class="breadcrumbs1_wrapper">
                <div class="container">
                    <div class="breadcrumbs1"><a href="index.html">Home</a><span>/</span>Travel Article</div>
                </div>
            </div>

            <?php //print_r($about);
                echo $travel_articles[0]['page_description'];
            ?>
