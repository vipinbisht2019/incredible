					...
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Members Bill Add</b></h3>
						     ...
						     <div class="col-md-6 padding_opx">
								  <a href="<?php echo base_url('admin/payments/view_due'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
						</div>
					</div>
				</div>
                            ...
                            <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/payments/add', $attributes);
							     ?>
		                			...
		                			<label class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('RegionsName'); ?></span>
                                           Aerostar Helmets Ltd./HEMS:CMM/GGN/003
                                        <?php   
                                           $data = array('user_id'  => $_REQUEST['id']);
                       ...
                       <!--  ************************************* Annual Sub. for Year****************************************************** -->               
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('financialYear'); ?></span>
                                       <?php
								
               $data = array('name'  => 'financialYear', 'id' => 'financialYear', 'value'=>set_value('financialYear'), 'placeholder' => 'Annual Sub. for Year', 'class'=>"form-control margin_bottom");
