             	...
             	<div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b><i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>  Regions Modify</b></h3>
						</div>
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/regions/edit', $attributes);
							     ?>
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'RegionsName', 'id' => 'RegionsName', 'value' =>$edit_regions[0]['RegionsName'], 'placeholder' => 'Regions Name', 'class'=>"form-control margin_bottom");
                                   ...
                                   <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'Description', 'id' => 'Description','value'=>$edit_regions[0]['Description'] ,  'placeholder' => 'Description ', 'class'=>"form-control margin_bottom");
                                ...
                                <div class="col-md-12 padding_opx">
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                      <?php
											  if($edit_regions[0]['Photo']!='') { ?>
                                               <img src="<?php echo base_url('uploads/tour/'.$edit_regions[0]['Photo']) ?>" width="200px"> <br>
											  <?php } else { ?>
                               ...
                               <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'meta_title', 'id' => 'meta_title', 'value'=>$edit_regions[0]['meta_title']  , 'placeholder' => '', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                        ?>
                                      </div>
		                		</div>
                                  ...
                                  <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
           $data = array('name'  => 'meta_description', 'id' => 'meta_description', 'value'=>$edit_regions[0]['meta_description'] ,  'placeholder' => ' ', 'class'=>"form-control margin_bottom");
            echo form_textarea($data);
                                    ?>
		                		  </div>
                               </div>   
                                 ...
                                 <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'meta_keyword', 'id' => 'meta_keyword', 'value'=>$edit_regions[0]['meta_keyword']  ,  'placeholder' => '', 'class'=>"form-control margin_bottom");
                                         echo form_textarea($data);
                                    ?>
		                		  </div>
                               </div>   
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
										...
										//-------------------------------------------------------------------------------------------------------------------
										$data = array('id'  => $edit_regions[0]['RId'] );
											echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
