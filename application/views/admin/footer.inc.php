       <footer>
			<div class="container-fluid">
				<p class="copyright">&copy; <?php echo date('Y'); ?>  My Tour Advisor . All Rights Reserved. <small> <a href="http://us-creations.com" target="_blank"> US Creations Web Services </a> -  Web Admin Console </small> </p>
			</div>
		</footer>
...
<script src="<?php echo base_url('assets/admin/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js') ?>"></script> 
