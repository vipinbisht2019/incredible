						...
						//-------------------------------------------------------------------------------------------------
                          ...
                          <?php  
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/members/import', $attributes);
							     ?>
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx"> Select Regions  </label>
		                			<div class="col-md-5 form-group padding_opx">
                                      <span class="margin_bottom" style="text-align:left; color:#FF0000; font-size:12px;";><?php echo form_error('RId'); ?></span>
                                   <?php
								     // ------------------------------ adm_status form  ---------------------------------
										
											   $options['']='Select Regions';
											   foreach($regions as $reg_val)
											    {
												  $options[$reg_val['RId']] = $reg_val['RegionsName'];
												}
											
											 $selected=set_value('RId');							
