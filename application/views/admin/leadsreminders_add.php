		   ...
		   <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Reminders Add</b></h3>
						</div>
                                  ...
                                  <?php
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/leadsreminders/add', $attributes);
							     ?>
           ...
           ?>
                                  ...
                                  <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
            $data = array('name'  => 'DueDateTime', 'id' => 'datepicker1', 'value'=>set_value('DueDateTime'), 'placeholder' => 'Date-Time', 'class'=>"form-control margin_bottom");
             echo form_input($data);
                                        ?>
                                      </div>
		                		  </div>
